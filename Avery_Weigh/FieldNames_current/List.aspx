<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="Avery_Weigh.FieldNames.List" %>
        ...
        <div class="Wrapper WeighMain">
            ...
            <div class="MiddleSection">
                ...
                <div id="div_print" class="RightSec">
                    <div class="RightInn11" style="overflow:hidden">
                        <h4>MASTERS</h4>
                        <h4 class="SupplierSearchBig">FIELD NAMES LIST <a href="/ManageMasters" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image32','','/images/close_hover.png',1)" class="CloseButtonA">
                                        ...
                                        <HeaderTemplate>
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th align="center" valign="middle" bgcolor="#d8e7ee">Plant Code</th>
                                                    <th align="center" valign="middle" bgcolor="#d8e7ee">Machine Name</th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                        </HeaderTemplate>
                                        <ItemTemplate>
                                            <tr class="trclass" data-rowid="<%#Eval("PlantId") +"#"+Eval("MachineId") %>">
                                                <%--<td>
                                                    <input type="checkbox" class="checkbox" data-id="<%#Eval("Id") %>" /></td>--%>
                                                <td align="center" valign="middle">
                                                    <asp:Label ID="lblid" runat="server" Visible="false"></asp:Label><%#Eval("PlantId") %></td>
            ...
            <div class="footer">
                <ul class="selected">
                    ...
                    <li>
                        <asp:LinkButton ID="Export" runat="server" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image15','','/images/type4/import_hover.png',1)">
                    ...
                    <li>
                        <asp:LinkButton ID="Delete" runat="server" OnClientClick="return Delete();" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image17','','/images/type4/delete_hover.png',1)">
