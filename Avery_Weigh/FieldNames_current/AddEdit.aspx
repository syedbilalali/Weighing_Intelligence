                                    ...
                                    <ItemTemplate>
                                        <tr class="trclass" >
                                            ...
                                            <td align="center" valign="middle"><asp:TextBox ID="txtValue" style="width:80%;" runat="server" Text='<%#Eval("FieldValue") %>'
                                                ></asp:TextBox></td>
                                            <td align="center" valign="middle"> <asp:CheckBox ID="chk1" runat="server" Checked='<%#Eval("IsMandatory1") == "true" ? true : false %>' /></td>
                                            <td align="center" valign="middle"> <asp:CheckBox ID="chk2" runat="server" Checked='<%#Eval("IsMandatory2") == "true" ? true : false %>' /></td>
                                        </tr>
                                    </ItemTemplate>
                                </asp:Repeater>
                            </table>
