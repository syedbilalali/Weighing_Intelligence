<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddEdit.aspx.cs" Inherits="Avery_Weigh.Camera_Master.AddEdit" %>
            ...
            <div class="MiddleSection">
                ...
                <div class="RightSec">
                    <div class="RightInn11" style="overflow:hidden">
                        <h4>CONFIGURATION</h4>
                        <h4 class="SupplierSearchBig">CAMERA MASTER <a href="List.aspx" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image32','','/images/close_hover.png',1)" class="CloseButtonA">
                        ...
                        <div class="RightInnMasters">
                            ...
                            <table border="0" cellspacing="0" cellpadding="2">
                                <tr>
                                    ...
                                    <td>
                                        <asp:DropDownList ID="ddlplantcode" AutoPostBack="true" Width="287px" OnSelectedIndexChanged="ddlplantcode_SelectedIndexChanged" DataTextField="Name" DataValueField="PlantCode" CssClass="FilddHalf112" runat="server"></asp:DropDownList>
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    <td align="right" width="150px;">Camera Identification</td>
                                    <td>
                                        <asp:TextBox ID="txtidentification" CssClass="FilddHalf112" runat="server" MaxLength="10"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                    <td align="right" width="150px;">Camera IP</td>
                                    <td>
                                        <asp:TextBox ID="txtip" runat="server" CssClass="FilddHalf112" MaxLength="15"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                    <td align="right" width="150px;">Camera PORT</td>
                                    <td>
                                        <asp:TextBox ID="txtport" runat="server" CssClass="FilddHalf112" MaxLength="5"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                    <td align="right" width="150px;">Camera User Name</td>
                                    <td>
                                        <asp:TextBox ID="txtCameraUserName" runat="server" CssClass="FilddHalf112" MaxLength="10"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                    <td align="right" width="150px;">Camera Password</td>
                                    <td>
                                        <asp:TextBox ID="txtCameraPwd" runat="server" CssClass="FilddHalf112" MaxLength="10"></asp:TextBox>
                                    </td>
                                </tr>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $('#ddlmachineid').change(function () {
                ...
                $.ajax({
                    url: "/AveryService/WebService1.asmx/Check_CameraMaster",
                    type: "post",
                    dataType: "json",
                    ...
                    success: function (data) {
                        if (data.d != "") {
                            toastr.warning('3 Camera Allow at One Machine!');
                        }
                    },
                    error: function (data) {
                        console.log(data);
            ...
            $('#txtip').change(function () {
                ...
                var cameraip = $('#txtip').val();
                $.ajax({
                    url: "/AveryService/WebService1.asmx/Check_CameraMasterIP",
                    type: "post",
                    dataType: "json",
                    contentType: "application/json; charset=utf-8",
                    data: '{plantcode:"' + plantcode + '",cameraip:"' + cameraip + '"}',
                    async: false,
                    success: function (data) {
                        if (data.d != "") {
                            toastr.warning('Same Camera IP Exist!');
                        }
                    },
                    error: function (data) {
                        console.log(data);
