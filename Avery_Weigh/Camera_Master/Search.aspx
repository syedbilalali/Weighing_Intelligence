<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Search.aspx.cs" Inherits="Avery_Weigh.Camera_Master.Search" %>
...
<head runat="server">
    ...
    <script>
        $(document).on("click", ".MainPopBtn", function () {
            ...
            $.ajax({
                        type: "POST",
                        url: "/AveryService/WebService1.asmx/Get_CameraById",
                        data: "{'id':'" + id + "'}",
                        ...
                        success: function (response) {
                            ...
                            $('#txtiden').val(obj.CameraIndentification);
                            $('#txtip').val(obj.CameraIP);
                            $('#txtport').val(obj.CameraPort);
            ...
            <div class="MiddleSection">
                ...
                <div class="RightSec">
                    <div class="RightInn11">
                        <h4>CONFIGURATION</h4>
                        <h4 class="SupplierSearch">CAMERA MASTER | SEARCH    </h4>
                    </div>
                                ...
                                <tr>
                                    <td align="left">
                                        <table width="200" border="0" cellspacing="0" cellpadding="0" style="margin-top: 20px;">
                                            ...
                                            <tr>
                                                <td align="center">
                                                    <select class="DropDown" id="ddlSearch1" style="width: 85%;">
                                                        ...
                                                        <option value="CameraIP">Camera IP</option>
                                                    </select>
                                                </td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                <td align="center" style="width: 85%;">
                                                    <select class="DropDown" id="ddlSearch3">
                                                        <option value="CameraIP">Camera IP</option>
                                                        <option value="Code">Plant Code</option>
                                                        <option value="Name">Machine ID</option>
                                                    </select>
                        ...
                        <div class="RightInn33">
                                ...
                                <tr>
                                    <td class="TableDiv">
                                        <table border="0" cellspacing="0" cellpadding="2">
                                            ...
                                            <tr>
                                                <td align="right">Camera Identification</td>
                                                <td>
                                                    <input type="text" name="" id="" value="" placeholder="" class="FilddHalf11" /></td>
                                            </tr>
                                            <tr>
                                                <td align="right">Camera IP</td>
                                                <td>
                                                    <input type="text" name="" id="" value="" placeholder="" class="FilddHalf11" /></td>
                                            </tr>
                                            <tr>
                            ...
                            <div class="Popup">
                                <table border="0" cellspacing="0" cellpadding="2" class="PopupDiv">
                                    <tr>
                                        <td align="left" class="PopupHeader" style="color: #ffffff; padding-left: 15px;">CAMERA MASTER</td>
                                    ...
                                    <tr>
                                        <td colspan="2" style="padding: 10px 0 20px 0px;">
                                            <table border="0" cellspacing="0" cellpadding="2">
                                                ...
                                                <tr>
                                                    <td align="right" width="110px;">Camera Identification</td>
                                                    <td>
                                                        <input type="text" name="" id="txtiden" value="" placeholder="" class="FilddHalf112" /></td>
                                                    <td align="right" width="110px;">Camera IP</td>
                                                    <td>
                                                        <input type="text" name="" id="txtip" value="" placeholder="" class="FilddHalf112" /></td>
                                                </tr>
                                                <tr>
                                                    <td align="right" width="110px;">Camera Port</td>
                                                    <td>
                                                        <input type="text" name="" id="txtport" value="" placeholder="" class="FilddHalf112" />
                                                    </td>                                                   
                                                </tr>                                                                                                                                              
                                            </table>
                                        </td>
        ...
        <script type="text/javascript">  
            $(document).ready(function () {
                $("#search1").keyup(function () {
                    ...
                    $.ajax({
                        type: "POST",
                        url: "/AveryService/WebService1.asmx/Get_CameraMaster",
                        ...
                        success: function (response) {
                            ...
                            $.each(obj, function (key, value) {
                                if (count == 0) {
                                    ...
                                    row = row + '<tr><td align="right" width="110px;">Camera Identification</td> <td><input type="text" name="" id="" value="' + value.CameraIndentification + '" placeholder="" class="FilddHalf11" /></td></tr>';
                                    row = row + '<tr><td align="right" width="110px;">Camera IP</td> <td><input type="text" name="" id="" value="' + value.CameraIP + '" placeholder="" class="FilddHalf11" /></td></tr>';
                                    ...
                                    row = row + '<tr><td align="right" width="110px;">Machine ID</td> <td><input type="text" name="" id="" value="' + value.MachineId + '" placeholder="" class="FilddHalf11" /></td></tr>';
                                    row = row + '<tr><td align="right" width="110px;">Camera Identification</td> <td><input type="text" name="" id="" value="' + value.CameraIndentification + '" placeholder="" class="FilddHalf11" /></td></tr>';
                                    row = row + '<tr><td align="right" width="110px;">Camera IP</td> <td><input type="text" name="" id="" value="' + value.CameraIP + '" placeholder="" class="FilddHalf11" /></td>';
                                    row = row + '<tr><td align="right"></td><td align="right"><a href="javascript:void(0);" data-id="'+value.Id+'" class="MainPopBtn" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage("Image37","","/images/fullscreen_hover.png",1)"><img src="/images/fullscreen_normal.png" name="Image37" width="26" height="26" border="0" id="Image37" /></a></td></tr></table></td>';
                                    $("#tblsearch").append(row);
                                    count = 0;
