<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="Avery_Weigh.Camera_Master.List" %>
            ...
            <div class="MiddleSection">
                ...
                <div class="RightSec">
                    <div class="RightInn11" style="overflow:hidden">
                        <h4>CONFIGURATION</h4>
                        <h4 class="SupplierSearchBig">CAMERA MASTER<a href="/ConfigurationMaster" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image32','','/images/close_hover.png',1)" class="CloseButtonA">
                                ...
                                <asp:Repeater ID="rptList" runat="server" OnItemCreated="rptList_ItemCreated">
                                    <HeaderTemplate>
                                        <tr>
                                            ...
                                            <td align="center" valign="middle" bgcolor="#d8e7ee">Plant Code Id</td>
                                            <td align="center" valign="middle" bgcolor="#d8e7ee">Machine Id</td>
                                            <td align="center" valign="middle" bgcolor="#d8e7ee">Camera Identification</td> 
                                            <td align="center" valign="middle" bgcolor="#d8e7ee">Camera IP</td> 
                                            <td align="center" valign="middle" bgcolor="#d8e7ee">Camera PORT</td>                                                                                      
                                        </tr>
                                    </HeaderTemplate>
                                    <ItemTemplate>
                                        <tr class="trclass" data-RowId="<%#Eval("Id")%>"">
                                            ...
                                            <td align="center" valign="middle"><%#Eval("CameraIdentification") %></td>
                                            <td align="center" valign="middle"><%#Eval("CameraIP") %></td>
                                            <td align="center" valign="middle"><%#Eval("CameraPORT") %></td>                                         
                                        </tr>
                                    </ItemTemplate>
                                </asp:Repeater>
                            </table>
