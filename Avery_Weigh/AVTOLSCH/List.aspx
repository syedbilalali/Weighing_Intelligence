<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="Avery_Weigh.AVTOLSCH.List" %>
        ...
        <div class="Wrapper WeighMain">
            ...
            <div class="MiddleSection">
                ...
                <div id="div_print" class="RightSec">
                    <div class="RightInn11 textcon" style="overflow: hidden">
                        <h4>CONFIGURATION</h4>
                        <h4 class="SupplierSearchBig">TARE WEIGHT TOLERANCE TYPE <a href="/ManageMasters" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image32','','/images/close_hover.png',1)" class="CloseButtonA">
                        ...
                        <div class="RightInnMasters">
                                    ...
                                    <asp:Repeater ID="rptList" runat="server" OnItemCreated="rptList_ItemCreated">
                                        <HeaderTemplate>
                                            <tr>
                                                ...
                                                <td align="center" valign="middle" bgcolor="#d8e7ee">Description</td>
                                                <td align="center" valign="middle" bgcolor="#d8e7ee">weightvalue</td>
                                               <%-- <td align="center" valign="middle" bgcolor="#d8e7ee">kerb Wt</td>
                                                <td align="center" valign="middle" bgcolor="#d8e7ee">Gross vehicle wt.</td>
                                                <td align="center" valign="middle" bgcolor="#d8e7ee">UOM for Weight</td>--%>
                                            </tr>
                                        </HeaderTemplate>
                                        <ItemTemplate>
                                            <tr class="trclass" data-rowid="<%#Eval("Id")%>">
                                                ...
                                                <td align="center" valign="middle"><%#Eval("Description") %></td>
                                                <td align="center" valign="middle"><%#Eval("weightvalue") %></td>
                                                <%--<td align="center" valign="middle"><%#Eval("KerbWt") %></td>
                                                <td align="center" valign="middle"><%#Eval("GrossWeight") %></td>
                                                <td align="center" valign="middle"><%#Eval("UOMWeight") %></td>--%>
                                            </tr>
                                        </ItemTemplate>
                                    </asp:Repeater>
                                </table>
                            ...
                            <table id="tblNone" runat="server" visible="false" style="width: 100%;" border="1" bordercolor="#72aac0" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF" class="MainLTable">
                                <thead>
                                    <tr>
                                        <td align="center" valign="middle" bgcolor="#d8e7ee">No.</td>
                                        <td align="center" valign="middle" bgcolor="#d8e7ee">Tolerance Type</td>
                                        <td align="center" valign="middle" bgcolor="#d8e7ee">Value</td>
                                       <%-- <td align="center" valign="middle" bgcolor="#d8e7ee">kerb Wt</td>
                                        <td align="center" valign="middle" bgcolor="#d8e7ee">Gross vehicle wt.</td>
                                        <td align="center" valign="middle" bgcolor="#d8e7ee">UOM for Weight</td>--%>
                                    </tr>
            ...
            <div class="footer">
                <ul class="selected">
                    ...
                    <li><asp:LinkButton ID="LnkExport" OnClick="LnkExport_Click" runat="server" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image15','','/images/type4/import_hover.png',1)">
                    ...
                    <li>
                        <asp:LinkButton runat="server" ID="Delete" OnClick="Delete_Click" OnClientClick="return Delete();" CommandName="Delete" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image17','','/images/type4/delete_hover.png',1)">
