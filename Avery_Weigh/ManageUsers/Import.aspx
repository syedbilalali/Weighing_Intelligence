<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Import.aspx.cs" Inherits="Avery_Weigh.ManageUsers.Import" %>
            ...
            <div class="MiddleSection">
                ...
                <div class="RightSec">
                    <div class="RightInn11">
                        <h4>MASTERS</h4>
                        <h4 class="SupplierSearchBig">USER MASTER IMPORT <a href="PackingList.aspx" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image32','','/images/close_hover.png',1)" class="CloseButtonA">
                    ...
                    <div class="RightInn11">
                        ...
                        <div class="RightInnMasters">
                            ...
                            <div style="width: 50%; float: right; display: inline-block; text-align: left">
                                ...
                                <h2 style="color:red">Instructions for import xlsx file</h2>
                                <table style="border:1px solid red">
                                    <tr>
                                        <td>1</td>
                                        <td>User Name should less than or equal to 25 character</td>
                                    </tr>
                                     <tr>
                                        <td>2</td>
                                        <td>Password should less than or equal to 15 character</td>
                                    </tr>
                                     <tr>
                                        <td>3</td>
                                        <td>User Type should less than or equal to 25 character</td>
                                    </tr>
                                     <tr>
                                        <td>4</td>
