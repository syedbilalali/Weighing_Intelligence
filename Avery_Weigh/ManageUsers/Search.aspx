<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Search.aspx.cs" Inherits="Avery_Weigh.ManageUsers.Search" %>
...
<head runat="server">
    ...
    <script>
        $(document).on("click", ".MainPopBtn", function () {
            ...
            $.ajax({
                type: "POST",
                url: "/AveryService/WebService1.asmx/Get_UserMasterById",
                data: "{'id':'" + id + "'}",
                ...
                success: function (response) {
                    ...
                    console.log(obj);
                    $('#txtusername').val(obj._UserMaster.UserName);
                    $('#txtusertype').val(obj._UserClassification.UserType);
                    $('#txtplantcode').val(obj._PlantMaster.PlantCode);
                    $('#txtweighbridgeid').val(obj.WeighbridgeId);
            ...
            <div class="MiddleSection">
                ...
                <div class="RightSec">
                    <div class="RightInn11" style="overflow:hidden">
                        <h4>CONFIGURATION</h4>
                        <h4 class="SupplierSearchBig">USER CONFIGURATION | SEARCH <a href="List.aspx" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image32','','images/close_hover.png',1)" class="CloseButtonA">
                        ...
                        <div class="RightInn33">
                                ...
                                <tr>
                                    <td class="TableDiv">
                                        <table border="0" cellspacing="0" cellpadding="2">
                                            <tr>
                                                <td align="right" width="110px;">User Name</td>
                                                <td>
                                            ...
                                            <tr>
                                                <td align="right">Weighbridge Id</td>
                                                <td>
                                                    <input type="text" name="" id="" value="" placeholder="" class="FilddHalf11" /></td>
                                            </tr>
                                            <tr>
                            ...
                            <div class="Popup">
                                <table border="0" cellspacing="0" cellpadding="2" class="PopupDiv">
                                    <tr>
                                        <td align="left" class="PopupHeader" style="color: #ffffff; padding-left: 15px;">USER MASTER</td>
                                        ...
                                        <td colspan="2" style="padding: 10px 0 20px 0px;">
                                            <table border="0" cellspacing="0" cellpadding="2">
                                                <tr>
                                                    <td align="right" width="110px;">User Name</td>
                                                    <td>
                                                        <input type="text" name="" id="txtusername" value="" placeholder="" class="FilddHalf112" /></td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td align="right" width="110px;">Weighbridge Id</td>
                                                    <td>
                                                        <input type="text" name="" id="txtweighbridgeid" value="" placeholder="" class="FilddHalf112" /></td>
                                                </tr>
                                            </table>
                                        </td>
                                    </tr>
     ...
     <script type="text/javascript">  
            $(document).ready(function () {
                $("#search1").keyup(function () {
                    ...
                    $.ajax({
                        type: "POST",
                        url: "/AveryService/WebService1.asmx/Get_UserMaster",
                        ...
                        success: function (response) {
                            ...
                            $.each(obj, function (key, value) {
                                if (count == 0)
                                {
                                    ...
                                    row = row + '<tr><td align="right" width="110px;">User Name</td> <td><input type="text" name="" id="" value="' + value._UserMaster.UserName + '" placeholder="" class="FilddHalf11" /></td></tr>';
                                    row = row + '<tr><td align="right" width="110px;">User Type</td> <td><input type="text" name="" id="" value="' + value._UserClassification.UserType + '" placeholder="" class="FilddHalf11" /></td></tr>';
                                    row = row + '<tr><td align="right" width="110px;">Plant Code</td> <td><input type="text" name="" id="" value="' + value._PlantMaster.PlantCode + '" placeholder="" class="FilddHalf11" /></td></tr>';
                                    row = row + '<tr><td align="right" width="110px;">Weighbridge Id</td> <td><input type="text" name="" id="" value="' + value.WeighbridgeId + '" placeholder="" class="FilddHalf11" /></td></tr>';
                                    row = row + '<tr><td align="right"></td><td align="right"><a href="javascript:void(0);" data-id="'+value._UserMaster.Id+'" class="MainPopBtn" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage("Image37","","/images/fullscreen_hover.png",1)"><img src="/images/fullscreen_normal.png" name="Image37" width="26" height="26" border="0" id="Image37" /></a></td></tr></table></td>';
                                    ...
                                    row = row + '<tr><td align="right" width="110px;">User Type</td> <td><input type="text" name="" id="" value="' + value._UserClassification.UserType + '" placeholder="" class="FilddHalf11" /></td></tr>';
                                    row = row + '<tr><td align="right" width="110px;">Plant Code</td> <td><input type="text" name="" id="" value="' + value._PlantMaster.PlantCode + '" placeholder="" class="FilddHalf11" /></td></tr>';
                                    row = row + '<tr><td align="right" width="110px;">Weighbridge Id</td> <td><input type="text" name="" id="" value="' + value.WeighbridgeId + '" placeholder="" class="FilddHalf11" /></td>';
                                    row = row + '<tr><td align="right"></td><td align="right"><a href="javascript:void(0);" data-id="'+value._UserMaster.Id+'" class="MainPopBtn" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage("Image37","","/images/fullscreen_hover.png",1)"><img src="/images/fullscreen_normal.png" name="Image37" width="26" height="26" border="0" id="Image37" /></a></td></tr></table></td>';
                                    $("#tblsearch").append(row);
                                    count = 0;
