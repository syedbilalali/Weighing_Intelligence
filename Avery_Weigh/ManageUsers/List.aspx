<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="Avery_Weigh.ManageUsers.List" %>
        ...
        <div class="Wrapper WeighMain">
            ...
            <div class="MiddleSection">
                ...
                <div class="RightSec">
                    <div class="RightInn11 textcon" style="overflow:hidden">
                        <h4>CONFIGURATION</h4>
                        <h4 class="SupplierSearchBig">USERS MASTER <a href="/ConfigurationMaster" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image32','','/images/close_hover.png',1)" class="CloseButtonA">
                            ...
                            <div id="dbMain" runat="server" style="display: none;">
                                <table style="width: 100%;" border="1" bordercolor="#72aac0" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF" class="MainLTable">
                                    <asp:Repeater ID="rptList" runat="server" OnItemCreated="rptList_ItemCreated">
                                        ...
                                        <ItemTemplate>
                                            <tr class="trclass" data-rowid="<%#Eval("_UserMaster.Id") %>">
                                                <td align="center" valign="middle"><asp:Label ID="lblindex" runat="server"></asp:Label></td>
                                                <td align="center" valign="middle"><%#Eval("_UserMaster.UserName") %></td>
                                                <td align="center" valign="middle"><%#Eval("_UserClassification.UserType") %></td>
                                                <td align="center" valign="middle"><%#Eval("_PlantMaster.PlantName") %></td>
                                            </tr>
                                        </ItemTemplate>
                                    </asp:Repeater>
                                </table>
            ...
            <div class="footer">
                <ul class="selected">
                    ...
                    <li><asp:LinkButton ID="BtnExport" runat="server" OnClick="BtnExport_Click" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image15','','/images/type4/import_hover.png',1)">
                    ...
                    <li><asp:LinkButton ID="BtnDelete" runat="server" OnClientClick="return ValidateDelete();" OnClick="BtnDelete_Click" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image17','','/images/type4/delete_hover.png',1)">
