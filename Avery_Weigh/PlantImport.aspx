<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PlantImport.aspx.cs" Inherits="Avery_Weigh.PlantImport" %>
            ...
            <div class="MiddleSection">
                ...
                <div class="RightSec">
                    <div class="RightInn11">
                        <h4>MASTERS</h4>
                        <h4 class="SupplierSearchBig">PLANT MASTER IMPORT <a href="PlantList.aspx" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image32','','/images/close_hover.png',1)" class="CloseButtonA">
                    ...
                    <div class="RightInn11">
                        ...
                        <div class="RightInnMasters">
                            ...
                            <div id="dbMain" runat="server" style="width: 50%; float: left; display: inline-block">
                                <h3>Select File to Import</h3>
                                <asp:FileUpload ID="FileUpload1" runat="server" />
                            </div>
                            <div style="width: 50%; float: right; display: inline-block; text-align: left">
                                <div style="height: 50px"></div>
                                <h2 style="color:red">Instruction for Import .xlsx file</h2>
                                <table style="border: 1px solid red">
                                    <tr>
                                        <td>1</td>
                                        <td>Plant Code should less than or equal to 10 character</td>
                                    </tr>
                                    <tr>
                                        <td>2</td>
                                        <td>Plant Name Should Less than or equal to 25 character</td>
                                    </tr>
                                    <tr>
                                        <td>3</td>
                                        <td>Plant Address1 Should Less than or equal to 25 character</td>
                                    </tr>
                                     <tr>
                                        <td>4</td>
                                        <td>Plant Address2 Should Less than or equal to 25 character</td>
                                    </tr>
                                     <tr>
                                        <td>5</td>
                                        <td>Plant Contact Person Should Less than or equal to 25 character</td>
                                    </tr>
                                     <tr>
                                        <td>6</td>
                                        <td>Designation Should Less than or equal to 25 character</td>
                                    </tr>
                                     <tr>
                                        <td>7</td>
                                        <td>Contact Mobile Should Less than or equal to 15 character</td>
                                    </tr>
                                     <tr>
                                        <td>8</td>
                                        <td>Contact Email Should less than or equal to 25 character</td>
                                    </tr>
                                     <tr>
                                        <td>9</td>
                                        <td>No Of Machines should less than or equal to 3 character and it should be in numeric format</td>
                                    </tr>
                                </table>
                            </div>
                        </div>
                ...
                <div class="footer">
                    <ul class="selected">
                        ...
                        <li>
                            <asp:LinkButton ID="LnkSave" OnClick="LnkSave_Click" OnClientClick="return validatefileupload();" runat="server" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image13','','/images/type4/save_hover.png',1)">
