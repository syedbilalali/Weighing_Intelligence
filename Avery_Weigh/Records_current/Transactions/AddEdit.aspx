<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddEdit.aspx.cs" Inherits="Avery_Weigh.Records.Transactions.AddEdit" %>
            ...
            <div class="MiddleSection">
                ...
                <div class="RightSec">
                    <div class="RightInn11" style="overflow: hidden">
                        <h4>MASTERS</h4>
                        <h4 class="SupplierSearchBig">TRANSACTION RECORDS <a href="List.aspx" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image32','','/images/close_hover.png',1)" class="CloseButtonA">
                        ...
                        <div class="RightInnMasters">
                            ...
                            <table border="0" cellspacing="0" cellpadding="2">
                                <tr>
                                    ...
                                    <td>
                                        <asp:TextBox ID="txtTripID" CssClass="FilddHalf112" runat="server"></asp:TextBox>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:CheckBox ID="chkIsMultiProduct" runat="server" />
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:TextBox ID="txtTruckNo" CssClass="FilddHalf112" runat="server"></asp:TextBox>
                                    </td>
                                ...
                                <tr>
                                    <td align="right" width="150px;">Shift</td>
                                    <td>
                                ...
                                <asp:Repeater ID="rptList" runat="server" OnItemCreated="rptList_ItemCreated">
                                    <HeaderTemplate>
                                        <tr>
                                            ...
                                            <td align="center" valign="middle" bgcolor="#d8e7ee">Date</td> 
                                            <td align="center" valign="middle" bgcolor="#d8e7ee">Time</td> 
                                        </tr>
                                    </HeaderTemplate>
                                    <ItemTemplate>
                                        <tr class="trclass" data-RowId="<%#Eval("Id")%>"">
                                            ...
                                            <td align="center" valign="middle"><%# Convert.ToDateTime(Eval("WeightDate")).ToShortDateString() %></td>
                                            <td align="center" valign="middle"><%#Convert.ToDateTime(Eval("WeightTime")).ToShortTimeString() %></td>
                                        </tr>
                                    </ItemTemplate>
                                </asp:Repeater>
                            </table>
