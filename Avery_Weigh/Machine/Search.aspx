<%--<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Search.aspx.cs" Inherits="Avery_Weigh.Machine.Search" %>--%>
...
<head runat="server">
    ...
    <script>
        $(document).on("click", ".MainPopBtn", function () {
            ...
            $.ajax({
                        type: "POST",
                        url: "/AveryService/WebService1.asmx/Get_Machines_ByMachineId",
                        data: "{'id':'" + id + "'}",
                        ...
                        success: function (response) {
                            ...
                            $('#txtip').val(obj.IPPort);
                            $('#txtpn').val(obj.PortNo);
                            $('#txtmoc').val(obj.ModeOfComs);
                            $('#txtsn').val(obj.StabilityNos);
                            $('#txtsr').val(obj.StabilityRange);
                            $('#txtzi').val(obj.ZeroInterlock);
                            $('#txtzir').val(obj.ZeroInterlockRange);
                            $('#txttnp').val(obj.TransactionNoPrefix);
                            $('#txttarecheck').val(obj.TareCheck);
                            $('#txtstoredtare').val(obj.StoredTare);
                        },
            ...
            <div class="MiddleSection">
                ...
                <div class="RightSec">
                    <div class="RightInn11">
                        <h4>MASTERS</h4>
                        <h4 class="SupplierSearch">MACHINE | SEARCH    </h4>
                    </div>
                                ...
                                <tr>
                                    <td align="left">
                                        <table width="200" border="0" cellspacing="0" cellpadding="0" style="margin-top: 20px;">
                                            ...
                                            <tr>
                                                <td align="center">
                                                    <select class="DropDown" id="ddlSearch2" style="width: 85%;">
                                                        <option value="Code">Code</option>
                                                        <option value="MachineId">Machine Id</option>
                                                        <option value="IPPort">IP Port</option>
                                                    </select>
                                            ...
                                            <tr>
                                                <td align="center">
                                                    <select class="DropDown" id="ddlSearch3" style="width: 85%;">
                                                        <option value="Code">Code</option>
                                                        <option value="MachineId">Machine Id</option>
                                                        <option value="IPPort">IP Port</option>
                                                    </select>
                                            ...
                                            <tr>
                                                <td align="center">
                                                    <input type="text" name="search3" id="search3" style="width: 80%; margin-top: 12px;" />
                                                </td>
                                            </tr>
                                            <tr>
                                                <td height="40px"></td>
                        ...
                        <div class="RightInn33">
                                ...
                                <tr>
                                    <td class="TableDiv">
                                        <table border="0" cellspacing="0" cellpadding="2">
                                            ...
                                            <tr>
                                                <td align="right">IP Port</td>
                                                <td>
                                                    <input type="text" name="" id="" value="" placeholder="" class="FilddHalf11" /></td>
                                            </tr>
                                            <tr>
                                                <td align="right">Port No</td>
                                                <td>
                                                    <input type="text" name="" id="" value="" placeholder="" class="FilddHalf11" /></td>
                                            </tr>
                                            <tr>
                            ...
                            <div class="Popup">
                                <table border="0" cellspacing="0" cellpadding="2" class="PopupDiv">
                                    <tr>
                                        <td align="left" class="PopupHeader" style="color: #ffffff; padding-left: 15px;">MACHINE</td>
                                    ...
                                    <tr>
                                        <td colspan="2" style="padding: 10px 0 20px 0px;">
                                            <table border="0" cellspacing="0" cellpadding="2">
                                                ...
                                                <tr>
                                                    <td align="right" width="110px;">IP Port</td>
                                                    <td>
                                                        <input type="text" name="" id="txtip" value="" placeholder="" class="FilddHalf112" /></td>
                                                    <td align="right" width="110px;">Port No</td>
                                                    <td>
                                                        <input type="text" name="" id="txtpn" value="" placeholder="" class="FilddHalf112" /></td>
                                                </tr>
                                                <tr>
                                                    <td align="right" width="110px;">Mode Of Coms</td>
                                                    <td>
                                                        <input type="text" name="" id="txtmoc" value="" placeholder="" class="FilddHalf112" /></td>
                                                    <td align="right" width="110px;">Stability Nos</td>
                                                    <td>
                                                        <input type="text" name="" id="txtsn" value="" placeholder="" class="FilddHalf112" /></td>
                                                </tr>
                                                <tr>
                                                    <td align="right" width="110px;">Stability Range</td>
                                                    <td>
                                                        <input type="text" name="" id="txtsr" value="" placeholder="" class="FilddHalf112" /></td>
                                                    <td align="right" width="110px;">Zero Interlock</td>
                                                    <td>
                                                        <input type="text" name="" id="txtzi" value="" placeholder="" class="FilddHalf112" /></td>
                                                </tr>
                                                <tr>
                                                    <td align="right" width="110px;">Zero Interlock Range</td>
                                                    <td>
                                                        <input type="text" name="" id="txtzir" value="" placeholder="" class="FilddHalf112" /></td>
                                                    <td align="right" width="110px;">Transaction No Prefix</td>
                                                    <td>
                                                        <input type="text" name="" id="txttnp" value="" placeholder="" class="FilddHalf112" /></td>
                                                </tr>
                                                <tr>
                                                    <td align="right" width="110px;">Tare Check</td>
                                                    <td>
                                                        <input type="text" name="" id="txttarecheck" value="" placeholder="" class="FilddHalf112" /></td>
                                                    <td align="right" width="110px;">Stored Tare</td>
                                                    <td>
                                                        <input type="text" name="" id="txtstoredtare" value="" placeholder="" class="FilddHalf112" /></td>
                                                </tr>
                                            </table>
                                        </td>
                                    </tr>
        ...
        <script type="text/javascript">  
            $(document).ready(function () {
                $("#search1").keyup(function () {
                    ...
                    var drop3 = $('#ddlSearch3 option:selected').val();
                    console.log($(this).val());
                    $.ajax({
                        type: "POST",
                        url: "/AveryService/WebService1.asmx/Get_MachinesWorkingParameter",
                        data: "{'search1':'" + search1 + "','search2':'" + search2 + "', 'search3':'" + search3 + "', 'drop1':'" + drop1 + "','drop2':'" + drop2 + "','drop3':'" + drop3 + "'}",
                        contentType: "application/json; charset=utf-8",
                        dataType: "json",
                        async: false,
                        success: function (response) {
                            ...
                            $.each(obj, function (key, value) {
                                if (count == 0) {
                                    ...
                                    row = row + '<tr><td align="right" width="110px;">IP Port</td> <td><input type="text" name="" id="" value="' + value.IPPort + '" placeholder="" class="FilddHalf11" /></td></tr>';
                                    row = row + '<tr><td align="right" width="110px;">Port No</td> <td><input type="text" name="" id="" value="' + value.PortNo + '" placeholder="" class="FilddHalf11" /></td></tr>';
                                    ...
                                    row = row + '<tr><td align="right" width="110px;">Machine Id</td> <td><input type="text" name="" id="" value="' + value.MachineId + '" placeholder="" class="FilddHalf11" /></td></tr>';
                                    row = row + '<tr><td align="right" width="110px;">IP Port</td> <td><input type="text" name="" id="" value="' + value.IPPort + '" placeholder="" class="FilddHalf11" /></td></tr>';
                                    row = row + '<tr><td align="right" width="110px;">Port No</td> <td><input type="text" name="" id="" value="' + value.PortNo + '" placeholder="" class="FilddHalf11" /></td>';
                                    row = row + '<tr><td align="right"></td><td align="right"><a href="javascript:void(0)" data-id="'+value.Id+'" class="MainPopBtn" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage("Image37","","/images/fullscreen_hover.png",1)"><img src="/images/fullscreen_normal.png" name="Image37" width="26" height="26" border="0" id="Image37" /></a></td></tr></table></td>';
                                    $("#tblsearch").append(row);
                                    count = 0;
