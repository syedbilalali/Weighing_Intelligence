<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="Avery_Weigh.Machine.List" %>
            ...
            <div class="MiddleSection">
                ...
                <div id="div_print" class="RightSec">
                    <div class="RightInn11 textcon" style="overflow:hidden">
                        <h4>SERVICES</h4>
                        <h4 class="SupplierSearchBig">MACHINE WORKING PARAMETERS <a href="/ConfigurationMaster" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image32','','/images/close_hover.png',1)" class="CloseButtonA">
                                        ...
                                        <HeaderTemplate>
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th align="center" valign="middle" bgcolor="#d8e7ee">Machine Id</th>
                                                    <th align="center" valign="middle" bgcolor="#d8e7ee">IP Port</th>
                                                    <th align="center" valign="middle" bgcolor="#d8e7ee">Port No</th>
                                                    <th align="center" valign="middle" bgcolor="#d8e7ee">Mode of Coms</th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                        </HeaderTemplate>
                                        <ItemTemplate>
                                            <tr class="trclass" data-rowid="<%#Eval("Id") %>">
                                                <td align="center" valign="middle">
                                                    <asp:Label ID="lblid" runat="server" Visible="false"></asp:Label><%#Eval("PlantCode") %></td>
                                                <td align="center" valign="middle"><%#Eval("MachineId") %></td>
                                                <td align="center" valign="middle"><%#Eval("IPPort") %></td>
                                                <td align="center" valign="middle"><%#Eval("PortNo") %></td>
                                                <td align="center" valign="middle"><%#Eval("ModeOfComs") %></td>
                                            </tr>
                                        </ItemTemplate>
                                        <FooterTemplate>
                                            </tbody>
