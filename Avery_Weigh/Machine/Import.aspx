<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Import.aspx.cs" Inherits="Avery_Weigh.Machine.Import" %>
            ...
            <div class="MiddleSection">
                ...
                <div class="RightSec">
                    <div class="RightInn11">
                        <h4>SERVICES</h4>
                        <h4 class="SupplierSearchBig">MACHINE IMPORT <a href="List.aspx" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image32','','/images/close_hover.png',1)" class="CloseButtonA">
                    ...
                    <div class="RightInn11">
                        ...
                        <div class="RightInnMasters">
                            ...
                            <div id="dbMain" runat="server" style="float:left;display:inline-block;width:50%">
                            ...
                            <div style="width:50%;display:inline-block;float:right;text-align:left">
                                ...
                                <table style="border:1px solid red">
                                    <tr>
                                        <td>1</td>
                                        <td>Plant Code should be less than or equal to 10 character</td>
                                    </tr>
                                    <tr>
                                        <td>2</td>
                                    ...
                                    <tr>
                                        <td>3</td>
                                        <td>IP Port should be less than or equal to 15 character and should be valid</td>
                                    </tr>
                                    <tr>
                                        <td>4</td>
                                        <td>Port No should be less than or equal to 5 character</td>
                                    </tr>
                                    <tr>
                                        <td>5</td>
                                        <td>Stability Nos should be in Numeric format</td>
                                    </tr>
                                    <tr>
                                        <td>6</td>
                                        <td>Zero Interlock should be in "Y" or "N"</td>
                                    </tr>
                                    <tr>
                                        <td>7</td>
                                        <td>Transaction No Prefix should be less than or equal to 3 character</td>
                                    </tr>
                                    <tr>
                                        <td>8</td>
                                        <td>Tare Check should be in "Y" or "N"</td>
                                    </tr>
                                    <tr>
                                        <td>9</td>
                                        <td>Stored Tare should be in "Y" or "N"</td>
                                    </tr>                                   
                                </table>
                            </div>
                        </div>
                ...
                <div class="footer">
                    <ul class="selected">
                        ...
                        <img src="/images/type4/edit_normal.png" name="Image12" width="80" height="50" border="0" id="Image12" /></a></li>
                         <li><asp:LinkButton ID="BtnSave" OnClick="BtnSave_Click" runat="server" OnClientClick="return validate();" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image13','','/images/type4/save_hover.png',1)">
