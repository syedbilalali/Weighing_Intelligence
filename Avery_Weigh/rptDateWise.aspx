<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="rptDateWise.aspx.cs" Inherits="Avery_Weigh.rptDateWise" EnableEventValidation="false" %>
    ...
    <form id="form1" runat="server">
        <div class="Wrapper WeighMain">
            ...
            <div class="MiddleSection">
                <div class="LeftSec">
                    <ul>
                        <li id="Weighment" runat="server"><a href="/Manual_Weighment.aspx" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image4','','/images/type1/weigh_hover.png',1)">
                ...
                <div class="RightSec">
                    <div class="RightInn11 textcon" style="overflow: hidden">
                        <h4>DASHBOARD</h4>
                        <h4 class="SupplierSearchBig">ALL TYPE OF REPORTS <a href="/dashboardmaster" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image32','','images/close_hover.png',1)" class="CloseButtonA">
                    ...
                    <div class="RightInn11">
                        ...
                        <div class="RightInnMasters dashboardmidsec">
                            ...
                            <div id="dbMain" runat="server">
                                <table style="width: 100%;" border="0" class="MainLTable">
                                    <tr>
                                        <td>From :</td>
                                        <td>
                                        ...
                                        <td>Select Type :</td>
                                        <td>
                                            <asp:DropDownList ID="ddlType" runat="server" CssClass="FilddHalf112" AutoPostBack="True" OnSelectedIndexChanged="ddlType_SelectedIndexChanged">
                                                <asp:ListItem Value="0">---Select All---</asp:ListItem>
                                                <asp:ListItem Value="MaterialName">Material Name</asp:ListItem>
                                                <asp:ListItem Value="PartyName">Party Name</asp:ListItem>
                                                <asp:ListItem Value="Transporter">Transporter Name</asp:ListItem>
                                                <asp:ListItem Value="VehicleNo">Vehicle No.</asp:ListItem>
                                                <asp:ListItem Value="PlantCode">Plant Code</asp:ListItem>
                                                <asp:ListItem Value="WeighbridgeId">Weighbridge ID</asp:ListItem>
                                                <asp:ListItem Value="CreatedBy">User</asp:ListItem>
                                                <asp:ListItem Value="Shift">Shift</asp:ListItem>

                                            </asp:DropDownList></td>
                                        <td>
                                            <asp:DropDownList ID="ddlValueType" runat="server" CssClass="FilddHalf112"></asp:DropDownList></td>
                                        <td>
                                    ...
                                    <asp:Repeater ID="rptList" runat="server" OnItemDataBound="rptList_ItemDataBound">
                                        ...
                                        <HeaderTemplate>
                                            ...
                                            <tr>
                                                ...
                                                <td align="center" valign="middle" bgcolor="#d8e7ee">Trip Id</td>
                                                <td align="center" valign="middle" bgcolor="#d8e7ee">Truck No</td>
                                                <td align="center" valign="middle" bgcolor="#d8e7ee">First Wt</td>
                                                <td align="center" valign="middle" bgcolor="#d8e7ee">DateTime In</td>
                                                <td align="center" valign="middle" bgcolor="#d8e7ee">Second Wt</td>
                                                <td align="center" valign="middle" bgcolor="#d8e7ee">DateTime Out</td>
                                                <td align="center" valign="middle" bgcolor="#d8e7ee">Net Wt</td>
                                                <td align="center" valign="middle" bgcolor="#d8e7ee">Material Name</td>
                                                <td align="center" valign="middle" bgcolor="#d8e7ee">Supplier Name</td>
                                                 <td align="center" valign="middle" bgcolor="#d8e7ee">Weighing Unit</td>
                                                <td align="center" valign="middle" bgcolor="#d8e7ee">User</td>
                                                 <td align="center" valign="middle" bgcolor="#d8e7ee">Shift</td>
                                            </tr>
                                        ...
                                        <ItemTemplate>
                                                ...
                                                <tr class="trclass" data-rowid="<%#Eval("Id") %>">
                                                    ...
                                                    <td align="center" valign="middle"><%#Eval("TripId") %></td>
                                                    <td align="center" valign="middle"><%#Eval("TruckNo") %></td>
                                                    <td align="center" valign="middle"><%#Eval("FirstWeight","{0:00}") %></td>
                                                    <td align="center" valign="middle"><%#Eval("FirstWtDateTime") %></td>
                                                    <td align="center" valign="middle"><%#Eval("SecondWeight","{0:00}") %></td>
                                                    <td align="center" valign="middle"><%#Eval("SecondWtDateTime") %></td>
                                                    <td align="center" valign="middle"><%#Eval("NetWeight","{0:00}") %></td>
                                                    ...
                                                    <td align="center" valign="middle"><%#Eval("CreatedBy") %></td>
                                                    <td align="center" valign="middle"><%#Eval("Shift") %></td>
            ...
            <div class="footer">
                <ul class="selected">
                    ...
                    <li style="float:right">
                        <asp:LinkButton runat="server" ID="lnkprintPDF" OnClick="lnkprintPDF_Click" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image16','','images/type4/print_hover.png',1)">
                        <img src="/images/type4/print_normal.png" name="Image16" width="80" height="50" border="0" id="Image16" /></asp:LinkButton></li>
                     <li style="float:right">
                        <asp:LinkButton runat="server" ID="BtnLinkExport" OnClick="BtnLinkExport_Click" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image15','','images/type4/import_hover.png',1)">
