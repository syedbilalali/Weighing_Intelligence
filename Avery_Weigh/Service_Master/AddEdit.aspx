<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddEdit.aspx.cs" Inherits="Avery_Weigh.Service_Master.AddEdit" %>
...
<body onload="MM_preloadImages('/images/contact/contact_hover.png','/images/contact/info_hover.png','/images/contact/login_hover.png','/images/close_hover.png','/images/fullscreen_hover.png','/images/exit_fullscreen_hover.png','/images/type3/copy_hover.png','/images/type3/previous_page_hover.png','/images/type3/previous_record_hover.png','/images/type3/next_record_hover.png','/images/type3/next_page_hover.png')">
    <form id="form1" runat="server" defaultfocus="select2-ddlamctype-container">
            ...
            <div class="MiddleSection">
                ...
                <div class="RightSec">
                    <div class="RightInn11 textcon" style="overflow: hidden">
                        <h4>SERVICE</h4>
                        <h4 class="SupplierSearchBig">AMC DETAILS <a href="List.aspx" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image32','','/images/close_hover.png',1)" class="CloseButtonA">
                        ...
                        <div class="RightInnMasters">
                            <div class="ConatctIcons2" id="divoptions" style="display: none;" runat="server">
                                <ul>
                                    ...
                                    <li>
                                        <asp:LinkButton ID="First_Record" runat="server" ToolTip="First Record" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('previous_page','','/images/type3/previous_page_hover.png',1)">
                                    ...
                                    <li>
                                        <asp:LinkButton ID="Previous_Record" runat="server" ToolTip="Previous Record" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('previous_record','','/images/type3/previous_record_hover.png',1)">
                                    ...
                                    <li>
                                        <asp:LinkButton runat="server" ID="Next_Record" ToolTip="Next Record" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('next_record','','/images/type3/next_record_hover.png',1)">
                                    ...
                                    <li>
                                        <asp:LinkButton runat="server" ID="Last_Record" ToolTip="Last Record" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('next_page','','/images/type3/next_page_hover.png',1)">
                            ...
                            <table border="0" cellspacing="0" cellpadding="2">
                                <tr>
                                    <td align="right" width="150px;">AMC Type</td>
                                    <td>
                                        <asp:DropDownList ID="ddlamctype" runat="server" CssClass="FilddHalf112" Width="287px" AutoPostBack="True" OnSelectedIndexChanged="ddlamctype_SelectedIndexChanged">
                                ...
                                <tr>
                                    <td align="right" width="150px;">Warranty</td>
                                    <td>
                                         <asp:DropDownList ID="ddlWarrantee" runat="server" CssClass="FilddHalf112" Width="287px" AutoPostBack="True" OnSelectedIndexChanged="ddlWarrantee_SelectedIndexChanged" OnTextChanged="ddlWarrantee_TextChanged">
                                            <asp:ListItem Value="">Select</asp:ListItem>
                               ...
                               <tr>
                                   <%-- <td align="right" width="150px;" >Guarantee</td>--%>
                                    <td>
                                         <asp:DropDownList ID="ddlGarrantee" runat="server" CssClass="FilddHalf112" Width="287px" Visible="false">
                                            <asp:ListItem Value="">Select</asp:ListItem>
                                            <asp:ListItem Value="Yes">Yes</asp:ListItem>
                                            <asp:ListItem Value="No">No</asp:ListItem>
                               ...
                               <%-- <tr>
                                    <td align="right" width="150px;">Warranty Valid Upto</td>
                                    <td>
                                        <asp:TextBox ID="txtWarrantyValidUpto" CssClass="FilddHalf112" runat="server" class="dateselect"></asp:TextBox>
                                    </td>
                                </tr>--%>
                                <tr>
                                    <td align="right" width="150px;">AMC Contact Number</td>
                                    <td>
                                        <asp:TextBox ID="txtamccontactnumber" CssClass="FilddHalf112" runat="server" MaxLength="20"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                    <td align="right" width="150px;">AMC Valid Upto</td>
                                    <td>
                                        <asp:TextBox ID="txtamcvalidupto" CssClass="FilddHalf112" runat="server" class="dateselect"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                    <td align="right" width="150px;">AMC Reminder</td>
                                    <td>
                                        <asp:TextBox ID="txtamcreminder" runat="server" CssClass="FilddHalf112" MaxLength="2"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                    <td align="right" width="150px;">Stamping Date</td>
                                    <td>
                                        <asp:TextBox ID="txtstampingdate" runat="server" CssClass="FilddHalf112" class="dateselect"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                    <td align="right" width="150px;">Stamping Reminder</td>
                                    <td>
                                        <asp:TextBox ID="txtstampingreminder" runat="server" CssClass="FilddHalf112" MaxLength="2"></asp:TextBox>
                                    </td>
                                </tr>
    ...
    <script type="text/javascript">
        function validateForm() {
            var result = true;
            var amctype = $('#ddlamctype option:selected').val();
            if (amctype == '') {
                toastr.error('Please Select AMC Type');
                $('#ddlamctype').css("border", "solid 1px red");
                result = false;
            }
            return result;
        }
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $("#txtstampingreminder").keydown(function (e) {
            ...
            $("#txtamcreminder").keydown(function (e) {
                if ($.inArray(e.keyCode, [46, 8, 9, 27, 13, 110, 190]) !== -1 ||
                    ((e.keyCode == 65 || e.keyCode == 86 || e.keyCode == 67) && (e.ctrlKey === true || e.metaKey === true)) ||
                    (e.keyCode >= 35 && e.keyCode <= 40)) {
                    return;
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            $('#txtstampingdate').datepicker({
                dateFormat: 'dd/mm/yy',
                changeMonth: true,
                changeYear: true
            });
            $('#txtamcvalidupto').datepicker({
                dateFormat: 'dd/mm/yy',
                changeMonth: true,
                changeYear: true
            });  
            $('#txtWarrantyValidUpto').datepicker({
                dateFormat: 'dd/mm/yy',
                changeMonth: true,
                changeYear: true
            });    
