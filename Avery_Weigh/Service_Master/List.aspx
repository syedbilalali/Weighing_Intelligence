<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="Avery_Weigh.Service_Master.List" %>
            ...
            <div class="MiddleSection">
                ...
                <div class="RightSec">
                    <div class="RightInn11 textcon" style="overflow: hidden">
                        <h4>SERVICES</h4>
                        <h4 class="SupplierSearchBig">SERVICE MASTER<a href="/ManageServices" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image32','','/images/close_hover.png',1)" class="CloseButtonA">
                                ...
                                <asp:Repeater ID="rptList" runat="server" OnItemCreated="rptList_ItemCreated">
                                    <HeaderTemplate>
                                        <tr>
                                            ...
                                            <td align="center" valign="middle" bgcolor="#d8e7ee">AMC Type</td>
                                            <td align="center" valign="middle" bgcolor="#d8e7ee">AMC Contact No</td>
                                            <td align="center" valign="middle" bgcolor="#d8e7ee">AMC Valid Upto</td> 
                                            <td align="center" valign="middle" bgcolor="#d8e7ee">AMC Reminder</td> 
                                            <td align="center" valign="middle" bgcolor="#d8e7ee">Stamping Date</td>
                                              <td align="center" valign="middle" bgcolor="#d8e7ee">Stamping Reminder</td>
                                        </tr>
                                    </HeaderTemplate>
                                    <ItemTemplate>
                                        <tr class="trclass" data-RowId="<%#Eval("Id")%>"">
                                            <td align="center" valign="middle"><asp:Label ID="lblindex" runat="server"></asp:Label></td>
                                            <td align="center" valign="middle"><%#Eval("AMCType") %></td>
                                            <td align="center" valign="middle"><%#Eval("AMCContactNo") %></td>
                                            <td align="center" valign="middle"><%# string.Format("{0:dd/MM/yyyy}", Eval("AMCValidUpto"))%></td>
                                            <td align="center" valign="middle"><%#Eval("AMCReminder") %></td>
                                            <td align="center" valign="middle"><%# string.Format("{0:dd/MM/yyyy}", Eval("StampingDate"))%></td>
                                             <td align="center" valign="middle"><%#Eval("StampingReminder") %></td> 
                                        </tr>
                                    </ItemTemplate>
                                </asp:Repeater>
                            </table>
            ...
            <div class="footer">
                <ul class="selected">
                 ...
                 <%--   <li><asp:LinkButton runat="server" Visible="false" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image13','','/images/type4/save_hover.png',1)">
                    ...
                    <li><asp:LinkButton ID="Delete"  runat="server" OnClick="Delete_Click"  OnClientClick="return Delete();" CommandName="Delete" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image17','','/images/type4/delete_hover.png',1)">
