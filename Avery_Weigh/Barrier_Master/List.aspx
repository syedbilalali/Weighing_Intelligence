<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="Avery_Weigh.Barrier_Master.List" %>
            ...
            <div class="MiddleSection">
                ...
                <div class="RightSec">
                    <div class="RightInn11" style="overflow:hidden">
                        <h4>CONFIGURATION</h4>
                        <h4 class="SupplierSearchBig">BARRIER MASTER<a href="/ConfigurationMaster" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image32','','/images/close_hover.png',1)" class="CloseButtonA">
                                ...
                                <asp:Repeater ID="rptList" runat="server" OnItemCreated="rptList_ItemCreated">
                                    <HeaderTemplate>
                                        <tr>
                                            ...
                                            <td align="center" valign="middle" bgcolor="#d8e7ee">Machin Id</td>
                                            <td align="center" valign="middle" bgcolor="#d8e7ee">Barrier Identification</td> 
                                            <td align="center" valign="middle" bgcolor="#d8e7ee">Barrier IP</td> 
                                            <td align="center" valign="middle" bgcolor="#d8e7ee">Barrier PORT</td>
                                            <td align="center" valign="middle" bgcolor="#d8e7ee">Barrier Scheme</td> 
                                    ...
                                    <ItemTemplate>
                                        <tr class="trclass" data-RowId="<%#Eval("Id")%>"">
                                            ...
                                            <td align="center" valign="middle"><%#Eval("BarrierIdentification") %></td>
                                            <td align="center" valign="middle"><%#Eval("BarrierIP") %></td>
                                            <td align="center" valign="middle"><%#Eval("BarrierPORT") %></td>
                                            <td align="center" valign="middle"><%#Eval("BarrierScheme") %></td>
                                        </tr>
                                    </ItemTemplate>
                                </asp:Repeater>
                            </table>
            ...
            <div class="footer">
                <ul class="selected">
                 ...
                 <%--   <li><asp:LinkButton runat="server" Visible="false" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image13','','/images/type4/save_hover.png',1)">
                    ...
                    <li><a href="Import.aspx" runat="server" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Imag14','','/images/type4/export_hover.png',1)">
