<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddEdit.aspx.cs" Inherits="Avery_Weigh.Barrier_Master.AddEdit" %>
            ...
            <div class="MiddleSection">
                ...
                <div class="RightSec">
                    <div class="RightInn11" style="overflow:hidden">
                        <h4>CONFIGURATION</h4>
                        <h4 class="SupplierSearchBig">BARRIER MASTER <a href="List.aspx" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image32','','/images/close_hover.png',1)" class="CloseButtonA">
                        ...
                        <div class="RightInnMasters">
                            ...
                            <table border="0" cellspacing="0" cellpadding="2">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:DropDownList ID="ddlmachinid" DataTextField="MachineId" DataValueField="MachineId" Width="287px" CssClass="FilddHalf112" runat="server"></asp:DropDownList>
                                    </td>
                                </tr>
                                <tr>
                                    <td align="right" width="150px;">Barrier Identification</td>
                                    <td>
                                        <asp:TextBox ID="txtidentification" CssClass="FilddHalf112" runat="server" MaxLength="10"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                    <td align="right" width="150px;">Barrier IP</td>
                                    <td>
                                        <asp:TextBox ID="txtip" runat="server" CssClass="FilddHalf112" MaxLength="15"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                    <td align="right" width="150px;">Barrier PORT</td>
                                    <td>
                                        <asp:TextBox ID="txtport" runat="server" CssClass="FilddHalf112" MaxLength="5"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                    <td align="right" width="150px;">Barrier Scheme</td>
                                    <td>
                                        <asp:DropDownList runat="server" ID="ddlscheme" Width="287px" CssClass="FilddHalf112">
                                            <asp:ListItem Text="Select Scheme" Value=""></asp:ListItem>
        ...
        $(document).ready(function () {
            ...
            $('#ddlmachinid').change(function () {
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        if (data.d != '') {
                            toastr.warning('Only 2 Barriers allow in 1 plant!');
                        }
                    },
                    error: function (data) {
                        console.log(data);
            ...
            $('#txtip').change(function () {
                ...
                $.ajax({
                    ...
                    contentType: 'application/json;charset=utf-8',
                    dataType: 'json',
                    data: "{plantcode:'" + plantcode + "', barrierip:'" + barrierip + "'}",
                    success: function (data) {
                        if (data.d != '') {
