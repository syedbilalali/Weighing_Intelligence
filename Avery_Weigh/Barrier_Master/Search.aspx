<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Search.aspx.cs" Inherits="Avery_Weigh.Barrier_Master.Search" %>
...
<head runat="server">
    ...
    <script>
        $(document).on("click", ".MainPopBtn", function () {
            ...
            $.ajax({
                type: "POST",
                url: "/AveryService/WebService1.asmx/Get_BarrierByCode",
                data: "{'code':'" + code + "'}",
                ...
                success: function (response) {
                    ...
                    console.log(obj);
                    $('#txtplantcode').val(obj.PlantCodeId);
                    $('#txtmachineid').val(obj.MachineId);
                    $('#txtidentification').val(obj.BarrierIdentification);
                    $('#txtip').val(obj.BarrierIP);
                    $('#txtport').val(obj.BarrierPort);
                    $('#txtscheme').val(obj.BarrierScheme);
                },
            ...
            <div class="MiddleSection">
                ...
                <div class="RightSec">
                    <div class="RightInn11" style="overflow: hidden">
                        <h4>CONFIGURATION</h4>
                        <h4 class="SupplierSearchBig">BARRIER MASTER | SEARCH <a href="List.aspx" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image32','','/images/close_hover.png',1)" class="CloseButtonA">
                                ...
                                <tr>
                                    <td align="left">
                                        <table width="200" border="0" cellspacing="0" cellpadding="0" style="margin-top: 20px;">
                                            ...
                                            <tr>
                                                <td align="center">
                                                    <select class="DropDown" id="ddlSearch1" style="width: 85%; float: right">
                                                        <option value="Code">Plant Code</option>
                                                        <option value="Name">Machine ID</option>
                                                        <option value="IP">Barrier IP</option>
                                                    </select>
                                                </td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                <td align="center" >
                                                <select class="DropDown" id="ddlSearch2" style="width: 85%; margin-top: 12px; float: right">
                                                    <option value="Name">Machine ID</option>
                                                    <option value="Code">Plant Code</option>
                                                    <option value="IP">Barrier IP</option>
                                                </select>
                                            ...
                                            <tr>
                                                <td align="center" >
                                                    <select class="DropDown" id="ddlSearch3" style="width: 85%; margin-top: 12px; float: right">
                                                        <option value="IP">Barrier IP</option>
                                                        <option value="Code">Plant Code</option>
                                                        <option value="Name">Machine ID</option>
                                                    </select>
                                            ...
                                            <tr>
                                                <td align="center">
                                                    <input type="text" name="search3" id="search3" style="width: 75%; margin-top: 12px; float: right" />
                                                </td>
                                            </tr>
                        ...
                        <div class="RightInn33">
                                ...
                                <tr>
                                    <td class="TableDiv">
                                        <table border="0" cellspacing="0" cellpadding="2">
                                            ...
                                            <tr>
                                                <td align="right">Barrier Identification</td>
                                                <td>
                                                    <input type="text" name="" id="" value="" placeholder="" class="FilddHalf11" /></td>
                                            </tr>
                                            <tr>
                                                <td align="right">Barrier IP</td>
                                                <td>
                                                    <input type="text" name="" id="" value="" placeholder="" class="FilddHalf11" /></td>
                                            </tr>
                                            <tr>
                            ...
                            <div class="Popup">
                                <table border="0" cellspacing="0" cellpadding="2" class="PopupDiv">
                                    <tr>
                                        <td align="left" class="PopupHeader" style="color: #ffffff; padding-left: 15px;">TRANSPORTER</td>
                                        ...
                                        <td colspan="2" style="padding: 10px 0 20px 0px;">
                                            <table border="0" cellspacing="0" cellpadding="2">
                                                <tr>
                                                    <td align="right" width="110px;">Plant Code</td>
                                                    <td>
                                                        <input type="text" name="" id="txtplantcode" value="" placeholder="" class="FilddHalf112" /></td>
                                                    <td align="right" width="110px;">Machine ID</td>
                                                    <td>
                                                        <input type="text" name="" id="txtmachineid" value="" placeholder="" class="FilddHalf112" /></td>
                                                </tr>
                                                <tr>
                                                    <td align="right" width="110px;">Barrier Identification</td>
                                                    <td>
                                                        <input type="text" name="" id="txtidentification" value="" placeholder="" class="FilddHalf112" /></td>
                                                    <td align="right" width="110px;">Barrier IP</td>
                                                    <td>
                                                        <input type="text" name="" id="txtip" value="" placeholder="" class="FilddHalf112" /></td>
                                                </tr>
                                                <tr>
                                                    <td align="right" width="110px;">Barrier Port</td>
                                                    <td>
                                                        <input type="text" name="" id="txtport" value="" placeholder="" class="FilddHalf112" /></td>
                                                    <td align="right" width="110px;">Barrier Scheme</td>
                                                    <td>
                                                        <input type="text" name="" id="txtscheme" value="" placeholder="" class="FilddHalf112" /></td>
                                                </tr>
                                            </table>
                                        </td>
                                    </tr>
        ...
        <script type="text/javascript">  
            $(document).ready(function () {
                $("#search1").keyup(function () {
                    ...
                    $.ajax({
                        type: "POST",
                        url: "/AveryService/WebService1.asmx/Get_Barriers",
                        ...
                        success: function (response) {
                            ...
                            $.each(obj, function (key, value) {
                                if (count == 0) {
                                    ...
                                    row = row + '<tr><td align="right" width="110px;">Barrier Identification</td> <td><input type="text" name="" id="" value="' + value.BarrierIdentification + '" placeholder="" class="FilddHalf11" /></td></tr>';
                                    row = row + '<tr><td align="right" width="110px;">Barrier IP</td> <td><input type="text" name="" id="" value="' + value.BarrierIP + '" placeholder="" class="FilddHalf11" /></td></tr>';
                                    ...
                                    row = row + '<tr><td align="right" width="110px;">Machine ID</td> <td><input type="text" name="" id="" value="' + value.MachineId + '" placeholder="" class="FilddHalf11" /></td></tr>';
                                    row = row + '<tr><td align="right" width="110px;">Barrier Identification</td> <td><input type="text" name="" id="" value="' + value.BarrierIdentification + '" placeholder="" class="FilddHalf11" /></td></tr>';
                                    row = row + '<tr><td align="right" width="110px;">Barrier IP</td> <td><input type="text" name="" id="" value="' + value.BarrierIP + '" placeholder="" class="FilddHalf11" /></td>';
                                    row = row + '<tr><td align="right"></td><td align="right"><a href="javascript:void(0);" data-id="' + value.PlantCodeId + '" class="MainPopBtn" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage("Image37","","/images/fullscreen_hover.png",1)"><img src="/images/fullscreen_normal.png" name="Image37" width="26" height="26" border="0" id="Image37" /></a></td></tr></table></td>';
                                    $("#tblsearch").append(row);
                                    count = 0;
