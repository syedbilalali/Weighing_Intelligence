<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PlantInfo.aspx.cs" Inherits="Avery_Weigh.PlantInfo" %>
...
<body onload="MM_preloadImages('images/contact/contact_hover.png','images/contact/info_hover.png','images/contact/login_hover.png','images/close_hover.png','images/fullscreen_hover.png','images/exit_fullscreen_hover.png','images/type3/copy_hover.png','images/type3/previous_page_hover.png','images/type3/previous_record_hover.png','images/type3/next_record_hover.png','images/type3/next_page_hover.png')">
    <form id="form1" runat="server" defaultfocus="txtPlantCOde">
        <div class="Wrapper WeighMain">
            ...
            <div class="MiddleSection">
                ...
                <div class="RightSec">
                    <div class="RightInn11 textcon" style="overflow: hidden">
                        <h4>CONFIGURATION</h4>
                        <h4 class="SupplierSearchBig">PLANT MASTER<a href="PlantList.aspx" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image32','','images/close_hover.png',1)" class="CloseButtonA">
                    ...
                    <div class="RightInn11 supplier">
                        ...
                        <div class="RightInnMasters">
                            <div class="ConatctIcons2" id="divoptions" style="display: none;" runat="server">
                                <ul>
                                    <li><a href="PlantList.aspx" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Copy','','/images/type3/copy_hover.png',1)">
                            ...
                            <table border="0" cellspacing="0" cellpadding="2">
                                <tr>
                                    <td align="right" width="150px;">Plant Code <span class="mandatory">*</span></td>
                                    <td>
                                        <asp:TextBox ID="txtPlantCOde" runat="server" CssClass="FilddHalf112" MaxLength="10"></asp:TextBox></td>
                                    <td align="right" width="150px;">Plant Name <span class="mandatory">*</span></td>
                                    <td>
                                        <asp:TextBox ID="txtPlantName" runat="server" CssClass="FilddHalf112" MaxLength="25"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                    <td align="right" width="150px;">Plant Address 1</td>
                                    <td>
                                        <asp:TextBox ID="txtAddress1" runat="server" CssClass="FilddHalf112" MaxLength="25"></asp:TextBox>
                                    </td>
                                    <td align="right" width="150px;">Plant Address2</td>
                                    <td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:TextBox ID="txtContactPerson" runat="server" CssClass="FilddHalf112" MaxLength="25"></asp:TextBox>
                                    </td>
                                    <td align="right" width="150px;">Designation</td>
                                    <td>
                                        <asp:TextBox ID="txtDesignation" runat="server" CssClass="FilddHalf112" MaxLength="25"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                    <td align="right" width="150px;">Contact Mobile</td>
                                    <td>
                                        <asp:TextBox ID="txtContactMobile" runat="server" CssClass="FilddHalf112" MaxLength="12"></asp:TextBox>
                                    </td>
                                    <td align="right" width="150px;">Contact Email</td>
                                    <td>
                                        <asp:TextBox ID="txtContactEmail" runat="server" CssClass="FilddHalf112" MaxLength="25"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                    <td align="right" width="150px;">No of Machines</td>
                                    <td>
                                        <asp:TextBox ID="txtMachineCount" runat="server" Text="0" CssClass="FilddHalf112" MaxLength="3"></asp:TextBox>
                                    </td>
            ...
            <div class="footer">
                <ul class="selected">
                    ...
                    <li><a href="PlantInfo.aspx" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image12','','images/type4/edit_hover.png',1)">
                        <img src="images/type4/edit_normal.png" name="Image12" width="80" height="50" border="0" id="Image12" /></a></li>
                    <li>
                        <asp:LinkButton runat="server" ID="Save" OnClick="Save_Click" OnClientClick="return validateForm();" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image13','','images/type4/save_hover.png',1)">
                    ...
                    <li><a href="PlantList.aspx" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image15','','images/type4/import_hover.png',1)">
            ...
            <script type="text/javascript">
                function validateForm() {
                    var txtPlantCOde = $('#txtPlantCOde').val().trim();
                    var txtPlantName = $('#txtPlantName').val().trim();
                    var txtContactEmail = $('#txtContactEmail').val().trim();
                    if (txtPlantCOde == "" || txtPlantName == "") {
        ...
        <script type="text/javascript">
            $(document).ready(function () {
                $('#txtPlantCOde').change(function () {
                    debugger;
                    var code = $('#txtPlantCOde').val();
                    $.ajax({
                        type: "POST",
                        url: "/AveryService/WebService1.asmx/Check_PlantMaster",
                        data: "{'code':'" + code + "'}",
                        ...
                        success: function (data) {
                            ...
                            if (data.d != "") {
                                ...
                                console.log(obj);
                                toastr.error('Same Plant Code Exist');
                                $('#txtPlantCOde').focus();
                            }
                        },
                        error: function (data) {
                ...
                $("#txtContactMobile").keydown(function (e) {
                ...
                $("#txtMachineCount").keydown(function (e) {
                    if ($.inArray(e.keyCode, [46, 8, 9, 27, 13, 110, 190]) !== -1 ||
                        ((e.keyCode == 65 || e.keyCode == 86 || e.keyCode == 67) && (e.ctrlKey === true || e.metaKey === true)) ||
                        (e.keyCode >= 35 && e.keyCode <= 40)) {
                        return;
