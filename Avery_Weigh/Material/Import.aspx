<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Import.aspx.cs" Inherits="Avery_Weigh.Material.Import" %>
            ...
            <div class="MiddleSection">
                ...
                <div class="RightSec">
                    <div class="RightInn11">
                        <h4>MASTERS</h4>
                        <h4 class="SupplierSearchBig">MATERIAL IMPORT <a href="List.aspx" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image32','','/images/close_hover.png',1)" class="CloseButtonA">
                    ...
                    <div class="RightInn11">
                        ...
                        <div class="RightInnMasters">
                            ...
                            <div style="display:inline-block;width:50%;float:right;text-align:left">
                                ...
                                <h3 style="color:red">Instruction for import the Material xlsx file</h3>
                                <table style="border:1px solid red">
                                    <tr>
                                        <td>1</td>
                                        <td>Material Code should be less than or equal to 10 character</td>
                                    </tr>
                                    <tr>
                                        <td>2</td>
                                        <td>Material description should be less than or equal to 25 character</td>
                                    </tr>
                                    <tr>
                                        <td>3</td>
