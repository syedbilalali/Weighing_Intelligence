<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Search.aspx.cs" Inherits="Avery_Weigh.Material.Search" %>
...
<head runat="server">
    ...
    <script>
        $(document).on("click", ".MainPopBtn", function () {
            ...
            $.ajax({
                        type: "POST",
                        url: "/AveryService/WebService1.asmx/Get_MaterialByCode",
                        data: "{'code':'" + code + "'}",
                        ...
                        success: function (response) {
                            ...
                            console.log(obj);
                            $('#txtCode').val(obj.MaterialCode);
                            $('#txtmd').val(obj.MaterialDesc);
                            $('#txtpc').val(obj.PackingCode);
                            $('#txtmcc').val(obj.MaterialClassificationCode);                         
                        },
            ...
            <div class="MiddleSection">
                ...
                <div class="RightSec">
                    <div class="RightInn11">
                        <h4>MASTERS</h4>
                        <h4 class="SupplierSearchBig">MATERIAL | SEARCH    </h4>
                    </div>
                                            ...
                                            <tr>
                                                <td align="center">
                                                    <select class="DropDown" id="ddlSearch1" style="width: 85%;">
                                                        ...
                                                        <option value="Name">Material Desc</option>
                                                    </select>
                                                </td>
                                            </tr>
                                            <tr>
                        ...
                        <div class="RightInn33">
                                ...
                                <tr>
                                    <td class="TableDiv">
                                        <table border="0" cellspacing="0" cellpadding="2">
                                            <tr>
                                                <td align="right" width="110px;">Material Code</td>
                                                <td>
                                                    <input type="text" name="" id="" value="" placeholder="" class="FilddHalf11" /></td>
                                            </tr>
                                            <tr>
                                                <td align="right">Material Desc</td>
                                                <td>
                                                    <input type="text" name="" id="" value="" placeholder="" class="FilddHalf11" /></td>
                                            </tr>
                                            <tr>
                                                <td align="right">Packing Code</td>
                                                <td>
                                                    <input type="text" name="" id="" value="" placeholder="" class="FilddHalf11" /></td>
                                            </tr>
                                            <tr>
                                                <td align="right">Material Classification Code</td>
                                                <td>
                                                    <input type="text" name="" id="" value="" placeholder="" class="FilddHalf11" /></td>
                                            </tr>
                                            <tr>
                            ...
                            <div class="Popup">
                                <table border="0" cellspacing="0" cellpadding="2" class="PopupDiv">
                                    <tr>
                                        <td align="left" class="PopupHeader" style="color: #ffffff; padding-left: 15px;">MATERIAL</td>
                                        ...
                                        <td colspan="2" style="padding: 10px 0 20px 0px;">
                                            <table border="0" cellspacing="0" cellpadding="2">
                                                <tr>
                                                    ...
                                                    <td align="right" width="110px;">Material Desc</td>
                                                    <td>
                                                        <input type="text" name="" id="txtmd" value="" placeholder="" class="FilddHalf112" /></td>
                                                </tr>
                                                <tr>
                                                    <td align="right" width="110px;">Packing Code</td>
                                                    <td>
                                                        <input type="text" name="" id="txtpc" value="" placeholder="" class="FilddHalf112" /></td>
                                                    <td align="right" width="110px;">Material Classification Code</td>
                                                    <td>
                                                        <input type="text" name="" id="txtmcc" value="" placeholder="" class="FilddHalf112" /></td>
                                                </tr>                                                                                                                                                                                          
                                            </table>
                                        </td>
                                    </tr>
        ...
        <script type="text/javascript">  
            $(document).ready(function () {
                $("#search1").keyup(function () {
                    ...
                    $.ajax({
                        type: "POST",
                        url: "/AveryService/WebService1.asmx/Get_Materials",
                        ...
                        success: function (response) {
                            ...
                            $.each(obj, function (key, value) {
                                if (count == 0) {
                                    ...
                                    row = row + '<tr><td align="right" width="110px;">Material Code</td> <td><input type="text" name="" id="" value="' + value.MaterialCode + '" placeholder="" class="FilddHalf11" /></td></tr>';
                                    row = row + '<tr><td align="right" width="110px;">Material Desc</td> <td><input type="text" name="" id="" value="' + value.MaterialDesc + '" placeholder="" class="FilddHalf11" /></td></tr>';
                                    ...
                                    row = row + '<tr><td align="right" width="110px;">Material Classification Code</td> <td><input type="text" name="" id="" value="' + value.MaterialClassificationCode + '" placeholder="" class="FilddHalf11" /></td></tr>';
                                    row = row + '<tr><td align="right"></td><td align="right"><a href="javascript:void(0);" data-id="'+value.MaterialCode+'" class="MainPopBtn" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage("Image37","","/images/fullscreen_hover.png",1)"><img src="/images/fullscreen_normal.png" name="Image37" width="26" height="26" border="0" id="Image37" /></a></td></tr></table></td>';
                                    ...
                                    row = row + '<tr><td align="right" width="110px;">Material Desc</td> <td><input type="text" name="" id="" value="' + value.MaterialDesc + '" placeholder="" class="FilddHalf11" /></td></tr>';
                                    row = row + '<tr><td align="right" width="110px;">Packing Code</td> <td><input type="text" name="" id="" value="' + value.PackingCode + '" placeholder="" class="FilddHalf11" /></td></tr>';
                                    row = row + '<tr><td align="right" width="110px;">Material Classification Code</td> <td><input type="text" name="" id="" value="' + value.MaterialClassificationCode + '" placeholder="" class="FilddHalf11" /></td>';
                                    row = row + '<tr><td align="right"></td><td align="right"><a href="javascript:void(0);" data-id="'+value.MaterialCode+'" class="MainPopBtn" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage("Image37","","/images/fullscreen_hover.png",1)"><img src="/images/fullscreen_normal.png" name="Image37" width="26" height="26" border="0" id="Image37" /></a></td></tr></table></td>';
                                    $("#tblsearch").append(row);
                                    count = 0;
