<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="Avery_Weigh.Material.List" %>
        ...
        <div class="Wrapper WeighMain">
            ...
            <div class="MiddleSection">
                ...
                <div id="div_print" class="RightSec">
                    <div class="RightInn11 textcon" style="overflow:hidden">
                        <h4>MASTERS</h4>
                        <h4 class="SupplierSearchBig">MATERIAL<a href="/ManageMasters" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image32','','/images/close_hover.png',1)" class="CloseButtonA">
                                    ...
                                    <asp:Repeater ID="rptList" runat="server" OnItemCreated="rptList_ItemCreated">
                                        <HeaderTemplate>
                                            <tr>
                                                ...
                                                <td align="center" valign="middle" bgcolor="#d8e7ee">Material Code</td>
                                                <td align="center" valign="middle" bgcolor="#d8e7ee">Material Desc</td>
                                        ...
                                        <ItemTemplate>
                                            <tr class="trclass" data-rowid="<%#Eval("Id")%>">                                               
                                                <td align="center" valign="middle">
                                                    <asp:Label ID="lblmaterialid" runat="server"></asp:Label></td>
                                                <td align="center" valign="middle"><%#Eval("MaterialCode") %></td>
                                                <td align="center" valign="middle"><%#Eval("MaterialDesc") %></td>
            ...
            <div class="footer">
                <ul class="selected">
                    ...
                    <li><asp:LinkButton ID="ExportExcel" runat="server" OnClick="ExportExcel_Click" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image15','','/images/type4/import_hover.png',1)">
                    ...
                    <li>
                        <asp:LinkButton ID="Delete" runat="server" OnClientClick="return Delete();" OnClick="Delete_Click" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image17','','/images/type4/delete_hover.png',1)">
