<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddEdit.aspx.cs" Inherits="Avery_Weigh.Material.AddEdit" %>
...
<body onload="MM_preloadImages('/images/contact/contact_hover.png','/images/contact/info_hover.png','/images/contact/login_hover.png','/images/close_hover.png','/images/fullscreen_hover.png','/images/exit_fullscreen_hover.png','/images/type3/copy_hover.png','/images/type3/previous_page_hover.png','/images/type3/previous_record_hover.png','/images/type3/next_record_hover.png','/images/type3/next_page_hover.png')">
    <form id="form1" runat="server" defaultfocus="txtmaterialcode">
        <div class="Wrapper WeighMain">
            ...
            <div class="MiddleSection">
                ...
                <div class="RightSec">
                    <div class="RightInn11 textcon" style="overflow:hidden">
                        <h4>MASTERS</h4>
                        <h4 class="SupplierSearchBig">MATERIALS <a href="List.aspx" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image32','','/images/close_hover.png',1)" class="CloseButtonA">
                    ...
                    <div class="RightInn11 supplier">
                        ...
                        <div class="RightInnMasters">
                            ...
                            <table border="0" cellspacing="0" cellpadding="2">
                                <tr>
                                    <td align="right" width="150px;">Material Code</td>
                                    <td>
                                        <asp:TextBox ID="txtmaterialcode" runat="server" CssClass="FilddHalf112" MaxLength="10"></asp:TextBox></td>
                                </tr>
                                <tr>
                                    <td align="right" width="150px;">Material Description</td>
                                    <td>
                                        <asp:TextBox ID="txtmaterialdesc" runat="server" CssClass="FilddHalf112" MaxLength="40"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                    <td align="right" width="150px;">Packing Code</td>
                                    <td>
                                        <asp:DropDownList ID="ddlpackingcodeid" Width="287px" CssClass="FilddHalf112" runat="server" DataTextField="Name" DataValueField="PackingCode">
                                        </asp:DropDownList>

                                    </td>
                                </tr>
                                <tr>
                                    <td align="right" width="150px;">Material Classification</td>
                                    <td>
                                        <asp:DropDownList ID="ddlmaterialclassificationid" Width="287px" CssClass="FilddHalf112" runat="server" DataTextField="Name" DataValueField="Code"></asp:DropDownList>
                                    </td>
                                </tr>
            ...
            <!--Footer Ends-->
            <script type="text/javascript">
                $('#ddlpackingcodeid').select2();
                $('#ddlmaterialclassificationid').select2();
            </script>
    ...
    <script type="text/javascript">
        function validateForm() {
            ...
            var des = $('#txtmaterialdesc').val();
            var packingcode = $('#ddlpackingcodeid').select().val();
            var materialclassificationcode = $('#ddlmaterialclassificationid').val();

            //if (materialcode.trim() == '' || des.trim() == '' || packingcode == '' || materialclassificationcode == '') {
            if (materialcode.trim() == '' || des.trim() == '') {
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            $('#txtmaterialcode').change(function () {
                var code = $('#txtmaterialcode').val();
                $.ajax({
                    type: "POST",
                    url: "/AveryService/WebService1.asmx/Check_Materials",
                    data: "{'code':'" + code + "'}",
                    ...
                    success: function (data) {
                        ...
                        if (data.d != "") {
                            ...
                            console.log(obj);
                            toastr.error('Same Material Code Exist');
                            $('#txtPlantCOde').focus();
                            return false;
                        }
                    },
