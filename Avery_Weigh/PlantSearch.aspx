<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PlantSearch.aspx.cs" Inherits="Avery_Weigh.PlantSearch" %>
...
<head runat="server">
    ...
    <script>
        $(document).on("click", ".MainPopBtn", function () {
            ...
            $.ajax({
                        type: "POST",
                        url: "/AveryService/WebService1.asmx/Get_PlantMasterByCode",
                        data: "{'code':'" + code + "'}",
                        ...
                        success: function (response) {
                            ...
                            console.log(obj);
                            $('#txtCode').val(obj.PlantCode);
                            $('#txtName').val(obj.PlantName);
                            $('#txtAddress1').val(obj.PlantAddress1);
                            $('#txtAddress2').val(obj.PlantAddress2);
                            $('#txtpcp').val(obj.PlantContactPerson);
                            $('#txtdesignation').val(obj.Designation);
                            $('#txtemail').val(obj.ContactEmail);
                            $('#txtmobile').val(obj.ContactMobile);
                            $('#txtmachine').val(obj.NoOfMachine);
                        },
        ...
        <div class="Wrapper WeighMain">
            ...
            <div class="MiddleSection">
                <div class="LeftSec">
                    <ul>
                        ...
                        <li><a href="/ConfigurationMaster" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image5','','/images/type1/configure_select.png',1)">
                ...
                <div class="RightSec">
                    <div class="RightInn11" style="overflow:hidden">
                        <h4>CONFIGURATION</h4>
                        <h4 class="SupplierSearchBig">PLANT CONFIGURATION | SEARCH <a href="PlantList.aspx" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image32','','images/close_hover.png',1)" class="CloseButtonA">
                        ...
                        <div class="RightInn33">
                                ...
                                <tr>
                                    <td class="TableDiv">
                                        <table border="0" cellspacing="0" cellpadding="2">
                                            ...
                                            <tr>
                                                <td align="right">Plant Address1</td>
                                                <td>
                                                    <input type="text" name="" id="" value="" placeholder="" class="FilddHalf11" /></td>
                                            </tr>
                                            <tr>
                                                <td align="right">Plant Address2</td>
                                                <td>
                                                    <input type="text" name="" id="" value="" placeholder="" class="FilddHalf11" /></td>
                                            </tr>
                                            <tr>
                            ...
                            <div class="Popup">
                                <table border="0" cellspacing="0" cellpadding="2" class="PopupDiv">
                                    <tr>
                                        <td align="left" class="PopupHeader" style="color: #ffffff; padding-left: 15px;">PLANT MASTER</td>
                                        ...
                                        <td colspan="2" style="padding: 10px 0 20px 0px;">
                                            <table border="0" cellspacing="0" cellpadding="2">
                                                <tr>
                                                    ...
                                                    <td align="right" width="110px;">Plant Name</td>
                                                    <td>
                                                        <input type="text" name="" id="txtName" value="" placeholder="" class="FilddHalf112" /></td>
                                                </tr>
                                                <tr>
                                                    <td align="right" width="110px;">Plant Address1</td>
                                                    <td>
                                                        <input type="text" name="" id="txtAddress1" value="" placeholder="" class="FilddHalf112" /></td>
                                                    <td align="right" width="110px;">Plant Address2</td>
                                                    <td>
                                                        <input type="text" name="" id="txtAddress2" value="" placeholder="" class="FilddHalf112" /></td>
                                                </tr>
                                                <tr>
                                                    <td align="right" width="110px;">Plant Contact Person</td>
                                                    <td>
                                                        <input type="text" name="" id="txtpcp" value="" placeholder="" class="FilddHalf112" /></td>
                                                    <td align="right" width="110px;">Designation</td>
                                                    <td>
                                                        <input type="text" name="" id="txtdesignation" value="" placeholder="" class="FilddHalf112" /></td>
                                                </tr>
                                                <tr>
                                                    <td align="right" width="110px;">Contact Email</td>
                                                    <td>
                                                        <input type="text" name="" id="txtemail" value="" placeholder="" class="FilddHalf112" /></td>
                                                    <td align="right" width="110px;">Contact Mobile</td>
                                                    <td>
                                                        <input type="text" name="" id="txtmobile" value="" placeholder="" class="FilddHalf112" /></td>
                                                </tr>
                                                <tr>
                                                    <td align="right" width="110px;">No Of Machine</td>
                                                    <td>
                                                        <input type="text" name="" id="txtmachine" value="" placeholder="" class="FilddHalf112" /></td>                                                    
                                                </tr>                                               
                                            </table>
                                        </td>
                                    </tr>
            ...
            <div class="footer">
                <ul class="selected">
                    ...
                    <li>
                        <a href="PlantInfo.aspx" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image12','','/images/type4/edit_hover.png',1)">
                    ...
                    <li><a href="PlantImport.aspx" id="myBtn" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Imag14','','/images/type4/export_hover.png',1)">
                        <img src="/images/type4/export_normal.png" alt="Export" name="Imag14" width="80" height="50" border="0" id="Imag14" /></a></li>
                    <li>
                        <a href="PlantList.aspx" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image15','','/images/type4/import_hover.png',1)">
        ...
        <script type="text/javascript">  
            $(document).ready(function () {
                $("#search1").keyup(function () {
                    ...
                    $.ajax({
                        type: "POST",
                        url: "/AveryService/WebService1.asmx/Get_PlantMaster",
                        ...
                        success: function (response) {
                            ...
                            $.each(obj, function (key, value) {
                                if (count == 0) {
                                    ...
                                    row = row + '<tr><td align="right" width="110px;">Plant Code</td> <td><input type="text" name="" id="" value="' + value.PlantCode + '" placeholder="" class="FilddHalf11" /></td></tr>';
                                    row = row + '<tr><td align="right" width="110px;">Plant Name</td> <td><input type="text" name="" id="" value="' + value.PlantName + '" placeholder="" class="FilddHalf11" /></td></tr>';
                                    row = row + '<tr><td align="right" width="110px;">Plant Address1</td> <td><input type="text" name="" id="" value="' + value.PlantAddress1 + '" placeholder="" class="FilddHalf11" /></td></tr>';
                                    row = row + '<tr><td align="right" width="110px;">Plant Address2</td> <td><input type="text" name="" id="" value="' + value.PlantAddress2 + '" placeholder="" class="FilddHalf11" /></td></tr>';
                                    row = row + '<tr><td align="right"></td><td align="right"><a href="javascript:void(0);" data-id="'+value.PlantCode+'" class="MainPopBtn" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage("Image37","","/images/fullscreen_hover.png",1)"><img src="/images/fullscreen_normal.png" name="Image37" width="26" height="26" border="0" id="Image37" /></a></td></tr></table></td>';
                                    ...
                                    row = row + '<tr><td align="right" width="110px;">Plant Name</td> <td><input type="text" name="" id="" value="' + value.PlantName + '" placeholder="" class="FilddHalf11" /></td></tr>';
                                    row = row + '<tr><td align="right" width="110px;">Plant Address1</td> <td><input type="text" name="" id="" value="' + value.PlantAddress1 + '" placeholder="" class="FilddHalf11" /></td></tr>';
                                    row = row + '<tr><td align="right" width="110px;">Plant Address2</td> <td><input type="text" name="" id="" value="' + value.PlantAddress2 + '" placeholder="" class="FilddHalf11" /></td>';
                                    row = row + '<tr><td align="right"></td><td align="right"><a href="javascript:void(0);" data-id="'+value.PlantCode+'" class="MainPopBtn" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage("Image37","","/images/fullscreen_hover.png",1)"><img src="/images/fullscreen_normal.png" name="Image37" width="26" height="26" border="0" id="Image37" /></a></td></tr></table></td>';
                                    $("#tblsearch").append(row);
                                    count = 0;
