                        ...
                        <div class="RightInnMasters" >
                            ...
                            <table border="0" cellspacing="0" cellpadding="2">
                                <tr>
                                    ...
                                    <td>
                                        <asp:DropDownList ID="ddlTripType" Width="287px" CssClass="FilddHalf112" runat="server" disabled="disabled">
                            ...
                            <table style="width: 98%;" border="1" bordercolor="#72aac0" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF" class="MainLTable">
                                        ...
                                        <tr class="trclass">
                                            ...
                                            <td align="center" valign="middle"><asp:Label ID="lblSecondWeight" runat="server"></asp:Label></td>
                                            <td align="center" valign="middle" ><asp:Label ID="lblSecondWeightDateTime" runat="server"></asp:Label></td>
                                            <td align="center" valign="middle" ><asp:Label ID="lblNetWeight" runat="server"></asp:Label></td> 
                                        </tr>
                            </table>
