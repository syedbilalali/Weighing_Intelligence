<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Import.aspx.cs" Inherits="Avery_Weigh.Truck_Master.Import" %>
            ...
            <div class="MiddleSection">
                ...
                <div class="RightSec">
                    <div class="RightInn11">
                        <h4>MASTERS</h4>
                        <h4 class="SupplierSearchBig">TRUCK MASTER IMPORT <a href="List.aspx" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image32','','/images/close_hover.png',1)" class="CloseButtonA">
                    ...
                    <div class="RightInn11">
                        ...
                        <div class="RightInnMasters">
                            ...
                            <div id="dbMain" runat="server" style="display:inline-block;width:50%;float:left">
                            ...
                            <div style="width:50%;float:right;display:inline-block;text-align:left">
                                ...
                                <table style="border:1px solid red">
                                    <tr>
                                        <td>1</td>
                                        <td>Truck Reg No should be less than or equal to 15 Character</td>
                                    </tr>
                                     <tr>
                                        <td>2</td>
                                     ...
                                     <tr>
                                        <td>3</td>
                                        <td>Stored Tare weight should be less than or equal to 7 character</td>
                                    </tr>
                                     <tr>
                                        <td>4</td>
                                        <td>Tare Validity date should be 'dd/mm/yyyy' format</td>
                                    </tr>
                                     <tr>
                                        <td>5</td>
                                        <td>Average Tare Scheme should be less than or equal to 2 character and should be in numeric format</td>
                                    </tr>
                                     <tr>
                                        <td>6</td>
                                        <td>Current Average Tare Value should be less than or equal to 7 character</td>
                                    </tr>
                                     <tr>
                                        <td>7</td>
                                        <td>UOM Weight for should be in "KG" and "T" format</td>
                                    </tr>
                                </table>
                            </div>
                        </div>
