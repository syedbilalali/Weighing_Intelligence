                    ...
                    <div class="RightInn11">
                        ...
                        <div class="RightInnMasters">
                            ...
                            <table border="0" cellspacing="0" cellpadding="2">
                                <tr>
                                    <td align="right" width="150px;">Truck Reg no</td>
                                    <td>
                                        <asp:TextBox ID="txtTruckRegNo" runat="server" MaxLength="15" CssClass="FilddHalf112"></asp:TextBox></td>
                                ...
                                <tr>
                                    <td align="right" width="150px;">Stored Tare weight</td>
                                    <td>
                                        <asp:TextBox ID="txtStoredTareWeight" runat="server" CssClass="FilddHalf112" MaxLength="7" ReadOnly="true" ></asp:TextBox>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td align="right" width="150px;">Weighbridge</td>
                                    <td colspan="2" align="center">
                                        <asp:UpdatePanel ID="up1" runat="server" style="float: left;">
                                            <ContentTemplate>
                                                <asp:LinkButton ID="RuntimeWeight" runat="server" value="0" placeholder="" Text="No weight" Style="width: 350px; float: left;" CssClass="field2" onfocus="if(this.value == '00000000'){this.value = '';}"></asp:LinkButton>
                                            </ContentTemplate>
                                        </asp:UpdatePanel>
                                       
                                    </td>
                                     <td>
                                            <asp:Button ID="btnSearch" runat="server" Text="Take Weight" OnClick="btnSearch_Click" class="my_btn" >
                                            <%--<span class="">Search</span>--%>
                                            </asp:Button>
                                        </td>

                                    <td><span style="margin: 15px 0 0 4px; display: inline-block;">kg</span></td>
  ...
  <script src="https://code.jquery.com/ui/1.12.1/jquery-ui.js"></script>--%>
    <script type="text/javascript">
        function validateForm() {
            ...
            if (Code.trim() == '') {
                toastr.error('Please fill Truck Reg. No. This is Mandatory field.');
                result = false;
            }
