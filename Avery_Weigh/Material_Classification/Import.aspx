<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Import.aspx.cs" Inherits="Avery_Weigh.Material_Classification.Import" %>
            ...
            <div class="MiddleSection">
                ...
                <div class="RightSec">
                    <div class="RightInn11">
                        <h4>MASTERS</h4>
                        <h4 class="SupplierSearchBig">MATERIAL CLASSIFICATION IMPORT <a href="List.aspx" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image32','','/images/close_hover.png',1)" class="CloseButtonA">
                    ...
                    <div class="RightInn11">
                        ...
                        <div class="RightInnMasters">
                            ...
                            <div style="display:inline-block;float:right;width:50%;text-align:left">
                                <div style="height:50px"></div>
                                <h3 style="color:red">Instructions for import xlsx file</h3>
                                <table style="border:1px solid red">
                                    <tr>
                                        <td>1</td>
                                        <td>Material classification code should be less than or equal to 10 character</td>
                                    </tr>
                                    <tr>
                                        <td>2</td>
                                        <td>Material classification description should be less than or equal to 25 character</td>
                                    </tr>
                                    <tr>
                                        <td>3</td>
                                        <td>Supplier vendor code should be less than or equal to 10 character</td>
                                    </tr>
                                </table>
                            </div>
                        </div>
                ...
                <div class="footer">
                    <ul class="selected">
                        ...
                        <li><a href="List.aspx" runat="server" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image15','','/images/type4/import_hover.png',1)">
