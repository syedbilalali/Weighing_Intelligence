<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="Avery_Weigh.Material_Classification.List" %>
        ...
        <div class="Wrapper WeighMain">
            ...
            <div class="MiddleSection">
                ...
                <div id="div_print" class="RightSec">
                    <div class="RightInn11 textcon" style="overflow:hidden">
                        <h4>MASTERS</h4>
                        <h4 class="SupplierSearchBig">MATERIAL CLASSIFICATION MASTER <a href="/ManageMasters" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image32','','/images/close_hover.png',1)" class="CloseButtonA">
                                ...
                                <asp:Repeater ID="rptList" runat="server" OnItemCreated="rptList_ItemCreated">
                                    <HeaderTemplate>
                                        <tr>
                                            ...
                                            <td align="center" valign="middle" bgcolor="#d8e7ee">Material Classification Code</td>
                                            <td align="center" valign="middle" bgcolor="#d8e7ee">Material Classification Desc</td>
                                            <td align="center" valign="middle" bgcolor="#d8e7ee">Supplier Vendor Code</td>                                                                                 
                                    ...
                                    <ItemTemplate>
                                        <tr class="trclass" data-RowId="<%#Eval("Id")%>"">
                                            ...
                                            <td align="center" valign="middle"><%#Eval("MaterialClassificationCode") %></td>
                                            <td align="center" valign="middle"><%#Eval("MaterialClassificationDesc") %></td>
                                            <td align="center" valign="middle"><%#Eval("Supplier_VendorCode") %></td>                                      
                                        </tr>
                                    </ItemTemplate>
                                </asp:Repeater>
                            </table>
            ...
            <div class="footer">
                <ul class="selected">
                    ...
                    <li><asp:LinkButton runat="server" ID="Edit" OnClick="Edit_Click" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image12','','/images/type4/edit_hover.png',1)">
                        <img src="/images/type4/edit_normal.png" name="Image12" width="80" height="50" border="0" id="Image12" /></asp:LinkButton></li>
                    <li><a href="javascript:void(0)" Visible="false" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image13','','/images/type4/save_hover.png',1)">
                    ...
                    <li><asp:LinkButton ID="btnImport" runat="server" OnClick="btnImport_Click" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image15','','/images/type4/import_hover.png',1)">
                    ...
                    <li><asp:LinkButton ID="Delete" runat="server" OnClick="Delete_Click" OnClientClick="return Delete();"
