<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddEdit.aspx.cs" Inherits="Avery_Weigh.Material_Classification.AddEdit" %>

<%@ Register Src="~/View/Header.ascx" TagPrefix="uc1" TagName="Header" %>
<!DOCTYPE html>
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <%--  <meta http-equiv="Refresh" content="3;url=List.aspx" />--%>
...
<body onload="MM_preloadImages('images/contact/contact_hover.png','images/contact/info_hover.png','images/contact/login_hover.png','images/close_hover.png','images/fullscreen_hover.png','images/exit_fullscreen_hover.png','images/type3/copy_hover.png','images/type3/previous_page_hover.png','images/type3/previous_record_hover.png','images/type3/next_record_hover.png','images/type3/next_page_hover.png')">
    <form id="form1" runat="server" defaultfocus="txtmcc">
            ...
            <div class="MiddleSection">
                ...
                <div class="RightSec">
                    <div class="RightInn11 textcon" style="overflow:hidden">
                        <h4>MASTERS</h4>
                        <h4 class="SupplierSearchBig">MATERIAL CLASSIFICATION <a href="List.aspx" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image32','','/images/close_hover.png',1)" class="CloseButtonA">
                        ...
                        <div class="RightInnMasters">
                            <div class="ConatctIcons2" id="divoptions" runat="server" style="display: none;">
                                <ul>
                                    ...
                                    <li>
                                        <asp:LinkButton ID="First_Record" OnClick="First_Record_Click" ToolTip="First Record" runat="server" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('previous_page','','/images/type3/previous_page_hover.png',1)">
                                    ...
                                    <li>
                                        <asp:LinkButton runat="server" ID="Previous_Record" OnClick="Previous_Record_Click" ToolTip="Previous Record" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('previous_record','','/images/type3/previous_record_hover.png',1)">
                                    ...
                                    <li>
                                        <asp:LinkButton runat="server" ID="Next_Record" OnClick="Next_Record_Click" ToolTip="Next Record" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('next_record','','/images/type3/next_record_hover.png',1)">
                                    ...
                                    <li>
                                        <asp:LinkButton runat="server" ID="Last_Record" OnClick="Last_Record_Click" ToolTip="Last Record" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('next_page','','/images/type3/next_page_hover.png',1)">
                            ...
                            <table border="0" cellspacing="0" cellpadding="2">
                                <tr>
                                    <td align="right" width="150px;">Material Classification Code</td>
                                    <td>
                                        <asp:TextBox ID="txtmcc" runat="server" CssClass="FilddHalf112" MaxLength="10"></asp:TextBox></td>
                                </tr>
                                <tr>
                                    <td align="right" width="150px;">Material Classification Description</td>
                                    <td>
                                        <asp:TextBox ID="txtmcd" runat="server" CssClass="FilddHalf112" MaxLength="25"></asp:TextBox></td>
                                </tr>
                                <tr>
                                    <td align="right" width="150px;">Supplier Vendor Code</td>
                                    <td>
                                        <asp:DropDownList ID="ddlsupplier" Width="287px" runat="server" DataTextField="Name" DataValueField="Id" CssClass="FilddHalf112"></asp:DropDownList></td>
                                </tr>
                            </table>
                        </div>
                    </div>
    ...
    <script type="text/javascript">
        function validateForm() {
            ...
            var code = $('#txtmcc').val();
            var desc = $('#txtmcd').val();
            var vendorcode = $('#txtsvc').val();
            if (code.trim() == '' || desc.trim() == '' || vendorcode.trim() == '') {
        ...
        $(document).ready(function () { $("#ddlsupplier").select2(); });
    </script>
    <script type="text/javascript">
        $('#txtmcc').change(function () {
            var code = $('#txtmcc').val();
            $.ajax({
                type: "POST",
                url: "/AveryService/WebService1.asmx/Check_MaterialClassification",
                data: "{'code':'" + code + "'}",
                ...
                success: function (data) {
                    ...
                    if (data.d != "") {
                        ...
                        console.log(obj);
                        toastr.error('Same Material Classificatin Code Exist');
                        $('#txtPlantCOde').focus();
                        return false;
                    }
                },
