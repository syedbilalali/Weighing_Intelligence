<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Search.aspx.cs" Inherits="Avery_Weigh.Material_Classification.Search" %>
...
<head runat="server">
    ...
    <script>
        $(document).on("click", ".MainPopBtn", function () {
            ...
            $.ajax({
                        type: "POST",
                        url: "/AveryService/WebService1.asmx/Get_MaterialClassificationByCode",
                        data: "{'code':'" + code + "'}",
                        ...
                        success: function (response) {
                            ...
                            console.log(obj);
                            $('#txtCode').val(obj.MaterialClassificationCode);
                            $('#txtdes').val(obj.MaterialClassificationDesc);
                            $('#txtsvc').val(obj.Supplier_VendorCode);                           
                        },
            ...
            <div class="MiddleSection">
                ...
                <div class="RightSec">
                    <div class="RightInn11">
                        <h4>MASTERS</h4>
                        <h4 class="SupplierSearchBig">MATERIAL CLASSIFICATION | SEARCH   <a href="/List" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image32','','/images/close_hover.png',1)" class="CloseButtonA">
                        ...
                        <div class="RightInn33">
                                ...
                                <tr>
                                    <td class="TableDiv">
                                        <table border="0" cellspacing="0" cellpadding="2">
                                            ...
                                            <tr>
                                                <td align="right">Supplier Vendor Code</td>
                                                <td>
                                                    <input type="text" name="" id="" value="" placeholder="" class="FilddHalf11" /></td>
                                            </tr>
                            ...
                            <div class="Popup">
                                <table border="0" cellspacing="0" cellpadding="2" class="PopupDiv">
                                    <tr>
                                        <td align="left" class="PopupHeader" style="color: #ffffff; padding-left: 15px;">MATERIAL CLASSIFICATION</td>
                                        ...
                                        <td colspan="2" style="padding: 10px 0 20px 0px;">
                                            <table border="0" cellspacing="0" cellpadding="2">
                                                <tr>
                                                    ...
                                                    <td align="right" width="110px;">Description</td>
                                                    <td>
                                                        <input type="text" name="" id="txtdes" value="" placeholder="" class="FilddHalf112" /></td>
                                                </tr>
                                                <tr>
                                                    <td align="right" width="110px;">Supplier Vendor Code</td>
                                                    <td>
                                                        <input type="text" name="" id="txtsvc" value="" placeholder="" class="FilddHalf112" /></td>
        ...
        <script type="text/javascript">  
            $(document).ready(function () {
                $("#search1").keyup(function () {
                    ...
                    $.ajax({
                        type: "POST",
                        url: "/AveryService/WebService1.asmx/Get_MaterialClassifications",
                        ...
                        success: function (response) {
                            ...
                            $.each(obj, function (key, value) {
                                if (count == 0) {
                                    ...
                                    row = row + '<tr><td align="right" width="110px;">Code</td> <td><input type="text" name="" id="" value="' + value.MaterialClassificationCode + '" placeholder="" class="FilddHalf11" /></td></tr>';
                                    row = row + '<tr><td align="right" width="110px;">Description</td> <td><input type="text" name="" id="" value="' + value.MaterialClassificationDesc + '" placeholder="" class="FilddHalf11" /></td></tr>';
                                    row = row + '<tr><td align="right" width="110px;">Supplier Vendor Code</td> <td><input type="text" name="" id="" value="' + value.Supplier_VendorCode + '" placeholder="" class="FilddHalf11" /></td></tr>';
                                    row = row + '<tr><td align="right"></td><td align="right"><a href="javascript:void(0);" data-id="'+value.MaterialClassificationCode+'" class="MainPopBtn" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage("Image37","","/images/fullscreen_hover.png",1)"><img src="/images/fullscreen_normal.png" name="Image37" width="26" height="26" border="0" id="Image37" /></a></td></tr></table></td>';
