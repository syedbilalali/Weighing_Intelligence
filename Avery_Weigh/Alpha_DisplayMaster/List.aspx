<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="Avery_Weigh.Alpha_DisplayMaster.List" %>
            ...
            <div class="MiddleSection">
                ...
                <div class="RightSec">
                    <div class="RightInn11" style="overflow:hidden">
                        <h4>CONFIGURATION</h4>
                        <h4 class="SupplierSearchBig">ALPHA DISPLAY MASTER<a href="/ConfigurationMaster" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image32','','/images/close_hover.png',1)" class="CloseButtonA">
                                ...
                                <asp:Repeater ID="rptList" runat="server" OnItemCreated="rptList_ItemCreated">
                                    <HeaderTemplate>
                                        <tr>
                                            ...
                                            <td align="center" valign="middle" bgcolor="#d8e7ee">Alpha Display Identification</td> 
                                            <td align="center" valign="middle" bgcolor="#d8e7ee">Alpha Display IP</td> 
                                            <td align="center" valign="middle" bgcolor="#d8e7ee">Alpha Display PORT</td>                                                                                      
                                        </tr>
                                    </HeaderTemplate>
                                    <ItemTemplate>
                                        <tr class="trclass" data-RowId="<%#Eval("Id")%>"">
                                            ...
                                            <td align="center" valign="middle"><%#Eval("AlphaDisplayIdentification") %></td>
                                            <td align="center" valign="middle"><%#Eval("AlphaDisplayIP") %></td>
                                            <td align="center" valign="middle"><%#Eval("AlphaDisplayPORT") %></td>                                         
                                        </tr>
                                    </ItemTemplate>
                                </asp:Repeater>
                            </table>
