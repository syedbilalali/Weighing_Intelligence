<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddEdit.aspx.cs" Inherits="Avery_Weigh.Alpha_DisplayMaster.AddEdit" %>
            ...
            <div class="MiddleSection">
                ...
                <div class="RightSec">
                    <div class="RightInn11" style="overflow:hidden">
                        <h4>CONFIGURATION</h4>
                        <h4 class="SupplierSearchBig">ALPHA DISPLAY MASTER <a href="List.aspx" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image32','','/images/close_hover.png',1)" class="CloseButtonA">
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $('#ddlmachineid').change(function () {
                ...
                $.ajax({
                    url: "/AveryService/WebService1.asmx/Check_AlphaDisplayMaster",
                    type: "post",
                    dataType: "json",
                    ...
                    success: function (data) {
                        if (data.d != "") {
                            toastr.warning('Only 2 Alpha Display Allow In 1 Plant!');
                        }
                    },
                    error: function (data) {
                        console.log(data);
            ...
            $('#txtip').change(function () {
                ...
                var ip = $('#txtip').val();
                $.ajax({
                    url: "/AveryService/WebService1.asmx/Check_AlphaDisplayIP",
                    type: "post",
                    dataType: "json",
                    contentType: "application/json; charset=utf-8",
                    ...
                    success: function (data) {
                        if (data.d != "") {
                            toastr.warning('Same Alpha Display IP Exist!');
                        }
                    },
                    error: function (data) {
                        console.log(data);
