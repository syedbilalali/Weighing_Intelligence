<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Search.aspx.cs" Inherits="Avery_Weigh.Alpha_DisplayMaster.Search" %>
...
<head runat="server">
    ...
    <script>
        $(document).on("click", ".MainPopBtn", function () {
            ...
            $.ajax({
                type: "POST",
                url: "/AveryService/WebService1.asmx/GetAlphaByCode",
                data: "{'code':'" + code + "'}",
                ...
                success: function (response) {
                    ...
                    $('#txtidentification').val(obj.AlphaDisplayIdentification);
                    $('#txtip').val(obj.AlphaDisplayIP);
                    $('#txtport').val(obj.AlphaDisplayPort);
            ...
            <div class="MiddleSection">
                ...
                <div class="RightSec">
                    <div class="RightInn11" style="overflow:hidden">
                        <h4>MASTERS</h4>
                        <h4 class="SupplierSearchBig">ALPHA DISPLAY | SEARCH <a href="List.aspx" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image32','','/images/close_hover.png',1)" class="CloseButtonA">
                                            ...
                                            <tr>
                                                <td align="center">
                                                    <select class="DropDown" id="ddlSearch1" style="width: 85%; float: right">
                                                        ...
                                                        <option value="IP">AlphaDisplay IP</option>
                                                    </select>
                                                </td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                <td align="center" >
                                                    <select class="DropDown" id="ddlSearch3" style="width: 85%; margin-top: 12px; float: right">
                                                        <option value="IP">Alpha Display IP</option>
                                                        <option value="Id">Machine Id</option>
                                                        <option value="Code">Plant Code</option>
                                                    </select>
                                                </td>
                        ...
                        <div class="RightInn33">
                                ...
                                <tr>
                                    <td class="TableDiv">
                                        <table border="0" cellspacing="0" cellpadding="2">
                                            ...
                                            <tr>
                                                <td align="right">Alpha Display Identification</td>
                                                <td>
                                                    <input type="text" name="" id="" value="" placeholder="" class="FilddHalf11" /></td>
                                            </tr>
                                            <tr>
                                                <td align="right">Alpha Display IP</td>
                                                <td>
                                                    <input type="text" name="" id="" value="" placeholder="" class="FilddHalf11" /></td>
                                            </tr>
                                            <tr>
                            ...
                            <div class="Popup">
                                <table border="0" cellspacing="0" cellpadding="2" class="PopupDiv">
                                    <tr>
                                        <td align="left" class="PopupHeader" style="color: #ffffff; padding-left: 15px;">ALPHA DISPLAY MASTER</td>
                                    ...
                                    <tr>
                                        <td colspan="2" style="padding: 10px 0 20px 0px;">
                                            <table border="0" cellspacing="0" cellpadding="2">
                                                ...
                                                <tr>
                                                    <td align="right" width="110px;">Alpha Display Identification</td>
                                                    <td>
                                                        <input type="text" name="" id="txtidentification" value="" placeholder="" class="FilddHalf112" /></td>
                                                    <td align="right" width="110px;">Alpha Display IP</td>
                                                    <td>
                                                        <input type="text" name="" id="txtip" value="" placeholder="" class="FilddHalf112" /></td>
                                                </tr>
                                                <tr>
                                                    <td align="right" width="110px;">Alpha Display Port</td>
                                                    <td>
        ...
        <script type="text/javascript">  
            $(document).ready(function () {
                $("#search1").keyup(function () {
                    ...
                    $.ajax({
                        type: "POST",
                        url: "/AveryService/WebService1.asmx/Get_AlphaDisplay",
                        ...
                        success: function (response) {
                            ...
                            $.each(obj, function (key, value) {
                                if (count == 0) {
                                    ...
                                    row = row + '<tr><td align="right" width="110px;">Alpha Display Identification</td> <td><input type="text" name="" id="" value="' + value.AlphaDisplayIdentification + '" placeholder="" class="FilddHalf11" /></td></tr>';
                                    row = row + '<tr><td align="right" width="110px;">Alpha Display IP</td> <td><input type="text" name="" id="" value="' + value.AlphaDisplayIP + '" placeholder="" class="FilddHalf11" /></td></tr>';
                                    ...
                                    row = row + '<tr><td align="right" width="110px;">Machine ID</td> <td><input type="text" name="" id="" value="' + value.MachineId + '" placeholder="" class="FilddHalf11" /></td></tr>';
                                    row = row + '<tr><td align="right" width="110px;">Alpha Display Identification</td> <td><input type="text" name="" id="" value="' + value.AlphaDisplayIdentification + '" placeholder="" class="FilddHalf11" /></td></tr>';
                                    row = row + '<tr><td align="right" width="110px;">Alpha Display IP</td> <td><input type="text" name="" id="" value="' + value.AlphaDisplayIP + '" placeholder="" class="FilddHalf11" /></td>';
                                    row = row + '<tr><td align="right"></td><td align="right"><a href="javascript:void(0);" data-id="' + value.PlantCodeId + '" class="MainPopBtn" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage("Image37","","/images/fullscreen_hover.png",1)"><img src="/images/fullscreen_normal.png" name="Image37" width="26" height="26" border="0" id="Image37" /></a></td></tr></table></td>';
                                    $("#tblsearch").append(row);
                                    count = 0;
