<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Add.aspx.cs" Inherits="Avery_Weigh.VC.Add" %>
            ...
            <div class="MiddleSection">
                ...
                <div class="RightSec">
                    <div class="RightInn11 textcon" style="overflow: hidden">
                        <h4>MASTERS</h4>
                        <h4 class="SupplierSearchBig">VEHICLE CLASSIFICATION <a href="List.aspx" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image32','','/images/close_hover.png',1)" class="CloseButtonA">
                    ...
                    <div class="RightInn11 supplier">
                        ...
                        <div class="RightInnMasters">
                            ...
                            <table border="0" cellspacing="0" cellpadding="2">
                                <tr>
                                    <td align="right" width="150px;">Classification Code</td>
                                    <td>
                                        <asp:TextBox ID="txtcode" runat="server" CssClass="FilddHalf112" MaxLength="12"></asp:TextBox></td>
                                    <td align="right" width="150px;">Make</td>
                                    <td>
                                        <asp:TextBox ID="txtMake" runat="server" CssClass="FilddHalf112" MaxLength="25"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
