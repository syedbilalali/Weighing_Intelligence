<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="Avery_Weigh.VC.List" %>
            ...
            <div class="MiddleSection">
                ...
                <div id="div_print" class="RightSec">
                    <div class="RightInn11 textcon" style="overflow: hidden">
                        <h4>MASTERS</h4>
                        <h4 class="SupplierSearchBig">VEHICLE CLASSIFICATION <a href="/ManageMasters" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image32','','/images/close_hover.png',1)" class="CloseButtonA">
                                    ...
                                    <asp:Repeater ID="rptList" runat="server" OnItemCreated="rptList_ItemCreated">
                                        <HeaderTemplate>
                                            <tr>
                                                ...
                                                <td align="center" valign="middle" bgcolor="#d8e7ee">Classification Code</td>
                                                <td align="center" valign="middle" bgcolor="#d8e7ee">No. of Axles</td>
                                        ...
                                        <ItemTemplate>
                                            <tr class="trclass" data-rowid="<%#Eval("Id")%>">
                                                ...
                                                <td align="center" valign="middle"><%#Eval("ClassificationCode") %></td>
                                                <td align="center" valign="middle"><%#Eval("NoOfAxies") %></td>
