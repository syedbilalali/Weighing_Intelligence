<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Import.aspx.cs" Inherits="Avery_Weigh.VC.Import" %>
            ...
            <div class="MiddleSection">
                ...
                <div class="RightSec">
                    <div class="RightInn11">
                        <h4>MASTERS</h4>
                        <h4 class="SupplierSearchBig">VEHICLE CLASSIFICATION IMPORT <a href="List.aspx" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image32','','/images/close_hover.png',1)" class="CloseButtonA">
                    ...
                    <div class="RightInn11">
                        ...
                        <div class="RightInnMasters">
                            ...
                            <div id="dbMain" runat="server" style="display:inline-block; float:left;width:50%">
                                <h3>Select File to Import</h3>
                                <asp:FileUpload ID="FileUpload1" runat="server" />
                            </div>
                            <div style="float:right;display:inline-block;width:50%;text-align:left">
                                <div style="height:50px"></div>
                                <h3 style="color:red">Instruction for import xlsx file</h3>
                                <table style="border:1px solid red">
                                    <tr>
                                        <td>1</td>
                                        <td>Classification code should be less than or equal to 12 character</td>
                                    </tr>
                                     <tr>
                                        <td>2</td>
                                        <td>Make should be less than or equal to 25 character</td>
                                    </tr>
                                     <tr>
                                        <td>3</td>
                                        <td>Model should be less than or equal to 25 character</td>
                                    </tr>
                                     <tr>
                                        <td>4</td>
                                        <td>No of Axles should be less than or equal to 10 character and should be in numeric format</td>
                                    </tr>
                                     <tr>
                                        <td>5</td>
                                        <td>Body type should be less than or equal to 25 character</td>
                                    </tr>
                                     <tr>
                                        <td>6</td>
                                        <td>Kerb wt should be less than or equal to 7 character and should be in numeric format</td>
                                    </tr>
                                     <tr>
                                        <td>7</td>
                                        <td>Year of manufacture should be less than or equal to 4 character and should be in numeric format</td>
                                    </tr>
                                     <tr>
                                        <td>8</td>
                                        <td>Gross vehicle wt should be less than or equal to 7 character and should be in numeric format</td>
                                    </tr>
                                     <tr>
                                        <td>9</td>
                                        <td>UOM for weight should be in "KG" or "T" format</td>
                                    </tr>
                                </table>
                            </div>
                        </div>
                ...
                <div class="footer">
                    <ul class="selected">
                        ...
                        <img src="/images/type4/edit_normal.png" name="Image12" width="80" height="50" border="0" id="Image12" /></a></li>
                         <li><asp:LinkButton ID="LnkSave" OnClick="LnkSave_Click" OnClientClick="return ValidateFileUpload();" runat="server" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image13','','/images/type4/save_hover.png',1)">
