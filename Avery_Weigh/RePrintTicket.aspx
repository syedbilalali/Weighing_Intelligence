<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RePrintTicket.aspx.cs" Inherits="Avery_Weigh.RePrintTicket" %>
            ...
            <div class="MiddleSection">
                ...
                <div class="RightSec">
                    <div class="RightInn11 textcon" style="overflow: hidden">
                        <h4>DASHBOARD</h4>
                        <h4 class="SupplierSearchBig">Re-Print Ticket <a href="/dashboardmaster" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image32','','images/close_hover.png',1)" class="CloseButtonA">
                            ...
                            <div id="dbMain" runat="server">
                                <table style="width: 100%;" border="0" class="MainLTable">
                                    <tr>
                                        ...
                                        <td>
                                            <asp:DropDownList ID="ddlTransactionType" runat="server" CssClass="FilddHalf112" Width="197px" AutoPostBack="True" OnSelectedIndexChanged="ddlTransactionType_SelectedIndexChanged">
                                        ...
                                        <td>
                                            <asp:DropDownList ID="ddlType" runat="server" CssClass="FilddHalf112" Width="207px"  AutoPostBack="True" OnSelectedIndexChanged="ddlType_SelectedIndexChanged">
                                               ...
                                               <%-- <asp:ListItem Value="MaterialName">Material Name</asp:ListItem>
                                                ...
                                                <asp:ListItem Value="TripId">Trip ID</asp:ListItem>
                                         ...
                                         <td>
                                            <asp:DropDownList ID="ddlValueType" runat="server" CssClass="FilddHalf112" Width="187px"></asp:DropDownList></td>
                                    ...
                                    <asp:Repeater ID="rptList" runat="server" OnItemDataBound="rptList_ItemDataBound">
                                        <HeaderTemplate>
                                            <tr>
                                               ...
                                               <%-- <td align="center" valign="middle" bgcolor="#d8e7ee">No.</td>--%>
                                                ...
                                                <td align="center" valign="middle" bgcolor="#d8e7ee">DateTimeIn</td>
                                                <td align="center" valign="middle" bgcolor="#d8e7ee">Second Wt</td>
                                                <td align="center" valign="middle" bgcolor="#d8e7ee">DateTimeOut</td>
                                        ...
                                        <ItemTemplate>
                                            <tr class="trclass">
                                                ...
                                                <td align="center" valign="middle"><%#Eval("FirstWeight") %></td>
                                                <td align="center" valign="middle"><%#Eval("FirstWtDateTime") %></td>
                                                <td align="center" valign="middle"><%#Eval("SecondWeight") %></td>
                                                <td align="center" valign="middle"><%#Eval("SecondWtDateTime") %></td>
                                                <td align="center" valign="middle"><%#Eval("NetWeight") %></td>
