<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Search.aspx.cs" Inherits="Avery_Weigh.Truck_Master.Search" %>
...
<head runat="server">
    ...
    <script>
        $(document).on("click", ".MainPopBtn", function () {
            ...
            $.ajax({
                        type: "POST",
                        url: "/AveryService/WebService1.asmx/GetTruckMasterByTruckNo",
                        data: "{'truckno':'" + code + "'}",
                        ...
                        success: function (response) {
                            ...
                            console.log(obj);
                            $('#txttruckno').val(obj.TruckRegNo);
                            $('#txtcode').val(obj.ClassificationCode);
                            $('#txtstw').val(obj.StoredTareWeight);
                            $('#txttvd').val(obj.TareValidityDate);
                            $('#txtats').val(obj.AverageTareScheme);
                            $('#txtcatv').val(obj.CurrentAverageTareValue);
                            $('#txtuomw').val(obj.UOMWeight);
        ...
        <div class="Wrapper WeighMain">
            ...
            <div class="MiddleSection">
                ...
                <div class="RightSec">
                    <div class="RightInn11">
                        <h4>MASTERS</h4>
                        <h4 class="SupplierSearchBig">TRUCK MASTER | SEARCH <a href="List.aspx" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image32','','images/close_hover.png',1)" class="CloseButtonA">
                                            ...
                                            <tr>
                                                <td align="center">
                                                    <select class="DropDown" id="ddlSearch1" style="width: 85%;">
                                                        <option value="TruckNo">Truck Reg No</option>
                        ...
                        <div class="RightInn33">
                                ...
                                <tr>
                                    <td class="TableDiv">
                                        <table border="0" cellspacing="0" cellpadding="2">
                                            <tr>
                                                <td align="right" width="110px;">Truck Reg No</td>
                                                <td>
                                                    <input type="text" name="" id="" value="" placeholder="" class="FilddHalf11" /></td>
                                            </tr>
                                            <tr>
                                                <td align="right">Classification Code</td>
                                                <td>
                                                    <input type="text" name="" id="" value="" placeholder="" class="FilddHalf11" /></td>
                                            </tr>
                                            <tr>
                                                <td align="right">Store Tare Weight</td>
                                                <td>
                                                    <input type="text" name="" id="" value="" placeholder="" class="FilddHalf11" /></td>
                                            </tr>
                                            <tr>
                                                <td align="right">Tare Validity Date</td>
                                                <td>
                                                    <input type="text" name="" id="" value="" placeholder="" class="FilddHalf11" /></td>
                                            </tr>
                                            <tr>
                            ...
                            <div class="Popup">
                                <table border="0" cellspacing="0" cellpadding="2" class="PopupDiv">
                                    <tr>
                                        <td align="left" class="PopupHeader" style="color: #ffffff; padding-left: 15px;">TRUCK MASTER</td>
                                        ...
                                        <td colspan="2" style="padding: 10px 0 20px 0px;">
                                            <table border="0" cellspacing="0" cellpadding="2">
                                                <tr>
                                                    <td align="right" width="110px;">Truck Reg No</td>
                                                    <td>
                                                        <input type="text" name="" id="txttruckno" value="" placeholder="" class="FilddHalf112" /></td>
                                                    <td align="right" width="110px;">Classification Code</td>
                                                    <td>
                                                        <input type="text" name="" id="txtcode" value="" placeholder="" class="FilddHalf112" /></td>
                                                </tr>
                                                <tr>
                                                    <td align="right" width="110px;">Store Tare Weight</td>
                                                    <td>
                                                        <input type="text" name="" id="txtstw" value="" placeholder="" class="FilddHalf112" /></td>
                                                    <td align="right" width="110px;">Tare Validity Date</td>
                                                    <td>
                                                        <input type="text" name="" id="txttvd" value="" placeholder="" class="FilddHalf112" /></td>
                                                </tr>
                                                <tr>
                                                    <td align="right" width="110px;">Average Tare Scheme</td>
                                                    <td>
                                                        <input type="text" name="" id="txtats" value="" placeholder="" class="FilddHalf112" /></td>
                                                    <td align="right" width="110px;">Current Average Tare Value</td>
                                                    <td>
                                                        <input type="text" name="" id="txtcatv" value="" placeholder="" class="FilddHalf112" /></td>
                                                </tr>
                                                <tr>
                                                    <td align="right" width="110px;">UOM Weight</td>
                                                    <td>
                                                        <input type="text" name="" id="txtuomw" value="" placeholder="" class="FilddHalf112" /></td>
            ...
            <div class="footer">
                <ul class="selected">
                    ...
                    <li><a href="javascript:void(0);" id="myBtn" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Imag14','','/images/type4/export_hover.png',1)">
        ...
        <script type="text/javascript">  
            $(document).ready(function () {
                $("#search1").keyup(function () {
                    ...
                    $.ajax({
                        type: "POST",
                        url: "/AveryService/WebService1.asmx/Get_TruckMaster",
                        ...
                        success: function (response) {
                            ...
                            $.each(obj, function (key, value) {
                                if (count == 0) {
                                    ...
                                    row = row + '<tr><td align="right" width="110px;">Truck Reg No</td> <td><input type="text" name="" id="" value="' + value.TruckRegNo + '" placeholder="" class="FilddHalf11" /></td></tr>';
                                    row = row + '<tr><td align="right" width="110px;">Classification Code</td> <td><input type="text" name="" id="" value="' + value.ClassificationCode + '" placeholder="" class="FilddHalf11" /></td></tr>';
                                    row = row + '<tr><td align="right" width="110px;">Store Tare Weight</td> <td><input type="text" name="" id="" value="' + value.StoredTareWeight + '" placeholder="" class="FilddHalf11" /></td></tr>';
                                    row = row + '<tr><td align="right" width="110px;">Tare Validity Date</td> <td><input type="text" name="" id="" value="' + value.TareValidityDate + '" placeholder="" class="FilddHalf11" /></td></tr>';
                                    row = row + '<tr><td align="right"></td><td align="right"><a href="javascript:void(0);" data-id="'+value.TruckRegNo+'" class="MainPopBtn" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage("Image37","","/images/fullscreen_hover.png",1)"><img src="/images/fullscreen_normal.png" name="Image37" width="26" height="26" border="0" id="Image37" /></a></td></tr></table></td>';
                                    ...
                                    row = row + '<td class="TableDiv">';
                                    row = row + '<table border="0" cellspacing="0" cellpadding="2">';
                                    row = row + '<tr><td align="right" width="110px;">Code</td> <td><input type="text" name="" id="" value="' + value.TruckRegNo + '" placeholder="" class="FilddHalf11" /></td></tr>';
                                    row = row + '<tr><td align="right" width="110px;">Name</td> <td><input type="text" name="" id="" value="' + value.ClassificationCode + '" placeholder="" class="FilddHalf11" /></td></tr>';
                                    row = row + '<tr><td align="right" width="110px;">City</td> <td><input type="text" name="" id="" value="' + value.StoredTareWeight + '" placeholder="" class="FilddHalf11" /></td></tr>';
                                    row = row + '<tr><td align="right" width="110px;">Contact Person</td> <td><input type="text" name="" id="" value="' + value.TareValidityDate + '" placeholder="" class="FilddHalf11" /></td>';
                                    row = row + '<tr><td align="right"></td><td align="right"><a href="javascript:void(0);" data-id="'+value.TruckRegNo+'" class="MainPopBtn" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage("Image37","","/images/fullscreen_hover.png",1)"><img src="/images/fullscreen_normal.png" name="Image37" width="26" height="26" border="0" id="Image37" /></a></td></tr></table></td>';
                                    $("#tblsearch").append(row);
                                    count = 0;
                        ...
                        success: function (response) {
                            ...
                            $.each(obj, function (key, value) {
                                if (count == 0) {
                                    ...
                                    row = row + '<tr><td align="right" width="110px;">Classification Code</td> <td><input type="text" name="" id="" value="' + value.ClassificationCode + '" placeholder="" class="FilddHalf11" /></td></tr>';
                                    row = row + '<tr><td align="right" width="110px;">Store Tare Weight</td> <td><input type="text" name="" id="" value="' + value.StoredTareWeight + '" placeholder="" class="FilddHalf11" /></td></tr>';
                                    row = row + '<tr><td align="right" width="110px;">Tare Validity Date</td> <td><input type="text" name="" id="" value="' + value.TareValidityDate + '" placeholder="" class="FilddHalf11" /></td>';
                                    row = row + '<tr><td align="right"></td><td align="right"><a href="javascript:void(0);" data-id="'+value.TruckRegNo+'" class="MainPopBtn" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage("Image37","","/images/fullscreen_hover.png",1)"><img src="/images/fullscreen_normal.png" name="Image37" width="26" height="26" border="0" id="Image37" /></a></td></tr></table></td>';
                                    $("#tblsearch").append(row);
                                    count = 0;
                                    $("#tblsearch").append('</tr><tr><td colspan="3" style="height: 10px;"><img src="/images/spacer.png" alt="" /></td></tr>');
