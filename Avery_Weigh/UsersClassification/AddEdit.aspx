<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddEdit.aspx.cs" Inherits="Avery_Weigh.UsersClassification.AddEdit" %>
...
<body onload="MM_preloadImages('/images/contact/contact_hover.png','/images/contact/info_hover.png','/images/contact/login_hover.png','/images/close_hover.png','/images/fullscreen_hover.png','/images/exit_fullscreen_hover.png','/images/type3/copy_hover.png','/images/type3/previous_page_hover.png','/images/type3/previous_record_hover.png','/images/type3/next_record_hover.png','/images/type3/next_page_hover.png')">
    <form id="form1" runat="server" defaultfocus="txtUserType">
        <div class="Wrapper WeighMain">
            ...
            <div class="MiddleSection">
                ...
                <div class="RightSec">
                    <div class="RightInn11 textcon" style="overflow:hidden">
                        <h4>CONFIGURATION</h4>
                        <h4 class="SupplierSearchBig">USER CLASSIFICATION CREATE/EDIT <a href="List.aspx" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image32','','/images/close_hover.png',1)" class="CloseButtonA">
                    ...
                    <div class="RightInn11 supplier">
                        ...
                        <div class="RightInnMasters">
                            ...
                            <table border="0" cellspacing="0" cellpadding="2">
                                <tr>
                                    <td align="right" width="150px;">User Type <span class="mandatory">*</span></td>
                                    <td colspan="3">
                                        <asp:TextBox ID="txtUserType" runat="server" Width="240px" CssClass="FilddHalf112" MaxLength="25"></asp:TextBox></td>
                                </tr>
                                <tr>
                                    <td align="right" width="150px;">Master File Updation</td>
                                    <td>
                                        <asp:DropDownList ID="ddlMasterFileDeletion" runat="server" CssClass="FilddHalf112" AppendDataBoundItems="false">
                                            <asp:ListItem Text="Disabled" Value="0"></asp:ListItem>
                                            <asp:ListItem Text="Enabled" Value="1"></asp:ListItem>
                                        </asp:DropDownList>
                                    </td>
                                    <td align="right" width="150px;">Master Record Deletion</td>
                                    <td>
                                        <asp:DropDownList ID="ddlMasterRecordDeletion" runat="server" CssClass="FilddHalf112" AppendDataBoundItems="false">
                                            <asp:ListItem Text="Disabled" Value="0"></asp:ListItem>
                                            <asp:ListItem Text="Enabled" Value="1"></asp:ListItem>
                                        </asp:DropDownList>
                                    </td>
                                ...
                                <tr>
                                    <td align="right" width="150px;">Pending Record Deletion</td>
                                    <td>
                                        <asp:DropDownList ID="ddlPendingRecordDeletion" runat="server" CssClass="FilddHalf112" AppendDataBoundItems="false" Enabled="False">
                                            <asp:ListItem Text="Disabled" Value="0"></asp:ListItem>
                                            <asp:ListItem Text="Enabled" Value="1"></asp:ListItem>
                                        </asp:DropDownList>
                                    </td>
                                    <td align="right" width="150px;">Transaction Deletion</td>
                                    <td>
                                        <asp:DropDownList ID="ddlTransactionDeletion" runat="server" CssClass="FilddHalf112" AppendDataBoundItems="false" Enabled="False">
                                            <asp:ListItem Text="Disabled" Value="0"></asp:ListItem>
                                            <asp:ListItem Text="Enabled" Value="1"></asp:ListItem>
                                        </asp:DropDownList>
                                    </td>
                                ...
                                <tr>
                                    <td align="right" width="150px;">Configuration</td>
                                    <td>
                                        <asp:DropDownList ID="ddlConfiguaration" runat="server" CssClass="FilddHalf112" AppendDataBoundItems="false" Enabled="False">
                                            <asp:ListItem Text="Disabled" Value="0"></asp:ListItem>
                                            <asp:ListItem Text="Enabled" Value="1"></asp:ListItem>
                                        </asp:DropDownList>
                                    </td>
                                    <td align="right" width="150px;">Password Policy</td>
                                    <td>
                                        <asp:DropDownList ID="ddlPasswordPolicy" runat="server" CssClass="FilddHalf112" AppendDataBoundItems="false" Enabled="False">
                                            <asp:ListItem Text="Disabled" Value="0"></asp:ListItem>
                                            <asp:ListItem Text="Enabled" Value="1"></asp:ListItem>
                                        </asp:DropDownList>
                                    </td>
                                ...
                                <tr>
                                    <td align="right" width="150px;">Password Reset</td>
                                    <td>
                                        <asp:DropDownList ID="ddlPasswordReset" runat="server" CssClass="FilddHalf112" AppendDataBoundItems="false" Enabled="False">
                                            <asp:ListItem Text="Disabled" Value="0"></asp:ListItem>
                                            <asp:ListItem Text="Enabled" Value="1"></asp:ListItem>
                                        </asp:DropDownList>
                                    </td>
                                    <td align="right" width="150px;">User Creation</td>
                                    <td>
                                        <asp:DropDownList ID="ddlUserCreation" runat="server" CssClass="FilddHalf112" AppendDataBoundItems="false">
                                            <asp:ListItem Text="Disabled" Value="0"></asp:ListItem>
                                            <asp:ListItem Text="Enabled" Value="1"></asp:ListItem>
                                        </asp:DropDownList>
                                    </td>
                                ...
                                <tr>
                                    <td align="right" width="150px;">Gate Entry</td>
                                    <td>
                                        <asp:DropDownList ID="ddlGateEntry" runat="server" CssClass="FilddHalf112" AppendDataBoundItems="false" Enabled="False">
                                            <asp:ListItem Text="Disabled" Value="0"></asp:ListItem>
                                            <asp:ListItem Text="Enabled" Value="1"></asp:ListItem>
                                        </asp:DropDownList>
                                    </td>
                                    <td align="right" width="150px;">RFID Issue</td>
                                    <td>
                                        <asp:DropDownList ID="ddlRFIDIssue" runat="server" CssClass="FilddHalf112" AppendDataBoundItems="false" Enabled="False">
                                            <asp:ListItem Text="Disabled" Value="0"></asp:ListItem>
                                            <asp:ListItem Text="Enabled" Value="1"></asp:ListItem>
                                        </asp:DropDownList>
                                    </td>
                                ...
                                <tr>
                                    <td align="right" width="150px;">Weighment</td>
                                    <td>
                                        <asp:DropDownList ID="ddlWeighment" runat="server" CssClass="FilddHalf112" AppendDataBoundItems="false">
                                            <asp:ListItem Text="Disabled" Value="0"></asp:ListItem>
                                            <asp:ListItem Text="Enabled" Value="1"></asp:ListItem>
                                        </asp:DropDownList>
                                    </td>
                                    <td align="right" width="150px;">Database Operation</td>
                                    <td>
                                        <asp:DropDownList ID="ddlDatabaseOperation" runat="server" CssClass="FilddHalf112" AppendDataBoundItems="false" Enabled="False">
                                            <asp:ListItem Text="Disabled" Value="0"></asp:ListItem>
                                            <asp:ListItem Text="Enabled" Value="1"></asp:ListItem>
                                        </asp:DropDownList>
                                    </td>
                                ...
                                <tr>
                                    <td align="right" width="150px;">Tare Tolerance Approval</td>
                                    <td>
                                        <asp:DropDownList ID="ddlTareTolApproval" runat="server" CssClass="FilddHalf112" AppendDataBoundItems="false">
                                            <asp:ListItem Text="Disabled" Value="0"></asp:ListItem>
                                            <asp:ListItem Text="Enabled" Value="1"></asp:ListItem>
                                        </asp:DropDownList>
                                    </td>
            ...
            <script type="text/javascript">
                function validateForm() {
                    var txtUserType = $('#txtUserType').val().trim();
                    if (txtUserType == "") {
    ...
    <script>
        $(document).ready(function () {
            $('#txtUserType').change(function () {
                ...
                $.ajax({
                    type: "POST",
                    url: "/AveryService/WebService1.asmx/Check_UserClassification",
                    data: "{'userType':'" + type + "'}",
                    ...
                    success: function (data) {
                        ...
                        if (data.d != '') {
                            ...
                            console.log(obj);
                            toastr.error('Same User Type already Exist');
                            $('#txtPlantCode').focus();
                        }
                    },
                    error: function (data) {
