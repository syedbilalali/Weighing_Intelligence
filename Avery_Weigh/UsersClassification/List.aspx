<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="Avery_Weigh.UsersClassification.List" %>
        ...
        <div class="Wrapper WeighMain">
            ...
            <div class="MiddleSection">
                ...
                <div class="RightSec">
                    <div class="RightInn11 textcon" style="overflow:hidden">
                        <h4>CONFIGURATION</h4>
                        <h4 class="SupplierSearchBig">USERS CLASSIFICATION MASTER <a href="/ConfigurationMaster" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image32','','/images/close_hover.png',1)" class="CloseButtonA">
                                    ...
                                    <asp:Repeater ID="rptList" runat="server" OnItemCreated="rptList_ItemCreated">
                                        <HeaderTemplate>
                                            <tr>
                                                ...
                                                <td align="center" valign="middle" bgcolor="#d8e7ee">User Type</td>
                                                <td align="center" valign="middle" bgcolor="#d8e7ee">Master File Updation</td>
                                                <td align="center" valign="middle" bgcolor="#d8e7ee">Master Record Deletion</td>
                                                <td align="center" valign="middle" bgcolor="#d8e7ee">Pending Record Deletion</td>
                                                <td align="center" valign="middle" bgcolor="#d8e7ee">Transaction Deletion</td>
                                               
                                            </tr>
                                        </HeaderTemplate>
                                        <ItemTemplate>
                                            <tr class="trclass" data-rowid="<%#Eval("Id")%>">
                                                <td align="center" valign="middle"> <asp:Label ID="lblid" runat="server"></asp:Label></td>
                                                <td align="center" valign="middle"><%#Eval("UserType") %></td>
                                                <td align="center" valign="middle"><%#Eval("MasterFileUpdation").ToString() == "True" ? "Enable" : "Disable" %></td>
                                                <td align="center" valign="middle"><%#Eval("MasterRecordDeletion").ToString() == "True" ? "Enable":"Disable" %></td>
                                                <td align="center" valign="middle"><%#Eval("PendingRecordDeletion").ToString() == "True" ? "Enable":"Disable" %></td>
                                                <td align="center" valign="middle"><%#Eval("TransactionDeletion").ToString() == "True" ? "Enable":"Disable" %></td>                                              
                                            </tr>
                                        </ItemTemplate>
                                    </asp:Repeater>
                                </table>
            ...
            <div class="footer">
                <ul class="selected">
                    ...
                    <li><asp:LinkButton ID="BtnAddEdit" runat="server" OnClick="BtnAddEdit_Click" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image12','','/images/type4/edit_hover.png',1)">
                    ...
                    <li><asp:LinkButton ID="BtnExportToExcel" runat="server" OnClick="BtnExportToExcel_Click" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image15','','/images/type4/import_hover.png',1)">
                    ...
                    <li><asp:LinkButton ID="BtnDelete" runat="server" OnClientClick="return Delete();" OnClick="BtnDelete_Click" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image17','','/images/type4/delete_hover.png',1)">
