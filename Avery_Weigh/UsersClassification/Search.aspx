<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Search.aspx.cs" Inherits="Avery_Weigh.UsersClassification.Search" %>
            ...
            <div class="MiddleSection">
                ...
                <div class="RightSec">
                    <div class="RightInn11" style="overflow:hidden">
                        <h4>CONFIGURATION</h4>
                        <h4 class="SupplierSearchBig">USER CLASSIFICATION | SEARCH <a href="List.aspx" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image32','','images/close_hover.png',1)" class="CloseButtonA">
                        ...
                        <div class="RightInn33">
                                ...
                                <tr>
                                    <td class="TableDiv">
                                        <table border="0" cellspacing="0" cellpadding="2">
                                            <tr>
                                                <td align="right" width="110px;">User Type</td>
                                                <td>
                                                    <input type="text" name="" id="" value="" placeholder="" class="FilddHalf11" /></td>
                                            </tr>
                                            <tr>
                                                <td align="right">Master File Updation</td>
                                                <td>
                                                    <input type="text" name="" id="" value="" placeholder="" class="FilddHalf11" /></td>
                                            </tr>
                                            <tr>
                                                <td align="right">Master Record Deletion</td>
                                                <td>
                                                    <input type="text" name="" id="" value="" placeholder="" class="FilddHalf11" /></td>
                                            </tr>
                                            <tr>
                                                <td align="right">Pending Record Deletion</td>
                                                <td>
                                                    <input type="text" name="" id="" value="" placeholder="" class="FilddHalf11" /></td>
                                            </tr>
                                            <tr>
                            ...
                            <div class="Popup">
                                <table border="0" cellspacing="0" cellpadding="2" class="PopupDiv">
                                    <tr>
                                        <td align="left" class="PopupHeader" style="color: #ffffff; padding-left: 15px;">USER CLASSIFICATION</td>
                                        ...
                                        <td colspan="2" style="padding: 10px 0 20px 0px;">
                                            <table border="0" cellspacing="0" cellpadding="2">
                                                <tr>
                                                    <td align="right" width="110px;">User Type</td>
                                                    <td>
                                                        <input type="text" name="" id="txtusertype" value="" placeholder="" class="FilddHalf112" /></td>
                                                    <td align="right" width="110px;">Master File Updation</td>
                                                    <td>
                                                        <input type="text" name="" id="txtfileupdation" value="" placeholder="" class="FilddHalf112" /></td>
                                                </tr>
                                                <tr>
                                                    <td align="right" width="110px;">Master Record Deletion</td>
                                                    <td>
                                                        <input type="text" name="" id="txtmasterrecorddeletion" value="" placeholder="" class="FilddHalf112" /></td>
                                                    <td align="right" width="110px;">Pending Record Deletion</td>
                                                    <td>
                                                        <input type="text" name="" id="txtpendingrecorddeletion" value="" placeholder="" class="FilddHalf112" /></td>
                                                </tr>
                                                <tr>
                                                    <td align="right" width="110px;">Transaction Deletion</td>
                                                    <td>
                                                        <input type="text" name="" id="txtdeletion" value="" placeholder="" class="FilddHalf112" /></td>
                                                    <td align="right" width="110px;">Configuration</td>
                                                    <td>
                                                        <input type="text" name="" id="txtconfiguration" value="" placeholder="" class="FilddHalf112" /></td>
                                                </tr>
                                                <tr>
                                                    <td align="right" width="110px;">Password Policy</td>
                                                    <td>
                                                        <input type="text" name="" id="txtpolicy" value="" placeholder="" class="FilddHalf112" /></td>
                                                    <td align="right" width="110px;">Password Reset</td>
                                                    <td>
                                                        <input type="text" name="" id="txtreset" value="" placeholder="" class="FilddHalf112" /></td>
                                                </tr>
                                                <tr>
                                                    <td align="right" width="110px;">User Creation</td>
                                                    <td>
                                                        <input type="text" name="" id="txtcreation" value="" placeholder="" class="FilddHalf112" /></td>
                                                    <td align="right" width="110px;">Gate Entry</td>
                                                    <td>
                                                        <input type="text" name="" id="txtentry" value="" placeholder="" class="FilddHalf112" /></td>
                                                </tr>
                                                <tr>
                                                    <td align="right" width="110px;">RFID Issue</td>
                                                    <td>
                                                        <input type="text" name="" id="txtissue" value="" placeholder="" class="FilddHalf112" /></td>
                                                    <td align="right" width="110px;">Weighment</td>
                                                    <td>
                                                        <input type="text" name="" id="txtweighment" value="" placeholder="" class="FilddHalf112" /></td>
                                                </tr>
                                                <tr>
                                                    <td align="right" width="110px;">Database Operation</td>
                                                    <td>
                                                        <input type="text" name="" id="txtoperation" value="" placeholder="" class="FilddHalf112" /></td>
                        ...
                        success: function (response) {
                            ...
                            $.each(obj, function (key, value) {
                                if (count == 0) {
                                    ...
                                    row = row + '<tr><td align="right" width="110px;">User Type</td> <td><input type="text" name="" id="" value="' + value.UserType + '" placeholder="" class="FilddHalf11" /></td></tr>';
                                    row = row + '<tr><td align="right" width="110px;">Master File Updation</td> <td><input type="text" name="" id="" value="' + value.MasterFileUpdation + '" placeholder="" class="FilddHalf11" /></td></tr>';
                                    row = row + '<tr><td align="right" width="110px;">Master Record Deletion</td> <td><input type="text" name="" id="" value="' + value.MasterRecordDeletion + '" placeholder="" class="FilddHalf11" /></td></tr>';
                                    row = row + '<tr><td align="right" width="110px;">Pending Record Deletion</td> <td><input type="text" name="" id="" value="' + value.PendingRecordDeletion + '" placeholder="" class="FilddHalf11" /></td></tr>';
                                    ...
                                    row = row + '<tr><td align="right" width="110px;">Master File Updation</td> <td><input type="text" name="" id="" value="' + value.MasterFileUpdation + '" placeholder="" class="FilddHalf11" /></td></tr>';
                                    row = row + '<tr><td align="right" width="110px;">Master Record Deletion</td> <td><input type="text" name="" id="" value="' + value.MasterRecordDeletion + '" placeholder="" class="FilddHalf11" /></td></tr>';
                                    row = row + '<tr><td align="right" width="110px;">Pending Record Deletion</td> <td><input type="text" name="" id="" value="' + value.PendingRecordDeletion + '" placeholder="" class="FilddHalf11" /></td>';
                                    row = row + '<tr><td align="right"></td><td align="right"><a href="javascript:void(0);" data-id="' + value.UserType + '" class="MainPopBtn" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage("Image37","","/images/fullscreen_hover.png",1)"><img src="/images/fullscreen_normal.png" name="Image37" width="26" height="26" border="0" id="Image37" /></a></td></tr></table></td>';
                                    $("#tblsearch").append(row);
                                    count = 0;
