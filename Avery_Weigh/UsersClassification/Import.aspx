<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Import.aspx.cs" Inherits="Avery_Weigh.UsersClassification.Import" %>
            ...
            <div class="MiddleSection">
                ...
                <div class="RightSec">
                    <div class="RightInn11">
                        <h4>MASTERS</h4>
                        <h4 class="SupplierSearchBig">USER CLASSIFICATION IMPORT <a href="List.aspx" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image32','','/images/close_hover.png',1)" class="CloseButtonA">
                    ...
                    <div class="RightInn11">
                        ...
                        <div class="RightInnMasters">
                            ...
                            <div style="width:50%;float:right;display:inline-block;text-align:left">
                                <div style="heightL50px"></div>
                                <h3 style="color:red">Instruction to import xlsx file</h3>
                                <table style="border:1px solid red">
                                    <tr>
                                        <td></td>
                                        <td>User Type should be less than or equal to 25 Character</td>
                                    </tr>
                                </table>
                            </div>
                        </div>
                ...
                <div class="footer">
                    <ul class="selected">
                        ...
                        <img src="/images/type4/edit_normal.png" name="Image12" width="80" height="50" border="0" id="Image12" /></a></li>
                         <li>
                             <asp:LinkButton ID="BtnSave" runat="server" OnClick="BtnSave_Click" OnClientClick="return ValidateFileUpload1();" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image13','','/images/type4/save_hover.png',1)">
