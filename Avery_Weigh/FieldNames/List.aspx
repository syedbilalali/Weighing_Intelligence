        ...
        <div class="Wrapper WeighMain">
            ...
            <div class="footer">
                <ul class="selected">
                    ...
                    <li>
                        <asp:LinkButton ID="Delete" runat="server" OnClick="Delete_Click" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image17','','/images/type4/delete_hover.png',1)">
