<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddEdit.aspx.cs" Inherits="Avery_Weigh.WeightMachinMaster.AddEdit" %>

<%@ Register Src="~/View/Header.ascx" TagName="Header" TagPrefix="uc1" %>
<!DOCTYPE html>
...
<body onload="MM_preloadImages('images/contact/contact_hover.png','images/contact/info_hover.png','images/contact/login_hover.png','images/close_hover.png','images/fullscreen_hover.png','images/exit_fullscreen_hover.png','images/type3/copy_hover.png','images/type3/previous_page_hover.png','images/type3/previous_record_hover.png','images/type3/next_record_hover.png','images/type3/next_page_hover.png')">
            ...
            <div class="MiddleSection">
                ...
                <div class="RightSec ">
                    <div class="RightInn11 textcon" style="overflow:hidden">
                        <h4>SERVICES</h4>
                        <h4 class="SupplierSearchBig">WEIGHING MACHINE MASTER<a href="List.aspx" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image32','','/images/close_hover.png',1)" class="CloseButtonA">
                        ...
                        <div class="RightInnMasters">
                            ...
                            <table border="0" cellspacing="0" cellpadding="2">
                                <tr>
                                    ...
                                    <td>
                                        <asp:DropDownList ID="ddlPlantId" Width="287px" CssClass="FilddHalf112" runat="server" DataTextField="PlantName" DataValueField="PlantCode"></asp:DropDownList>
                                    </td>
                                ...
                                <tr>
                                    <td align="right" width="150px;">Capacity</td>
                                    <td>
                                        <asp:TextBox ID="txtCapacity" runat="server" Width="180px" Height="20px" CssClass="FilddHalf21" MaxLength="6"></asp:TextBox>
                                        <asp:DropDownList ID="ddlcapacityuom" runat="server" CssClass="FilddHalf1" Width="80px">
                                    ...
                                    <td align="right" width="150px;">Resolution</td>
                                    <td>
                                        <asp:TextBox ID="txtResolution" runat="server" Width="180px" Height="20px" CssClass="FilddHalf21" MaxLength="3"></asp:TextBox>
                                        <asp:DropDownList ID="ddlresolutionuom" runat="server" Width="80px" CssClass="FilddHalf1">
                                            <asp:ListItem Value="kg">kg</asp:ListItem>
                                            <asp:ListItem Value="t">t</asp:ListItem>
                                            <asp:ListItem Value="g">g</asp:ListItem>
                                        </asp:DropDownList>
    ...
    <script type="text/javascript">
        ...
        function validateForm() {
            ...
            var machinid = $('#txtMachinId').val();
            var capacity = $('#txtCapacity').val();
            var resolution = $('#txtResolution').val();
            var model = $('#txtModel').val();
            var platformsize = $('#txtPlatformsize').val();
            var machinno = $('#txtmachinno').val();
            var indicator = $('#txtindicator').val();
            var lctype = $('#txtlctype').val();
            var noofloadcells = $('#txtnoofloadcells').val();
            var loadcellserialnos = $('#txtlcsn').val();
            var equipment = $('#txtequipment').val();
            var invoiceno = $('#txtinvoiceno').val();
            var despatch = $('#txtdispatchdate').val();
            var installationdate = $('#txtinstallationdate').val();
            var warrantyupto = $('#txtwarrantyupto').val();
            var reasonwarraty = $('#txtrowud').val();
            if (plantid.length <= 0 || machinid.length <= 0 || capacity.trim() == '' || resolution.trim() == '' || model.trim() == '' || platformsize.trim() == '' || machinno.trim() == '' || indicator.trim() == '' ||
                lctype.trim() == '' || noofloadcells.trim() == '' || loadcellserialnos.trim() == '' || equipment.trim() == '' || invoiceno.trim() == '' || despatch.trim() == '' || installationdate.trim() == '' ||
                warrantyupto.trim() == '' || reasonwarraty.trim() == '') {
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $('#txtMachinId').change(function () {
                var machineid = $('#txtMachinId').val();
                $.ajax({
                    type: "POST",
                    url: "/AveryService/WebService1.asmx/Check_WeightMachineMaster",
                    ...
                    success: function (data) {
                        ...
                        if (data.d != "") {
                            ...
                            console.log(obj);
                            toastr.error('Same Machine ID Exist');
                            $('#txtMachinId').focus();
                        }
                    },
                    error: function (data) {
            ...
            $("#txtCapacity").keydown(function (e) {
            ...
            $("#txtResolution").keydown(function (e) {
                if ($.inArray(e.keyCode, [46, 8, 9, 27, 13, 110, 190]) !== -1 ||
                    ((e.keyCode == 65 || e.keyCode == 86 || e.keyCode == 67) && (e.ctrlKey === true || e.metaKey === true)) ||
                    (e.keyCode >= 35 && e.keyCode <= 40)) {
                    return;
            ...
            $("#txtnoofloadcells").keydown(function (e) {
                if ($.inArray(e.keyCode, [46, 8, 9, 27, 13, 110, 190]) !== -1 ||
                    ((e.keyCode == 65 || e.keyCode == 86 || e.keyCode == 67) && (e.ctrlKey === true || e.metaKey === true)) ||
                    (e.keyCode >= 35 && e.keyCode <= 40)) {
                    return;
