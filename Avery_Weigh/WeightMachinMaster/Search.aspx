<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Search.aspx.cs" Inherits="Avery_Weigh.WeightMachinMaster.Search" %>
...
<head runat="server">
    ...
    <script>
        $(document).on("click", ".MainPopBtn", function () {
            ...
            $.ajax({
                type: "POST",
                url: "/AveryService/WebService1.asmx/GetweightmachinByCode",
                data: "{'code':'" + code + "'}",
                ...
                success: function (response) {
                    ...
                    var despatchdate = obj.DespatchDate;
                    var nowDate1 = new Date(parseInt(despatchdate.substr(6)));
                    var result1 = "";
                    result1 += nowDate1.format("mm/dd/yyyy");

                    var installationdate = obj.InstallationDate;
                    var nowDate2 = new Date(parseInt(installationdate.substr(6)));
                    var result2 = "";
                    result2 += nowDate2.format("mm/dd/yyyy");

                    var warrentyupto = obj.WarrentyUpto;
                    var nowDate3 = new Date(parseInt(warrentyupto.substr(6)));
                    var result3 = "";
                    result3 += nowDate3.format("mm/dd/yyyy");

                    $('#txtCode').val(obj.PlantCodeId);
                    $('#txtmachineid').val(obj.MachineId);
                    $('#txtcapacity').val(obj.Capacity);
                    $('#txtresolution').val(obj.Resolution);
                    $('#txtmodel').val(obj.Model);
                    $('#txtplatformsize').val(obj.PlatformSize);
                    $('#txtmachineno').val(obj.MachineNo);
                    $('#txtindicator').val(obj.Indicator);
                    $('#txtlctype').val(obj.LCType);
                    $('#txtnoofloadcells').val(obj.NoOfLoadCells);
                    $('#txtequipmentid').val(obj.EquipmentId);
                    $('#txtinvoiceno').val(obj.InvoiceNo);
                    $('#txtdesdate').val(result1);
                    $('#txtinstadate').val(result2);
                    $('#txtwu').val(result3);
                    $('#txtrwud').val(obj.ReasonWarrentyUptoDate);
                },
            ...
            <div class="MiddleSection">
                ...
                <div class="RightSec">
                    <div class="RightInn11" style="overflow:hidden">
                        <h4>MASTERS</h4>
                        <h4 class="SupplierSearchBig">WEIGHING MACHINE MASTER | SEARCH <a href="List.aspx" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image32','','/images/close_hover.png',1)" class="CloseButtonA">
                                ...
                                <tr>
                                    <td align="left">
                                        <table width="200" border="0" cellspacing="0" cellpadding="0" style="margin-top: 20px;">
                                            ...
                                            <tr>
                                                <td align="center">
                                                    <select class="DropDown" id="ddlSearch1" style="width: 85%; float:right">
                                                        <option value="Code">Code</option>
                                                        <option value="Name">Machine ID</option>
                                                    </select>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td align="center">
                                                    <input type="text" name="search1" id="search1" style="width: 75%; margin-top: 12px; float:right" />
                                                </td>
                                            </tr>
                                            <tr>
                                                <td height="40px"></td>
                                            ...
                                            <tr>
                                                <td align="center">
                                                    <select class="DropDown" id="ddlSearch2" style="width: 85%; float:right">
                                                        <option value="Code">Code</option>
                                                        <option value="Name">Machine ID</option>
                                                    </select>
                                                </td>
                                            ...
                                            <tr>
                                                <td align="center">
                                                    <input type="text" name="search2" id="search2" style="width: 75%; margin-top: 12px; float:right" />
                                                </td>
                                            </tr>
                                            <tr>
                                                <td height="40px"></td>
                        ...
                        <div class="RightInn33">
                                ...
                                <tr>
                                    <td class="TableDiv">
                                        <table border="0" cellspacing="0" cellpadding="2">
                                            <tr>
                                                <td align="right" width="110px;">Plant Code</td>
                                                <td>
                                                    <input type="text" name="" id="" value="" placeholder="" class="FilddHalf11" /></td>
                                            </tr>
                                            <tr>
                                                <td align="right">Machine Id</td>
                                                <td>
                                                    <input type="text" name="" id="" value="" placeholder="" class="FilddHalf11" /></td>
                                            </tr>
                                            <tr>
                            ...
                            <div class="Popup">
                                <table border="0" cellspacing="0" cellpadding="2" class="PopupDiv">
                                    <tr>
                                        <td align="left" class="PopupHeader" style="color: #ffffff; padding-left: 15px;">Weighing Machine Master</td>
                                        ...
                                        <td colspan="2" style="padding: 10px 0 20px 0px;">
                                            <table border="0" cellspacing="0" cellpadding="2">
                                                <tr>
                                                    ...
                                                    <td align="right" width="110px;">Machine Id</td>
                                                    <td>
                                                        <input type="text" name="" id="txtmachineid" value="" placeholder="" class="FilddHalf112" /></td>
                                                </tr>
                                                <tr>
                                                    <td align="right" width="110px;">Capacity</td>
                                                    <td>
                                                        <input type="text" name="" id="txtcapacity" value="" placeholder="" class="FilddHalf112" /></td>
                                                    <td align="right" width="110px;">Resolution</td>
                                                    <td>
                                                        <input type="text" name="" id="txtresolution" value="" placeholder="" class="FilddHalf112" /></td>
                                                </tr>
                                                <tr>
                                                    <td align="right" width="110px;">Model</td>
                                                    <td>
                                                        <input type="text" name="" id="txtmodel" value="" placeholder="" class="FilddHalf112" /></td>
                                                    <td align="right" width="110px;">Platform Size</td>
                                                    <td>
                                                        <input type="text" name="" id="txtplatformsize" value="" placeholder="" class="FilddHalf112" /></td>
                                                </tr>
                                                <tr>
                                                    <td align="right" width="110px;">Machine No</td>
                                                    <td>
                                                        <input type="text" name="" id="txtmachineno" value="" placeholder="" class="FilddHalf112" /></td>
                                                    <td align="right" width="110px;">Indicator</td>
                                                    <td>
                                                        <input type="text" name="" id="txtindicator" value="" placeholder="" class="FilddHalf112" /></td>
                                                </tr>
                                                <tr>
                                                    <td align="right" width="110px;">LC/Type</td>
                                                    <td>
                                                        <input type="text" name="" id="txtlctype" value="" placeholder="" class="FilddHalf112" /></td>
                                                    <td align="right" width="110px;">No Of Load Cells</td>
                                                    <td>
                                                        <input type="text" name="" id="txtnoofloadcells" value="" placeholder="" class="FilddHalf112" /></td>
                                                </tr>
                                                <tr>
                                                    <td align="right" width="110px;">Equipment Id</td>
                                                    <td>
                                                        <input type="text" name="" id="txtequipmentid" value="" placeholder="" class="FilddHalf112" /></td>
                                                    <td align="right" width="110px;">Invoice No</td>
                                                    <td>
                                                        <input type="text" name="" id="txtinvoiceno" value="" placeholder="" class="FilddHalf112" /></td>
                                                </tr>
                                                <tr>
                                                    <td align="right" width="110px;">Despatch Date</td>
                                                    <td>
                                                        <input type="text" name="" id="txtdesdate" value="" placeholder="dd/mm/yyyy" class="FilddHalf112" /></td>
                                                    <td align="right" width="110px;">Installation Date</td>
                                                    <td>
                                                        <input type="text" name="" id="txtinstadate" value="" placeholder="dd/mm/yyyy" class="FilddHalf112" /></td>
                                                </tr>
                                                <tr>
                                                    <td align="right" width="110px;">Warranty Upto</td>
                                                    <td>
                                                        <input type="text" name="" id="txtwu" value="" dataformatstring="{0:dd/MMM/yyyy}" placeholder="dd/mm/yyyy" class="FilddHalf112" /></td>
                                                    <td align="right" width="110px;">Reason Warranty Upto Date</td>
                                                    <td>
                                                        <input type="text" name="" id="txtrwud" value="" placeholder="dd/mm/yyyy" class="FilddHalf112" /></td>
                                                </tr>
                                            </table>
                                        </td>
                                    </tr>
        ...
        <script type="text/javascript">  
            $(document).ready(function () {
                $("#search1").keyup(function () {
                    ...
                    $.ajax({
                        type: "POST",
                        url: "/AveryService/WebService1.asmx/Get_WeightMachineMaster",
                        ...
                        success: function (response) {
                            ...
                            $.each(obj, function (key, value) {
                                if (count == 0) {
                                    ...
                                    row = row + '<tr><td align="right" width="110px;">Plant Code</td> <td><input type="text" name="" id="" value="' + value.PlantCodeId + '" placeholder="" class="FilddHalf11" /></td></tr>';
                                    row = row + '<tr><td align="right" width="110px;">Machine Id</td> <td><input type="text" name="" id="" value="' + value.MachineId + '" placeholder="" class="FilddHalf11" /></td></tr>';
                                    row = row + '<tr><td align="right" width="110px;">Capacity</td> <td><input type="text" name="" id="" value="' + value.Capacity + '" placeholder="" class="FilddHalf11" /></td></tr>';
                                    row = row + '<tr><td align="right" width="110px;">Resolution</td> <td><input type="text" name="" id="" value="' + value.Resolution + '" placeholder="" class="FilddHalf11" /></td></tr>';
                                    row = row + '<tr><td align="right"></td><td align="right"><a href="javascript:void(0);" data-id="' + value.PlantCodeId + '" class="MainPopBtn" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage("Image37","","/images/fullscreen_hover.png",1)"><img src="/images/fullscreen_normal.png" name="Image37" width="26" height="26" border="0" id="Image37" /></a></td></tr></table></td>';
                                    ...
                                    row = row + '<tr><td align="right" width="110px;">Machine Id</td> <td><input type="text" name="" id="" value="' + value.MachineId + '" placeholder="" class="FilddHalf11" /></td></tr>';
                                    row = row + '<tr><td align="right" width="110px;">Capacity</td> <td><input type="text" name="" id="" value="' + value.Capacity + '" placeholder="" class="FilddHalf11" /></td></tr>';
                                    row = row + '<tr><td align="right" width="110px;">Resolution</td> <td><input type="text" name="" id="" value="' + value.Resolution + '" placeholder="" class="FilddHalf11" /></td>';
                                    row = row + '<tr><td align="right"></td><td align="right"><a href="javascript:void(0);" data-id="' + value.PlantCodeId + '" class="MainPopBtn" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage("Image37","","/images/fullscreen_hover.png",1)"><img src="/images/fullscreen_normal.png" name="Image37" width="26" height="26" border="0" id="Image37" /></a></td></tr></table></td>';
                                    $("#tblsearch").append(row);
                                    count = 0;
