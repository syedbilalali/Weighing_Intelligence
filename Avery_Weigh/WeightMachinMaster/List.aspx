<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="Avery_Weigh.WeightMachinMaster.List" %>
        ...
        <div class="Wrapper WeighMain">
            ...
            <div class="MiddleSection">
                ...
                <div class="RightSec">
                    <div class="RightInn11 textcon" style="overflow:hidden">
                        <h4>CONFIGURATION</h4>
                        <h4 class="SupplierSearchBig">WEIGHING MACHIN MASTER<a href="/ConfigurationMaster" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image32','','/images/close_hover.png',1)" class="CloseButtonA">
                        ...
                        <div class="RightInnMasters">
                            ...
                            <div id="dbMain" runat="server" style="display: none;">
                                <table style="width: 100%;" border="1" bordercolor="#72aac0" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF" class="MainLTable">
                                    <asp:Repeater ID="RptrWeightMachinMaster" runat="server" OnItemCreated="RptrWeightMachinMaster_ItemCreated">
                                        <HeaderTemplate>
                                            <tr>
                                                ...
                                                <td align="center" valign="middle" bgcolor="#d8e7ee">Despatch Date</td>
                                                <td align="center" valign="middle" bgcolor="#d8e7ee">Installation Date</td>
                                            </tr>
                                        </HeaderTemplate>
                                        <ItemTemplate>
                                            <tr class="trclass" data-rowid="<%#Eval("Id") %>">
                                                ...
                                                <td align="center" valign="middle"><%#Eval("PlantCodeId") %></td>
                                                <td align="center" valign="middle"><%#Eval("MachineId") %></td>
                                                <td align="center" valign="middle"><%#Eval("DespatchDate","{0: dd/MM/yyyy}")%></td>
                                                <td align="center" valign="middle"><%#Eval("InstallationDate","{0: dd/MM/yyyy}")%></td>
                                            </tr>
                                        </ItemTemplate>
                                    </asp:Repeater>
                                </table>
                            ...
                            <table id="tblNone" runat="server" visible="false" style="width: 100%;" border="1" bordercolor="#72aac0" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF" class="MainLTable">
                                <thead>
                                    <tr>
                                        ...
                                        <td align="center" valign="middle" bgcolor="#d8e7ee">Plant Code</td>
                                        <td align="center" valign="middle" bgcolor="#d8e7ee">Machine Id</td>
                                        <td align="center" valign="middle" bgcolor="#d8e7ee">Capacity</td>
                                        <td align="center" valign="middle" bgcolor="#d8e7ee">Resolution</td>
                                        <td align="center" valign="middle" bgcolor="#d8e7ee">Model</td>
                                        <td align="center" valign="middle" bgcolor="#d8e7ee">Platform Size</td>
                                        <td align="center" valign="middle" bgcolor="#d8e7ee">Machin No</td>
                                        <td align="center" valign="middle" bgcolor="#d8e7ee">Indicator</td>
                                        <td align="center" valign="middle" bgcolor="#d8e7ee">L/C Type</td>
                                        <td align="center" valign="middle" bgcolor="#d8e7ee">No Of Load Cells</td>
                                        <td align="center" valign="middle" bgcolor="#d8e7ee">Load Cell Serial Nos</td>
                                        <td align="center" valign="middle" bgcolor="#d8e7ee">Equipment</td>
                                        <td align="center" valign="middle" bgcolor="#d8e7ee">Invoice No</td>
                                        <td align="center" valign="middle" bgcolor="#d8e7ee">Despatch Date</td>
                                        <td align="center" valign="middle" bgcolor="#d8e7ee">Installation Date</td>
                                        <td align="center" valign="middle" bgcolor="#d8e7ee">Warranty Upto</td>
                                        <td align="center" valign="middle" bgcolor="#d8e7ee">Reason of Warranty Upto Date</td>
            ...
            <div class="footer">
                <ul class="selected">
                    ...
                    <li>
                        <asp:LinkButton runat="server" ID="AddAndEdit" OnClick="AddAndEdit_Click" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image12','','/images/type4/edit_hover.png',1)">
                    ...
                    <li>
                        <a href="Import.aspx" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Imag14','','/images/type4/export_hover.png',1)">
                            <img src="/images/type4/export_normal.png" alt="Export" name="Imag14" width="80" height="50" border="0" id="Imag14" /></a></li>
                    <li>
                        <asp:LinkButton runat="server" ID="ExpToExcel" OnClick="ExpToExcel_Click" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image15','','/images/type4/import_hover.png',1)">
                    ...
                    <li>
                        <asp:LinkButton runat="server" ID="Delete" OnClick="Delete_Click" OnClientClick="return DeleteRecord();" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image17','','/images/type4/delete_hover.png',1)">
