<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Import.aspx.cs" Inherits="Avery_Weigh.Supplier.Import" %>
            ...
            <div class="MiddleSection">
                ...
                <div class="RightSec">
                    <div class="RightInn11">
                        <h4>MASTERS</h4>
                        <h4 class="SupplierSearchBig">SUPPLIER IMPORT <a href="/ManageMasters" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image32','','/images/close_hover.png',1)" class="CloseButtonA">
                        ...
                        <div class="RightInnMasters">
                            ...
                            <div style="width:50%;float:right;display:inline-block;text-align:left">
                                ...
                                <table style="border:1px solid red">
                                    <tr>
                                        <td>1</td>
                                        <td>Supplier Code Should be less than or equal to 10 character</td>
                                    </tr>
                                     <tr>
                                        <td>2</td>
                                        <td>Name should less be than or equal to 25 character</td>
                                    </tr>
                                     <tr>
                                        <td>3</td>
                                     ...
                                     <tr>
                                        <td>9</td>
                                        <td>PAN number should be less than or equal to 25 character</td>
                                    </tr>
                                     <tr>
                                        <td>10</td>
                                     ...
                                     <tr>
                                        <td>11</td>
                                        <td>Contact Email should be less than or equal to 25 character</td>
                                    </tr>
                                     <tr>
                                        <td>12</td>
                                        <td>Contact Mobile Number should be less than or equal to 12 character and should be in Numeric format</td>
                                    </tr>
                                </table>
                            </div>
                        </div>
                ...
                <div class="footer">
                    <ul class="selected">
                        ...
                        <img src="/images/type4/edit_normal.png" name="Image12" width="80" height="50" border="0" id="Image12" /></a></li>
                         <li><asp:LinkButton ID="lnkSave" runat="server" OnClick="lnkSave_Click" OnClientClick="return ValidateFileUpload();" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image13','','/images/type4/save_hover.png',1)">
