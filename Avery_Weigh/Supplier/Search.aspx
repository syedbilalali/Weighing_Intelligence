<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Search.aspx.cs" Inherits="Avery_Weigh.Supplier.Search" %>
...
<head runat="server">
    ...
    <script>
        $(document).on("click", ".MainPopBtn", function () {
            ...
            $.ajax({
                        type: "POST",
                        url: "/AveryService/WebService1.asmx/GetSupplierbyCode",
                        data: "{'code':'" + code + "'}",
                        ...
                        success: function (response) {
                            ...
                            $('#txtContactEMail').val(obj.ContactEMail);
                            $('#txtContactMobile').val(obj.ContactMobile);
            ...
            <div class="MiddleSection">
                ...
                <div class="RightSec">
                    <div class="RightInn11" style="overflow:hidden">
                        <h4>MASTERS</h4>
                        <h4 class="SupplierSearchBig">SUPPLIER | SEARCH <a href="List.aspx" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image32','','/images/close_hover.png',1)" class="CloseButtonA">
                        ...
                        <div class="RightInn33">
                            ...
                            <div class="Popup">
                                <table border="0" cellspacing="0" cellpadding="2" class="PopupDiv">
                                    <tr>
                                        <td align="left" class="PopupHeader" style="color: #ffffff; padding-left: 15px;">ABCDEFGHIJKLMNOPQRSTUV</td>
                                        ...
                                        <td colspan="2" style="padding: 10px 0 20px 0px;">
                                            <table border="0" cellspacing="0" cellpadding="2">
                                                <tr>
                                                    ...
                                                    <td align="right" width="110px;">Name</td>
                                                    <td>
                                                        <input type="text" name="" id="txtName" value="" placeholder="" class="FilddHalf112" /></td>
                                                </tr>
                                                <tr>
                                                    <td align="right" width="110px;">Address1</td>
                                                    <td>
                                                        <input type="text" name="" id="txtAddress1" value="" placeholder="" class="FilddHalf112" /></td>
                                                    <td align="right" width="110px;">Address2</td>
                                                    <td>
                                                        <input type="text" name="" id="txtAddress2" value="" placeholder="" class="FilddHalf112" /></td>
                                                </tr>
                                                <tr>
                                                    <td align="right" width="110px;">City</td>
                                                    <td>
                                                        <input type="text" name="" id="txtCity" value="" placeholder="" class="FilddHalf112" /></td>
                                                    <td align="right" width="110px;">State</td>
                                                    <td>
                                                        <input type="text" name="" id="txtState" value="" placeholder="" class="FilddHalf112" /></td>
                                                </tr>
                                                <tr>
                                                    <td align="right" width="110px;">Country</td>
                                                    <td>
                                                        <input type="text" name="" id="txtCountry" value="" placeholder="" class="FilddHalf112" /></td>
                                                    <td align="right" width="110px;">GST No</td>
                                                    <td>
                                                        <input type="text" name="" id="txtGSTNo" value="" placeholder="" class="FilddHalf112" /></td>
                                                </tr>
                                                <tr>
                                                    <td align="right" width="110px;">Contact Person</td>
                                                    <td>
                                                        <input type="text" name="" id="txtContactPerson" value="" placeholder="" class="FilddHalf112" /></td>
                                                    <td align="right" width="110px;">Contact E-Mail</td>
                                                    <td>
                                                        <input type="text" name="" id="txtContactEMail" value="" placeholder="" class="FilddHalf112" /></td>
                                                </tr>
                                                <tr>
                                                    <td align="right" width="110px;">Contact Mobile</td>
                                                    <td>
                                                        <input type="text" name="" id="txtContactMobile" value="" placeholder="" class="FilddHalf112" /></td>
                                                    <td align="right" width="110px;">PanNo</td>
                                                    <td>
                                                        <input type="text" name="" id="txtPanNo" value="" placeholder="" class="FilddHalf112" /></td>
                                                </tr>
                                            </table>
                                        </td>
                                    </tr>
        ...
        <script type="text/javascript">  
            $(document).ready(function () {
                $("#search1").keyup(function () {
                    ...
                    $.ajax({
                        type: "POST",
                        url: "/AveryService/WebService1.asmx/GetSupplier",
                        ...
                        success: function (response) {
                            ...
                            $.each(obj, function (key, value) {
                                if (count == 0) {
                                    ...
                                    row = row + '<tr><td align="right" width="110px;">Code</td> <td><input type="text" name="" id="" value="' + value.Code + '" placeholder="" class="FilddHalf11" /></td></tr>';
                                    row = row + '<tr><td align="right" width="110px;">Name</td> <td><input type="text" name="" id="" value="' + value.Name + '" placeholder="" class="FilddHalf11" /></td></tr>';
                                    row = row + '<tr><td align="right" width="110px;">City</td> <td><input type="text" name="" id="" value="' + value.City + '" placeholder="" class="FilddHalf11" /></td></tr>';
                                    row = row + '<tr><td align="right" width="110px;">Contact Person</td> <td><input type="text" name="" id="" value="' + value.ContactPerson + '" placeholder="" class="FilddHalf11" /></td></tr>';
                                    row = row + '<tr><td align="right"></td><td align="right"><a href="javascript:void(0);" data-id="'+value.Code+'" class="MainPopBtn" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage("Image37","","/images/fullscreen_hover.png",1)"><img src="/images/fullscreen_normal.png" name="Image37" width="26" height="26" border="0" id="Image37" /></a></td></tr></table></td>';
                                    ...
                                    row = row + '<tr><td align="right" width="110px;">Name</td> <td><input type="text" name="" id="" value="' + value.Name + '" placeholder="" class="FilddHalf11" /></td></tr>';
                                    row = row + '<tr><td align="right" width="110px;">City</td> <td><input type="text" name="" id="" value="' + value.City + '" placeholder="" class="FilddHalf11" /></td></tr>';
                                    row = row + '<tr><td align="right" width="110px;">Contact Person</td> <td><input type="text" name="" id="" value="' + value.ContactPerson + '" placeholder="" class="FilddHalf11" /></td>';
                                    row = row + '<tr><td align="right"></td><td align="right"><a href="javascript:void(0);" data-id="'+value.Code+'" class="MainPopBtn" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage("Image37","","/images/fullscreen_hover.png",1)"><img src="/images/fullscreen_normal.png" name="Image37" width="26" height="26" border="0" id="Image37" /></a></td></tr></table></td>';
                                    $("#tblsearch").append(row);
                                    count = 0;
