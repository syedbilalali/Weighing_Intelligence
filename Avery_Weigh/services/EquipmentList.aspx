<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EquipmentList.aspx.cs" Inherits="Avery_Weigh.services.EquipmentList" %>
            ...
            <div class="MiddleSection">
                ...
                <div class="RightSec">
                    <div class="RightInn11" style="overflow:hidden">
                        <h4>SERVICES</h4>
                        <h4 class="SupplierSearchBig">SITE SETTINGS <a href="javascript:void(0);" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image32','','images/close_hover.png',1)" class="CloseButtonA">
                        ...
                        <div class="RightInnMasters">
                            ...
                            <asp:Repeater ID="rptList" runat="server">
                                <HeaderTemplate>
                                    ...
                                    <td align="center" valign="middle" bgcolor="#d8e7ee">Type</td>
                                    <td align="center" valign="middle" bgcolor="#d8e7ee">Axle</td>
                                    <td align="center" valign="middle" bgcolor="#d8e7ee">Weight(t)</td>
                                    <td align="center" valign="middle" bgcolor="#d8e7ee">Speed</td>
                                </tr>
                                </HeaderTemplate>
                                <ItemTemplate>
                                     <tr>
                                    <td align="center" valign="middle"><%#Eval("Id") %></td>
                                    <td align="center" valign="middle">LOCO</td>
