<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Import.aspx.cs" Inherits="Avery_Weigh.SensorMaster.Import" %>
            ...
            <div class="MiddleSection">
                ...
                <div class="RightSec">
                    <div class="RightInn11">
                        <h4>CONFIGURATION</h4>
                        <h4 class="SupplierSearchBig">SENSOR IMPORT <a href="List.aspx" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image32','','/images/close_hover.png',1)" class="CloseButtonA">
                            ...
                            <div style="float:right;display:inline-block;width:50%;text-align:left">
                                ...
                                <table style="border:1px solid red">
                                    <tr>
                                     ...
                                     <tr>
                                        <td>3</td>
                                        <td>Sensor Identification should be less than or equal to 10 Character</td>
                                    </tr>
                                     <tr>
                                        <td>4</td>
                                        <td>Sensor IP should be less than or equal to 15 Character and should be in Valid format</td>
                                    </tr>
                                     <tr>
                                        <td>5</td>
                                        <td>Sensor Port should be less than or equal to 5 Character</td>
                                    </tr>
                                </table>
                            </div>
                        </div>
                ...
                <div class="footer">
                    <ul class="selected">
                        ...
                        <img src="/images/type4/edit_normal.png" name="Image12" width="80" height="50" border="0" id="Image12" /></a></li>
                         ...
                         <li><asp:LinkButton ID="BtnSave" runat="server" OnClick="BtnSave_Click" OnClientClick="return validatefile();" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image13','','/images/type4/save_hover.png',1)">
