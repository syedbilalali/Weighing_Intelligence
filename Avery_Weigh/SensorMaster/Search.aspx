<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Search.aspx.cs" Inherits="Avery_Weigh.SensorMaster.Search" %>
...
<head runat="server">
    ...
    <script>
        $(document).on("click", ".MainPopBtn", function () {
            ...
            $.ajax({
                type: "POST",
                url: "/AveryService/WebService1.asmx/Get_Sensor_ById",
                data: "{'id':'" + id + "'}",
                ...
                success: function (response) {
                    ...
                    $('#txtidentification').val(obj.SensorIdentification);
                    $('#txtip').val(obj.SensorIP);
                    $('#txtport').val(obj.SensorPort);
            ...
            <div class="MiddleSection">
                ...
                <div class="RightSec">
                    <div class="RightInn11" style="overflow: hidden">
                        <h4>MASTERS</h4>
                        <h4 class="SupplierSearchBig">SENSOR MASTER | SEARCH  <a href="List.aspx" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image32','','/images/close_hover.png',1)" class="CloseButtonA">
                                ...
                                <tr>
                                    <td align="left">
                                        <table width="200" border="0" cellspacing="0" cellpadding="0" style="margin-top: 20px;">
                                            ...
                                            <tr>
                                                <td align="center">
                                                    <select class="DropDown" id="ddlSearch1" style="width: 85%; float: right">
                                                        ...
                                                        <option value="SensorIP">Sensor IP</option>
                                                    </select>
                                                </td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                <td align="center" >
                                                    <select class="DropDown" id="ddlSearch3" style="width: 85%; float: right">
                                                        <option value="SensorIP">Sensor IP</option>
                                                        <option value="MachineId">Machine Id</option>
                                                        <option value="PlantCode">Plant Code</option>
                                                    </select>
                        ...
                        <div class="RightInn33">
                                ...
                                <tr>
                                    <td class="TableDiv">
                                        <table border="0" cellspacing="0" cellpadding="2">
                                            ...
                                            <tr>
                                                <td align="right">Sensor Identification</td>
                                                <td>
                                                    <input type="text" name="" id="" value="" placeholder="" class="FilddHalf11" /></td>
                                            </tr>
                                            <tr>
                                                <td align="right">Sensor IP</td>
                                                <td>
                                                    <input type="text" name="" id="" value="" placeholder="" class="FilddHalf11" /></td>
                                            </tr>
                                            <tr>
                            ...
                            <div class="Popup">
                                <table border="0" cellspacing="0" cellpadding="2" class="PopupDiv">
                                    <tr>
                                        <td align="left" class="PopupHeader" style="color: #ffffff; padding-left: 15px;">SENSOR MASTER</td>
        ...
        <script type="text/javascript">  
            $(document).ready(function () {
                $("#search1").keyup(function () {
                    ...
                    $.ajax({
                        type: "POST",
                        url: "/AveryService/WebService1.asmx/Get_SensorMaster",
                        ...
                        success: function (response) {
                            ...
                            $.each(obj, function (key, value) {
                                if (count == 0) {
                                    ...
                                    row = row + '<tr><td align="right" width="110px;">Identification</td> <td><input type="text" name="" id="" value="' + value.SensorIdentification + '" placeholder="" class="FilddHalf11" /></td></tr>';
                                    row = row + '<tr><td align="right" width="110px;">Sensor IP</td> <td><input type="text" name="" id="" value="' + value.SensorIP + '" placeholder="" class="FilddHalf11" /></td></tr>';
                                    ...
                                    row = row + '<tr><td align="right" width="110px;">Plant Code</td> <td><input type="text" name="" id="" value="' + value.PlantCode + '" placeholder="" class="FilddHalf11" /></td></tr>';
                                    row = row + '<tr><td align="right" width="110px;">Machine ID</td> <td><input type="text" name="" id="" value="' + value.MachineId + '" placeholder="" class="FilddHalf11" /></td></tr>';
                                    row = row + '<tr><td align="right" width="110px;">Sensor Identification</td> <td><input type="text" name="" id="" value="' + value.SensorIdentification + '" placeholder="" class="FilddHalf11" /></td></tr>';
                                    row = row + '<tr><td align="right" width="110px;">Sensor IP</td> <td><input type="text" name="" id="" value="' + value.SensorIP + '" placeholder="" class="FilddHalf11" /></td>';
                                    row = row + '<tr><td align="right"></td><td align="right"><a href="javascript:void(0);" data-id="' + value.Id + '" class="MainPopBtn" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage("Image37","","/images/fullscreen_hover.png",1)"><img src="/images/fullscreen_normal.png" name="Image37" width="26" height="26" border="0" id="Image37" /></a></td></tr></table></td>';
                                    $("#tblsearch").append(row);
                                    count = 0;
