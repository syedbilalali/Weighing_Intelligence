<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddEdit.aspx.cs" Inherits="Avery_Weigh.Packing_Master.AddEdit" %>
...
<body onload="MM_preloadImages('images/contact/contact_hover.png','images/contact/info_hover.png','images/contact/login_hover.png','images/close_hover.png','images/fullscreen_hover.png','images/exit_fullscreen_hover.png','images/type3/copy_hover.png','images/type3/previous_page_hover.png','images/type3/previous_record_hover.png','images/type3/next_record_hover.png','images/type3/next_page_hover.png')">
    <form id="form1" runat="server" defaultfocus="txtPackingCode">
        <div class="Wrapper WeighMain">
            ...
            <div class="MiddleSection">
                ...
                <div class="RightSec">
                    <div class="RightInn11 textcon" style="overflow:hidden ">
                        <h4>MASTERS</h4>
                        <h4 class="SupplierSearchBig">PACKING MASTER<a href="PackingList.aspx" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image32','','/images/close_hover.png',1)" class="CloseButtonA">
                    ...
                    <div class="RightInn11 supplier">
                        ...
                        <div class="RightInnMasters">
                            <div class="ConatctIcons2" id="divoptions" style="display: none;" runat="server">
                                <ul>
                                    <li><a href="PackingList.aspx" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Copy','','/images/type3/copy_hover.png',1)">
                            ...
                            <table border="0" cellspacing="0" cellpadding="2">
                                <tr>
                                    <td align="right" width="150px;">Packing Code</td>
                                    <td>
                                        <asp:TextBox ID="txtPackingCode" runat="server" CssClass="FilddHalf112" MaxLength="10"></asp:TextBox></td>
                                    <td align="right" width="150px;">Packing Name</td>
                                    <td>
                                        <asp:TextBox ID="txtPackingName" runat="server" CssClass="FilddHalf112" MaxLength="25"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                    <td align="right" width="150px;">Packing UOM</td>
                                    <td>
                                        <asp:DropDownList ID="ddlpackinguom" runat="server" CssClass="FilddHalf112" Width="287px">
                                            <asp:ListItem Value="">Select</asp:ListItem>
                                            <asp:ListItem Value="kg">kg</asp:ListItem>
                                            <asp:ListItem Value="t">t</asp:ListItem>
                                        </asp:DropDownList>
                                    </td>
                                    <td align="right" width="150px;">Packing WT</td>
                                    <td>
                                        <asp:TextBox ID="txtPackingwt" runat="server" CssClass="FilddHalf112" MaxLength="5"></asp:TextBox>
                                    </td>
                                </tr>
            ...
            <div class="footer">
                <ul class="selected">
                    ...
                    <li><a href="PackingList.aspx" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image15','','/images/type4/import_hover.png',1)">
    ...
    <script type="text/javascript">
        function validateForm() {
            var result = true;
            var PackingCode = $('#txtPackingCode').val();
            var PackingName = $('#txtPackingName').val();
            var Packinguom = $('#txtPackinguom').val();
            var Packingwt = $('#txtPackingwt').val();
            if (PackingCode.trim() == '' || PackingName.trim() == '' || Packinguom.trim() == '' || Packingwt.trim() == '') {
        ...
        $(document).ready(function () {
            $("#txtPackingwt").keydown(function (e) {
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            $('#txtPackingCode').change(function () {
                var code = $('#txtPackingCode').val();
                $.ajax({
                    type: "POST",
                    url: "/AveryService/WebService1.asmx/Check_PackingMaster",
                    data: "{'code':'" + code + "'}",
                    ...
                    success: function (data) {
                        ...
                        if (data.d != "") {
                            ...
                            console.log(obj);
                            toastr.error('Same Packing Code Exist');
                            $('#txtPlantCOde').focus();
                            return false;
                        }
                    },
