<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PackingList.aspx.cs" Inherits="Avery_Weigh.Packing_Master.Packing_Master" %>
        ...
        <div class="Wrapper WeighMain">
            ...
            <div class="MiddleSection">
                ...
                <div id="div_print" class="RightSec">
                    <div class="RightInn11 textcon" style="overflow:hidden">
                        <h4>MASTERS</h4>
                        <h4 class="SupplierSearchBig">PACKING MASTER <a href="/ManageMasters" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image32','','/images/close_hover.png',1)" class="CloseButtonA">
                                    ...
                                    <asp:Repeater ID="rptList" runat="server" OnItemCreated="rptList_ItemCreated">
                                        <HeaderTemplate>
                                            <tr>
                                                ...
                                                <td align="center" valign="middle" bgcolor="#d8e7ee">Packing Code</td>
                                                <td align="center" valign="middle" bgcolor="#d8e7ee">Packing Name</td>
                                                <td align="center" valign="middle" bgcolor="#d8e7ee">Packing UOM</td>
                                                <td align="center" valign="middle" bgcolor="#d8e7ee">Packing WT</td>
                                        ...
                                        <ItemTemplate>
                                            <tr class="trclass" data-rowid="<%#Eval("Id") %>">
                                                ...
                                                <td align="center" valign="middle"><%#Eval("PackingCode") %></td>
                                                <td align="center" valign="middle"><%#Eval("PackingName") %></td>
                                                <td align="center" valign="middle"><%#Eval("PackingUOM") %></td>
                                                <td align="center" valign="middle"><%#Eval("PackingWT") %></td>
                            ...
                            <table id="tblNone" runat="server" visible="false" style="width: 100%;" border="1" bordercolor="#72aac0" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF" class="MainLTable">
                                <thead>
                                    <tr>
                                        ...
                                        <td align="center" valign="middle" bgcolor="#d8e7ee">Packing UOM</td>
                                        <td align="center" valign="middle" bgcolor="#d8e7ee">Packing WT</td>
                                        <td align="center" valign="middle" bgcolor="#d8e7ee"></td>
                                    </tr>
                                </thead>
                                <tr>
            ...
            <div class="footer">
                <ul class="selected">
                    ...
                    <li>
                        <asp:LinkButton runat="server" ID="id1" OnClick="id1_Click" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image12','','/images/type4/edit_hover.png',1)">
                    ...
                    <li>
                        <asp:LinkButton runat="server" ID="Export" OnClick="Export_Click" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image15','','/images/type4/import_hover.png',1)">
                    ...
                    <li>
                        <asp:LinkButton runat="server" ID="Delete" OnClick="Delete_Click" OnClientClick="return Delete();" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image17','','/images/type4/delete_hover.png',1)">
