<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Import.aspx.cs" Inherits="Avery_Weigh.Packing_Master.Import" %>
            ...
            <div class="MiddleSection">
                ...
                <div class="RightSec">
                    <div class="RightInn11">
                        <h4>MASTERS</h4>
                        <h4 class="SupplierSearchBig">PACKING MASTER IMPORT <a href="PackingList.aspx" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image32','','/images/close_hover.png',1)" class="CloseButtonA">
                    ...
                    <div class="RightInn11">
                        ...
                        <div class="RightInnMasters">
                            ...
                            <div style="width:50%;display:inline-block;float:right;text-align:left">
                                ...
                                <h3 style="color:red">Instructions for Import xlsx file</h3>
                                <table style="border:1px solid red">
                                    <tr>
                                        <td>1</td>
                                        <td>Packing Code should be less than or equal to 10 character</td>
                                    </tr>
                                     <tr>
                                        <td>2</td>
                                        <td>Packing Name should be less than or equal to 25 character</td>
                                    </tr>
                                     <tr>
                                        <td>3</td>
                                        <td>Packing UOM should be in  ' KG ' or ' T ' format  </td>
                                    </tr>
                                     <tr>
                                        <td>4</td>
                                        <td>Packing WT should be less than or equal to 5 character and should be in numeric format</td>
                                    </tr>
                                </table>
                            </div>
                        </div>
                ...
                <div class="footer">
                    <ul class="selected">
                        ...
                        <img src="/images/type4/edit_normal.png" name="Image12" width="80" height="50" border="0" id="Image12" /></a></li>
                         <li><asp:LinkButton ID="lnkSave" runat="server" OnClientClick="return validate();" OnClick="lnkSave_Click1" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image13','','/images/type4/save_hover.png',1)">
                        ...
                        <li>
                            <a href="PackingList.aspx" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image15','','/images/type4/import_hover.png',1)">
