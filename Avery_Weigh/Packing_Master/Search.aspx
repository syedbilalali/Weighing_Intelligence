<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Search.aspx.cs" Inherits="Avery_Weigh.Packing_Master.Search" %>
        ...
        $(document).on("click", ".MainPopBtn", function () {
            ...
            $.ajax({
                        ...
                        success: function (response) {
                            ...
                            console.log(obj);
                            $('#txtCode').val(obj.PackingCode);
                            $('#txtName').val(obj.PackingName);
                            $('#txtpackinguom').val(obj.PackingUOM);
                            $('#txtpackingwt').val(obj.PackingWT);                         
                        },
        ...
        <div class="Wrapper WeighMain">
            ...
            <div class="MiddleSection">
                ...
                <div class="RightSec">
                    <div class="RightInn11">
                        <h4>MASTERS</h4>
                        <h4 class="SupplierSearch">PACKING | SEARCH    </h4>
                    </div>
                        ...
                        <div class="RightInn33">
                                ...
                                <tr>
                                    <td class="TableDiv">
                                        <table border="0" cellspacing="0" cellpadding="2">
                                            <tr>
                                                <td align="right" width="110px;">Packing Code</td>
                                                <td>
                                                    <input type="text" name="" id="" value="" placeholder="" class="FilddHalf11" /></td>
                                            </tr>
                                            <tr>
                                                <td align="right">Packing Name</td>
                                                <td>
                                                    <input type="text" name="" id="" value="" placeholder="" class="FilddHalf11" /></td>
                                            </tr>
                                            <tr>
                                                <td align="right">Packing UOM</td>
                                                <td>
                                                    <input type="text" name="" id="" value="" placeholder="" class="FilddHalf11" /></td>
                                            </tr>
                                            <tr>
                                                <td align="right">Packing WT</td>
                                                <td>
                                                    <input type="text" name="" id="" value="" placeholder="" class="FilddHalf11" /></td>
                                            </tr>
                                            <tr>
                            ...
                            <div class="Popup">
                                <table border="0" cellspacing="0" cellpadding="2" class="PopupDiv">
                                    <tr>
                                        <td align="left" class="PopupHeader" style="color: #ffffff; padding-left: 15px;">PACKING MASTER</td>
                                        ...
                                        <td colspan="2" style="padding: 10px 0 20px 0px;">
                                            <table border="0" cellspacing="0" cellpadding="2">
                                                <tr>
                                                    ...
                                                    <td align="right" width="110px;">Packing Name</td>
                                                    <td>
                                                        <input type="text" name="" id="txtName" value="" placeholder="" class="FilddHalf112" /></td>
                                                </tr>
                                                <tr>
                                                    <td align="right" width="110px;">Packing UOM</td>
                                                    <td>
                                                        <input type="text" name="" id="txtpackinguom" value="" placeholder="" class="FilddHalf112" /></td>
                                                    <td align="right" width="110px;">Packing WT</td>
                                                    <td>
                                                        <input type="text" name="" id="txtpackingwt" value="" placeholder="" class="FilddHalf112" /></td>
                                                </tr>                                               
                                            </table>
                                        </td>
                                    </tr>
            ...
            <div class="footer">
                <ul class="selected">
                    ...
                    <li>
                        <a href="PackingList.aspx" runat="server" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image15','','/images/type4/import_hover.png',1)">
                    ...
                    <li>
                        <a href="javascript:void(0)" runat="server"   onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image17','','/images/type4/delete_hover.png',1)">
        ...
        <script type="text/javascript">  
            $(document).ready(function () {
                $("#search1").keyup(function () {
                    ...
                    $.ajax({
                        type: "POST",
                        url: "/AveryService/WebService1.asmx/Get_Packings",
                        ...
                        success: function (response) {
                            ...
                            $.each(obj, function (key, value) {
                                if (count == 0) {
                                    ...
                                    row = row + '<tr><td align="right" width="110px;">Packing Code</td> <td><input type="text" name="" id="" value="' + value.PackingCode + '" placeholder="" class="FilddHalf11" /></td></tr>';
                                    row = row + '<tr><td align="right" width="110px;">Packing Name</td> <td><input type="text" name="" id="" value="' + value.PackingName + '" placeholder="" class="FilddHalf11" /></td></tr>';
                                    row = row + '<tr><td align="right" width="110px;">Packing UOM</td> <td><input type="text" name="" id="" value="' + value.PackingUOM + '" placeholder="" class="FilddHalf11" /></td></tr>';
                                    row = row + '<tr><td align="right" width="110px;">Packing WT</td> <td><input type="text" name="" id="" value="' + value.PackingWT + '" placeholder="" class="FilddHalf11" /></td></tr>';
                                    row = row + '<tr><td align="right"></td><td align="right"><a href="javascript:void(0);" data-id="'+value.PackingCode+'" class="MainPopBtn" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage("Image37","","/images/fullscreen_hover.png",1)"><img src="/images/fullscreen_normal.png" name="Image37" width="26" height="26" border="0" id="Image37" /></a></td></tr></table></td>';
                                    ...
                                    row = row + '<tr><td align="right" width="110px;">Packing Name</td> <td><input type="text" name="" id="" value="' + value.PackingName + '" placeholder="" class="FilddHalf11" /></td></tr>';
                                    row = row + '<tr><td align="right" width="110px;">Packing UOM</td> <td><input type="text" name="" id="" value="' + value.PackingUOM + '" placeholder="" class="FilddHalf11" /></td></tr>';
                                    row = row + '<tr><td align="right" width="110px;">Packing WT</td> <td><input type="text" name="" id="" value="' + value.PackingWT + '" placeholder="" class="FilddHalf11" /></td>';
                                    row = row + '<tr><td align="right"></td><td align="right"><a href="javascript:void(0);" data-id="'+value.PackingCode+'" class="MainPopBtn" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage("Image37","","/images/fullscreen_hover.png",1)"><img src="/images/fullscreen_normal.png" name="Image37" width="26" height="26" border="0" id="Image37" /></a></td></tr></table></td>';
                                    $("#tblsearch").append(row);
                                    count = 0;
