<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ConfigurationMaster.aspx.cs" Inherits="Avery_Weigh.ConfigurationMaster" %>
                        ...
                        <div class="MastersPageMasterDiv">
                            ...
                            <div class="MastersPageContent">
                                ...
                                <ul>
                                    ...
                                    <li><a href="PlantList.aspx" class="my_btn">
                                        <span class="">Plant Master</span></a></li>
                                    <li><a href="/usersClassification/List" class="my_btn">
                                        <span class="double_line">Users Classifications</span></a></li>
                                    <li><a href="/ManageUsers/List" class="my_btn">
                                        <span class="">Users Master</span></a></li>
                                </ul>
                            </div>
                            ...
                            <div class="MastersPageContent">
                                <h5>SITE</h5>
                                <ul>
                                    <li><a href="Company_Master" class="my_btn">
                                        <span class="">Company Master</span></a></li>
                                    <li><a href="/Services/PlantSettings" class="my_btn">
                                        <span class="double_line">Site Working Parameters</span></a></li>
                                    <li><a href="/Machine/List" class="my_btn">
                                        <span class="double_line">M/C Working Parameters</span></a></li>
                                </ul>
                            </div>

                            <div class="MastersPageContent">
                                <h5>WEIGHING MACHINE</h5>
                                <ul>
                                    <li><a href="/WeightMachinMaster/List.aspx" class="my_btn">
                                        <span class="double_line">Weighing Machine Master</span></a></li>

                                     <li><a href="Shift_Master" class="my_btn">
                                        <span class="">Shift</span></a></li>
                            ...
                            <%--<div class="MastersPageContent">
                                <h5>EQUIPMENT</h5>
                                <ul>
                                    <li><a href="Camera_Master/List" class="my_btn">
                                        <span class="">Camera Master</span></a></li>
                                    <li><a href="Barrier_Master/List" class="my_btn">
                                        <span class="">Barrier Master</span></a></li>
                                    <li><a href="Alpha_DisplayMaster/List" class="my_btn">
                                        <span class="double_line">Alpha Display Master</span></a></li>
                                    <li><a href="SensorMaster/List" class="my_btn">
                                        <span class="">Sensor Master</span>
                                        </a></li>
                            ...
                            <div class="MastersPageContent">
                                <h5>OTHERS</h5>
                                <ul>
                                     <%--<li><a href="javascript:void(0);" class="my_btn">
                                        <span class="">Data ID</span></a></li>--%>
                                    <li><a href="/AVTOLSCH/List" class="my_btn">
                                        <span class="">Av. Tare</span></a></li>
                                     <li><a href="Database_Backup" class="my_btn">
                                        <span class="">Database Backup</span></a></li>
                                     <li><a href="javascript:void(0);" class="my_btn">
                                        <span class="">Database Restore</span></a></li>
                                </ul>
                            </div>
