<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Database_Backup.aspx.cs" Inherits="Avery_Weigh.Database_Backup" %>
...
<body onload="MM_preloadImages('images/contact/contact_hover.png','images/contact/info_hover.png','images/contact/login_hover.png','images/close_hover.png','images/fullscreen_hover.png','images/exit_fullscreen_hover.png','images/type3/copy_hover.png','images/type3/previous_page_hover.png','images/type3/previous_record_hover.png','images/type3/next_record_hover.png','images/type3/next_page_hover.png')">
    <form id="form1" runat="server" defaultfocus="txtFilePath">
            ...
            <div class="MiddleSection">
                ...
                <div class="RightSec">
                    <div class="RightInn11 textcon" style="overflow:hidden">
                        <h4>CONFIGURATION</h4>
                        <h4 class="SupplierSearchBig">DATABASE BACKUP <a href="/ConfigurationMaster" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image32','','images/close_hover.png',1)" class="CloseButtonA">
                    ...
                    <div class="RightInn11">
                        ...
                        <div class="RightInnMasters">
                            ...
                            <table border="0" cellspacing="0" cellpadding="2" class="fileloc">
                                
                                <tr>
                                    <td align="right" width="150px;" >File Location</td>
                                     <td>
                                            <asp:TextBox ID="txtFilePath" runat="server" width="200px" Text="C:\\" CssClass="field FilddHalf70" ReadOnly="true" ></asp:TextBox></td>
                                    <td>
                                            <asp:Button ID="btnSearch" runat="server" Text="Database Backup" OnClick="btnSearch_Click" class="my_btn" />
