<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Dashboard.aspx.cs" Inherits="Avery_Weigh.Dashboard" %>
            ...
            <div class="MiddleSection">
                ...
                <div class="RightSec">
                    <div class="RightInn11 " style="overflow:hidden">
                        <h4>DASHBOARD</h4>
                        <h4 class="SupplierSearchBig">DAILY WEIGHMENT <a href="/ManageMasters" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image32','','images/close_hover.png',1)" class="CloseButtonA">
                    ...
                    <div class="RightInn11">
                        ...
                        <div class="RightInnMasters">
                            ...
                            <div id="dbMain" runat="server">
                                 <marquee behavior="scroll" direction="up" scrollamount="2" behavior="alternate">
                                 <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="false">
                                        <Columns>
                                            <asp:BoundField DataField="TripId" HeaderText="Trip Id" />
                                            <asp:BoundField DataField="TruckNo" HeaderText="Truck No" />
                                            <asp:BoundField DataField="FirstWeight" HeaderText="First Wt" />
                                            <asp:BoundField DataField="FirstWtDateTime" HeaderText="DateTimeIn" />
                                            <asp:BoundField DataField="SecondWeight" HeaderText="Second Wt" />
                                            <asp:BoundField DataField="SecondWtDateTime" HeaderText="DateTimeOut" />
                                            <asp:BoundField DataField="NetWeight" HeaderText="Net Wt" />
                                            <asp:BoundField DataField="MaterialName" HeaderText="Material Name" />
                                            <asp:BoundField DataField="SupplierName" HeaderText="Supplier Name" />
                                             <asp:BoundField DataField="WeighingUnit" HeaderText="Weighing Unit" />
                                        </Columns>
                                    </asp:GridView>
                                   </marquee>
