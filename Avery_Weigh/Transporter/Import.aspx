<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Import.aspx.cs" Inherits="Avery_Weigh.Transporter.Import" %>
            ...
            <div class="MiddleSection">
                ...
                <div class="RightSec">
                    <div class="RightInn11">
                        <h4>MASTERS</h4>
                        <h4 class="SupplierSearchBig">TRANSPORTER IMPORT <a href="List.aspx" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image32','','/images/close_hover.png',1)" class="CloseButtonA">
                        ...
                        <div class="RightInnMasters">
                            ...
                            <div style="width:50%;display:inline-block;float:right;text-align:left">
                                ...
                                <table style="border:1px solid red">
                                    <tr>
                                        <td>1</td>
                                        <td>Transporter code should be less than or equal to 12 character</td>
                                    </tr>
                                    <tr>
                                        <td>2</td>
                                        <td>Name should be less than or equal to 25 character</td>
                                    </tr>
                                    <tr>
                                        <td>3</td>
                                        <td>Address1 should be less than or equal to 25 character</td>
                                    </tr>
                                    <tr>
                                        <td>4</td>
                                        <td>Address2 should be less than or equal to 25 character</td>
                                    </tr>
                                    <tr>
                                        <td>5</td>
                                        <td>City should be less than or equal to 25 character</td>
                                    </tr>
                                    <tr>
                                        <td>6</td>
                                        <td>State should be less than or equal to 25 character</td>
                                    </tr>
                                    <tr>
                                        <td>7</td>
                                        <td>Country should be less than or equal to 25 character</td>
                                    </tr>
                                    <tr>
                                        <td>8</td>
                                        <td>GST NO should be less than or equal to 25 character</td>
                                    </tr>
                                    <tr>
                                        <td>9</td>
                                        <td>PAN No should be less than or equal to 25 character</td>
                                    </tr>
                                    <tr>
                                        <td>10</td>
                                        <td>Contact Person should be less than or equal to 25 character</td>
                                    </tr>
                                    <tr>
                                        <td>11</td>
                                        <td>Contact Email should be  less than or equal to 25 character and should be valid</td>
                                    </tr>
                                    <tr>
                                        <td>12</td>
                                        <td>Contact Mobile should be less than or equal to 12 character and should be in numeric format</td>
                                    </tr>
                ...
                <div class="footer">
                    <ul class="selected">
                        <li><a href="Search" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image11','','/images/type4/search_hover.png',1)">
                        ...
                        <img src="/images/type4/edit_normal.png" name="Image12" width="80" height="50" border="0" id="Image12" /></a></li>
                         <li><asp:LinkButton ID="lnkSave" runat="server"  OnClick="lnkSave_Click" OnClientClick="return validate();" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image13','','/images/type4/save_hover.png',1)">
