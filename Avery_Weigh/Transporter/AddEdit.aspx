<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddEdit.aspx.cs" Inherits="Avery_Weigh.Transporter.AddEdit" %>
        ...
        <div class="Wrapper WeighMain">
            ...
            <div class="MiddleSection">
                ...
                <div class="RightSec">
                    <div class="RightInn11 textcon" style="overflow: hidden">
                        <h4>MASTERS</h4>
                        <h4 class="SupplierSearchBig">TRANSPORTER <a href="List.aspx" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image32','','/images/close_hover.png',1)" class="CloseButtonA">
                        ...
                        <div class="RightInnMasters">
                            ...
                            <table border="0" cellspacing="0" cellpadding="2">
                                <tr>
                                    ...
                                    <td>
                                        <asp:TextBox ID="txtName" runat="server" CssClass="FilddHalf112" MaxLength="40"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                    <td align="right" width="150px;">Address1</td>
                                    <td>
                                        <asp:TextBox ID="txtaddress1" runat="server" CssClass="FilddHalf112" MaxLength="40"></asp:TextBox>
                                    </td>
                                    <td align="right" width="150px;">Address 2 </td>
                                    <td>
                                        <asp:TextBox ID="txtaddress2" runat="server" CssClass="FilddHalf112" MaxLength="40"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:TextBox ID="txtperson" runat="server" CssClass="FilddHalf112" MaxLength="40"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <asp:TextBox ID="txtemail" runat="server" CssClass="FilddHalf112" MaxLength="30"></asp:TextBox>
                                    </td>
                                </tr>
            ...
            <div class="footer">
                <ul class="selected">
                    ...
                    <li>
                        <a href="AddEdit.aspx" runat="server" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image12','','/images/type4/edit_hover.png',1)">
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            $('#txtcode').change(function () {
                ...
                $.ajax({
                    type: "POST",
                    url: "/AveryService/WebService1.asmx/Check_Transporter",
                    data: "{'code':'" + code + "'}",
                    ...
                    success: function (data) {
                        ...
                        if (data.d != "") {
                            ...
                            console.log(obj);
                            toastr.error('Same Transporter Code Exist');
                            $('#txtcode').focus();
                            return false;
                        }
                    },
