<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PlantList.aspx.cs" Inherits="Avery_Weigh.PlantList" %>
            ...
            <div class="MiddleSection">
                ...
                <div class="RightSec">
                    <div class="RightInn11 textcon" style="overflow:hidden">
                        <h4>CONFIGURATION</h4>
                        <h4 class="SupplierSearchBig">PLANT MASTER <a href="/ConfigurationMaster" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image32','','images/close_hover.png',1)" class="CloseButtonA">
                                ...
                                <asp:Repeater ID="rptList" runat="server" OnItemDataBound="rptList_ItemDataBound">
                                    ...
                                    <ItemTemplate>
                                        <tr class="trclass" data-rowid="<%#Eval("Id") %>">
                                            ...
                                            <td align="center" valign="middle"><%#Eval("PlantName") %></td>
                                            <td align="center" valign="middle"><%#Eval("PlantAddress1") %></td>
                                        </tr>
                                    </ItemTemplate>
                                </asp:Repeater>
                            </table>
